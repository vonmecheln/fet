...
void usage(QTextStream* out, const QString& error)
{
	...
	s+=QString(
		...
		"\n"
		"\t--embedcssinhtmlhead=ECHH\n"
		"\t\tECHH is either true or false and represents whether you want to embed the CSS code in the head of each of the resulted HTML files, instead of writing "
