/***************************************************************************
                          modifyconstraintstudentssetmaxroomchangesperrealdayinintervalform.cpp  -  description
                             -------------------
    begin                : 2024
...
ModifyConstraintStudentsSetMaxRoomChangesPerRealDayInIntervalForm::ModifyConstraintStudentsSetMaxRoomChangesPerRealDayInIntervalForm(QWidget* parent, ConstraintStudentsSetMaxRoomChangesPerRealDayInInterval* ctr): QDialog(parent)
{
	setupUi(this);

	okPushButton->setDefault(true);

	connect(okPushButton, &QPushButton::clicked, this, &ModifyConstraintStudentsSetMaxRoomChangesPerRealDayInIntervalForm::ok);
	connect(cancelPushButton, &QPushButton::clicked, this, &ModifyConstraintStudentsSetMaxRoomChangesPerRealDayInIntervalForm::cancel);
...
ModifyConstraintStudentsSetMaxRoomChangesPerRealDayInIntervalForm::~ModifyConstraintStudentsSetMaxRoomChangesPerRealDayInIntervalForm()
{
	saveFETDialogGeometry(this);
}

void ModifyConstraintStudentsSetMaxRoomChangesPerRealDayInIntervalForm::updateStudentsComboBox(QWidget* parent)
{
...
void ModifyConstraintStudentsSetMaxRoomChangesPerRealDayInIntervalForm::ok()
{
...
void ModifyConstraintStudentsSetMaxRoomChangesPerRealDayInIntervalForm::cancel()
{
	this->close();
}
