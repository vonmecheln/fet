...
#include "addconstraintstudentssetmaxhourscontinuouslyform_template.h"
...
class AddConstraintStudentsSetMaxHoursContinuouslyForm : public AddConstraintStudentsSetMaxHoursContinuouslyForm_template  {
public:
