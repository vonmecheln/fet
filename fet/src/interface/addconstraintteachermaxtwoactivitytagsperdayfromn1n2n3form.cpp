...
AddConstraintTeacherMaxTwoActivityTagsPerDayFromN1N2N3Form::AddConstraintTeacherMaxTwoActivityTagsPerDayFromN1N2N3Form(QWidget* parent): QDialog(parent)
{
	...
	connect(addConstraintPushButton, &QPushButton::clicked, this, &AddConstraintTeacherMaxTwoActivityTagsPerDayFromN1N2N3Form::addCurrentConstraint);
	connect(addConstraintsPushButton, &QPushButton::clicked, this, &AddConstraintTeacherMaxTwoActivityTagsPerDayFromN1N2N3Form::addCurrentConstraints);
	connect(closePushButton, &QPushButton::clicked, this, &AddConstraintTeacherMaxTwoActivityTagsPerDayFromN1N2N3Form::close);
...
void AddConstraintTeacherMaxTwoActivityTagsPerDayFromN1N2N3Form::addCurrentConstraints()
{
