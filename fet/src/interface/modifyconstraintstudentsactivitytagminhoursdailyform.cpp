/***************************************************************************
                          modifyconstraintstudentsactivitytagminhoursdailyform.cpp  -  description
                             -------------------
    begin                : 2019
...
ModifyConstraintStudentsActivityTagMinHoursDailyForm::ModifyConstraintStudentsActivityTagMinHoursDailyForm(QWidget* parent, ConstraintStudentsActivityTagMinHoursDaily* ctr): QDialog(parent)
{
	setupUi(this);

	okPushButton->setDefault(true);

	connect(okPushButton, &QPushButton::clicked, this, &ModifyConstraintStudentsActivityTagMinHoursDailyForm::ok);
	connect(cancelPushButton, &QPushButton::clicked, this, &ModifyConstraintStudentsActivityTagMinHoursDailyForm::cancel);
...
void ModifyConstraintStudentsActivityTagMinHoursDailyForm::updateActivityTagsComboBox()
{
...
void ModifyConstraintStudentsActivityTagMinHoursDailyForm::cancel()
{
	this->close();
}
