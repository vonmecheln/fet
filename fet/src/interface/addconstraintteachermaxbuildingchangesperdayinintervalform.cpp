/***************************************************************************
                          addconstraintteachermaxbuildingchangesperdayinintervalform.cpp  -  description
                             -------------------
    begin                : 2024
...
AddConstraintTeacherMaxBuildingChangesPerDayInIntervalForm::AddConstraintTeacherMaxBuildingChangesPerDayInIntervalForm(QWidget* parent): QDialog(parent)
{
	setupUi(this);

	addConstraintPushButton->setDefault(true);

	connect(addConstraintPushButton, &QPushButton::clicked, this, &AddConstraintTeacherMaxBuildingChangesPerDayInIntervalForm::addCurrentConstraint);
	connect(addConstraintsPushButton, &QPushButton::clicked, this, &AddConstraintTeacherMaxBuildingChangesPerDayInIntervalForm::addCurrentConstraints);
	connect(closePushButton, &QPushButton::clicked, this, &AddConstraintTeacherMaxBuildingChangesPerDayInIntervalForm::close);
...
AddConstraintTeacherMaxBuildingChangesPerDayInIntervalForm::~AddConstraintTeacherMaxBuildingChangesPerDayInIntervalForm()
{
	saveFETDialogGeometry(this);
}

void AddConstraintTeacherMaxBuildingChangesPerDayInIntervalForm::updateTeachersComboBox(){
...
void AddConstraintTeacherMaxBuildingChangesPerDayInIntervalForm::addCurrentConstraint()
{
	...
	ctr=new ConstraintTeacherMaxBuildingChangesPerDayInInterval(weight, teacher_name, maxChangesSpinBox->value(), startHour, endHour);
...
void AddConstraintTeacherMaxBuildingChangesPerDayInIntervalForm::addCurrentConstraints()
{
	...
	for(Teacher* tch : std::as_const(gt.rules.teachersList)){
		SpaceConstraint *ctr=new ConstraintTeacherMaxBuildingChangesPerDayInInterval(weight, tch->name, maxChangesSpinBox->value(), startHour, endHour);
		bool tmp2=gt.rules.addSpaceConstraint(ctr);
		assert(tmp2);
