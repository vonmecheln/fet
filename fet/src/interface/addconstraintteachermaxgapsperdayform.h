...
#include "addconstraintteachermaxgapsperdayform_template.h"
...
class AddConstraintTeacherMaxGapsPerDayForm : public AddConstraintTeacherMaxGapsPerDayForm_template  {
public:
