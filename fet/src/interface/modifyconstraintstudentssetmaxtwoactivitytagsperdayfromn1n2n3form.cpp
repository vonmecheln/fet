...
ModifyConstraintStudentsSetMaxTwoActivityTagsPerDayFromN1N2N3Form::ModifyConstraintStudentsSetMaxTwoActivityTagsPerDayFromN1N2N3Form(QWidget* parent, ConstraintStudentsSetMaxTwoActivityTagsPerDayFromN1N2N3* ctr): QDialog(parent)
{
	...
	connect(okPushButton, &QPushButton::clicked, this, &ModifyConstraintStudentsSetMaxTwoActivityTagsPerDayFromN1N2N3Form::ok);
	connect(cancelPushButton, &QPushButton::clicked, this, &ModifyConstraintStudentsSetMaxTwoActivityTagsPerDayFromN1N2N3Form::cancel);
