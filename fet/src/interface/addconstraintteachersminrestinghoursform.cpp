...
AddConstraintTeachersMinRestingHoursForm::AddConstraintTeachersMinRestingHoursForm(QWidget* parent): QDialog(parent)
{
	...
	connect(addConstraintPushButton, &QPushButton::clicked, this, &AddConstraintTeachersMinRestingHoursForm::addCurrentConstraint);
	connect(addConstraintsPushButton, &QPushButton::clicked, this, &AddConstraintTeachersMinRestingHoursForm::addCurrentConstraints);
	connect(closePushButton, &QPushButton::clicked, this, &AddConstraintTeachersMinRestingHoursForm::close);
...
void AddConstraintTeachersMinRestingHoursForm::addCurrentConstraint()
{
	...
	ctr=new ConstraintTeachersMinRestingHours(weight, minRestingHoursSpinBox->value(), circularCheckBox->isChecked());
...
void AddConstraintTeachersMinRestingHoursForm::addCurrentConstraints()
{
