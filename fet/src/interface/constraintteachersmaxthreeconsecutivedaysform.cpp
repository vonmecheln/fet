/***************************************************************************
                          constraintteachersmaxthreeconsecutivedaysform.cpp  -  description
                             -------------------
    begin                : 2021
...
ConstraintTeachersMaxThreeConsecutiveDaysForm::ConstraintTeachersMaxThreeConsecutiveDaysForm(QWidget* parent): QDialog(parent)
{
	setupUi(this);
...
ConstraintTeachersMaxThreeConsecutiveDaysForm::~ConstraintTeachersMaxThreeConsecutiveDaysForm()
{
	saveFETDialogGeometry(this);
}

bool ConstraintTeachersMaxThreeConsecutiveDaysForm::filterOk(TimeConstraint* ctr)
{
	if(ctr->type==CONSTRAINT_TEACHERS_MAX_THREE_CONSECUTIVE_DAYS)
		return true;
	else
		return false;
}

void ConstraintTeachersMaxThreeConsecutiveDaysForm::filterChanged()
{
...
void ConstraintTeachersMaxThreeConsecutiveDaysForm::constraintChanged(int index)
{
	if(index<0){
...
void ConstraintTeachersMaxThreeConsecutiveDaysForm::addConstraint()
{
	AddConstraintTeachersMaxThreeConsecutiveDaysForm form(this);
...
void ConstraintTeachersMaxThreeConsecutiveDaysForm::modifyConstraint()
{
...
void ConstraintTeachersMaxThreeConsecutiveDaysForm::removeConstraint()
{
	int i=constraintsListWidget->currentRow();
	if(i<0){
		QMessageBox::information(this, tr("FET information"), tr("Invalid selected constraint"));
