/***************************************************************************
                          addconstraintteachersmingapsbetweenorderedpairofactivitytagsperrealdayform.cpp  -  description
                             -------------------
    begin                : 2024
...
AddConstraintTeachersMinGapsBetweenOrderedPairOfActivityTagsPerRealDayForm::AddConstraintTeachersMinGapsBetweenOrderedPairOfActivityTagsPerRealDayForm(QWidget* parent): QDialog(parent)
{
	setupUi(this);

	addConstraintPushButton->setDefault(true);

	connect(addConstraintPushButton, &QPushButton::clicked, this, &AddConstraintTeachersMinGapsBetweenOrderedPairOfActivityTagsPerRealDayForm::addCurrentConstraint);
	connect(addConstraintsPushButton, &QPushButton::clicked, this, &AddConstraintTeachersMinGapsBetweenOrderedPairOfActivityTagsPerRealDayForm::addCurrentConstraints);
	connect(closePushButton, &QPushButton::clicked, this, &AddConstraintTeachersMinGapsBetweenOrderedPairOfActivityTagsPerRealDayForm::close);

	connect(swapPushButton, &QPushButton::clicked, this, &AddConstraintTeachersMinGapsBetweenOrderedPairOfActivityTagsPerRealDayForm::swap);
...
AddConstraintTeachersMinGapsBetweenOrderedPairOfActivityTagsPerRealDayForm::~AddConstraintTeachersMinGapsBetweenOrderedPairOfActivityTagsPerRealDayForm()
{
	saveFETDialogGeometry(this);
}

void AddConstraintTeachersMinGapsBetweenOrderedPairOfActivityTagsPerRealDayForm::updateFirstActivityTagComboBox()
{
	for(ActivityTag* at : std::as_const(gt.rules.activityTagsList))
		firstActivityTagComboBox->addItem(at->name);
}

void AddConstraintTeachersMinGapsBetweenOrderedPairOfActivityTagsPerRealDayForm::updateSecondActivityTagComboBox()
{
	for(ActivityTag* at : std::as_const(gt.rules.activityTagsList))
		secondActivityTagComboBox->addItem(at->name);
}

void AddConstraintTeachersMinGapsBetweenOrderedPairOfActivityTagsPerRealDayForm::addCurrentConstraint()
{
	...
	ctr=new ConstraintTeachersMinGapsBetweenOrderedPairOfActivityTagsPerRealDay(weight, minGaps, firstActivityTagName, secondActivityTagName);
...
void AddConstraintTeachersMinGapsBetweenOrderedPairOfActivityTagsPerRealDayForm::addCurrentConstraints()
{
...
void AddConstraintTeachersMinGapsBetweenOrderedPairOfActivityTagsPerRealDayForm::swap()
{
