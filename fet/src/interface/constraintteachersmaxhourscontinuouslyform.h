...
#include "constraintteachersmaxhourscontinuouslyform_template.h"
...
class ConstraintTeachersMaxHoursContinuouslyForm : public ConstraintTeachersMaxHoursContinuouslyForm_template  {
public:
