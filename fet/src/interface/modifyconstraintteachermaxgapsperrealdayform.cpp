...
ModifyConstraintTeacherMaxGapsPerRealDayForm::ModifyConstraintTeacherMaxGapsPerRealDayForm(QWidget* parent, ConstraintTeacherMaxGapsPerRealDay* ctr): QDialog(parent)
{
	...
	connect(okPushButton, &QPushButton::clicked, this, &ModifyConstraintTeacherMaxGapsPerRealDayForm::ok);
	connect(cancelPushButton, &QPushButton::clicked, this, &ModifyConstraintTeacherMaxGapsPerRealDayForm::cancel);
