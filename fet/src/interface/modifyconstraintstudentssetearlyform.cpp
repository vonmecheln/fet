/***************************************************************************
                          modifyconstraintstudentssetearlyform.cpp  -  description
                             -------------------
    begin                : July 18, 2007
...
ModifyConstraintStudentsSetEarlyForm::ModifyConstraintStudentsSetEarlyForm(ConstraintStudentsSetEarly* ctr)
{
...
ModifyConstraintStudentsSetEarlyForm::~ModifyConstraintStudentsSetEarlyForm()
{
}

void ModifyConstraintStudentsSetEarlyForm::constraintChanged()
{
	QString s;
...
void ModifyConstraintStudentsSetEarlyForm::ok()
{
	double weight;
	QString tmp=weightLineEdit->text();
	sscanf(tmp, "%lf", &weight);
...
void ModifyConstraintStudentsSetEarlyForm::cancel()
{
	this->close();
}
