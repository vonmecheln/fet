...
{
	AddConstraintActivitiesPreferredStartingTimesForm *form=new AddConstraintActivitiesPreferredStartingTimesForm();
	form->exec();
...
void ConstraintActivitiesPreferredStartingTimesForm::modifyConstraint()
{
	...
	ModifyConstraintActivitiesPreferredStartingTimesForm *form=new ModifyConstraintActivitiesPreferredStartingTimesForm((ConstraintActivitiesPreferredStartingTimes*)ctr);
	form->exec();
