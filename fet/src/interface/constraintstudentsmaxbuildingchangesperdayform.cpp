...
ConstraintStudentsMaxBuildingChangesPerDayForm::ConstraintStudentsMaxBuildingChangesPerDayForm(QWidget* parent): QDialog(parent)
{
	setupUi(this);
	...
	connect(constraintsListWidget, &QListWidget::currentRowChanged, this, &ConstraintStudentsMaxBuildingChangesPerDayForm::constraintChanged);
	connect(addConstraintPushButton, &QPushButton::clicked, this, &ConstraintStudentsMaxBuildingChangesPerDayForm::addConstraint);
	connect(closePushButton, &QPushButton::clicked, this, &ConstraintStudentsMaxBuildingChangesPerDayForm::close);
	connect(removeConstraintPushButton, &QPushButton::clicked, this, &ConstraintStudentsMaxBuildingChangesPerDayForm::removeConstraint);
	connect(modifyConstraintPushButton, &QPushButton::clicked, this, &ConstraintStudentsMaxBuildingChangesPerDayForm::modifyConstraint);
	connect(constraintsListWidget, &QListWidget::itemDoubleClicked, this, &ConstraintStudentsMaxBuildingChangesPerDayForm::modifyConstraint);
...
{
	AddConstraintStudentsMaxBuildingChangesPerDayForm form(this);
