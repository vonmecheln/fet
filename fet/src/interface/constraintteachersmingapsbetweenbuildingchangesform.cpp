...
ConstraintTeachersMinGapsBetweenBuildingChangesForm::ConstraintTeachersMinGapsBetweenBuildingChangesForm(QWidget* parent): QDialog(parent)
{
	setupUi(this);
	...
	connect(constraintsListWidget, &QListWidget::currentRowChanged, this, &ConstraintTeachersMinGapsBetweenBuildingChangesForm::constraintChanged);
	connect(addConstraintPushButton, &QPushButton::clicked, this, &ConstraintTeachersMinGapsBetweenBuildingChangesForm::addConstraint);
	connect(closePushButton, &QPushButton::clicked, this, &ConstraintTeachersMinGapsBetweenBuildingChangesForm::close);
	connect(removeConstraintPushButton, &QPushButton::clicked, this, &ConstraintTeachersMinGapsBetweenBuildingChangesForm::removeConstraint);
	connect(modifyConstraintPushButton, &QPushButton::clicked, this, &ConstraintTeachersMinGapsBetweenBuildingChangesForm::modifyConstraint);
	connect(constraintsListWidget, &QListWidget::itemDoubleClicked, this, &ConstraintTeachersMinGapsBetweenBuildingChangesForm::modifyConstraint);
...
{
	AddConstraintTeachersMinGapsBetweenBuildingChangesForm form(this);
