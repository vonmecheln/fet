...
class ModifyConstraintActivitiesMaxSimultaneousInSelectedTimeSlotsForm : public QDialog, Ui::ModifyConstraintActivitiesMaxSimultaneousInSelectedTimeSlotsForm_template  {
	Q_OBJECT
