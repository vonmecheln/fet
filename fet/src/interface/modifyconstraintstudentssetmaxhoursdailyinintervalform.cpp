/***************************************************************************
                          modifyconstraintstudentssetmaxhoursdailyinintervalform.cpp  -  description
                             -------------------
    begin                : 2024
...
ModifyConstraintStudentsSetMaxHoursDailyInIntervalForm::ModifyConstraintStudentsSetMaxHoursDailyInIntervalForm(QWidget* parent, ConstraintStudentsSetMaxHoursDailyInInterval* ctr): QDialog(parent)
{
	setupUi(this);

	okPushButton->setDefault(true);

	connect(okPushButton, &QPushButton::clicked, this, &ModifyConstraintStudentsSetMaxHoursDailyInIntervalForm::ok);
	connect(cancelPushButton, &QPushButton::clicked, this, &ModifyConstraintStudentsSetMaxHoursDailyInIntervalForm::cancel);
...
ModifyConstraintStudentsSetMaxHoursDailyInIntervalForm::~ModifyConstraintStudentsSetMaxHoursDailyInIntervalForm()
{
	saveFETDialogGeometry(this);
}

void ModifyConstraintStudentsSetMaxHoursDailyInIntervalForm::updateStudentsComboBox(QWidget* parent){
...
void ModifyConstraintStudentsSetMaxHoursDailyInIntervalForm::ok()
{
...
void ModifyConstraintStudentsSetMaxHoursDailyInIntervalForm::cancel()
{
	this->close();
}
