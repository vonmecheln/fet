...
#include "constraintsubjectactivitytagpreferredroomform_template.h"
...
class ConstraintSubjectActivityTagPreferredRoomForm : public ConstraintSubjectActivityTagPreferredRoomForm_template  {
public:
