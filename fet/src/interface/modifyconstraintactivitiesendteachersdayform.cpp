/***************************************************************************
                          modifyconstraintactivitiesendteachersdayform.cpp  -  description
                             -------------------
    begin                : 2020
...
ModifyConstraintActivitiesEndTeachersDayForm::ModifyConstraintActivitiesEndTeachersDayForm(QWidget* parent, ConstraintActivitiesEndTeachersDay* ctr): QDialog(parent)
{
	setupUi(this);

	okPushButton->setDefault(true);

	connect(cancelPushButton, &QPushButton::clicked, this, &ModifyConstraintActivitiesEndTeachersDayForm::cancel);
	connect(okPushButton, &QPushButton::clicked, this, &ModifyConstraintActivitiesEndTeachersDayForm::ok);
...
ModifyConstraintActivitiesEndTeachersDayForm::~ModifyConstraintActivitiesEndTeachersDayForm()
{
	saveFETDialogGeometry(this);
}

void ModifyConstraintActivitiesEndTeachersDayForm::updateTeachersComboBox(){
	int i=0, j=-1;
...
void ModifyConstraintActivitiesEndTeachersDayForm::updateStudentsComboBox(QWidget* parent){
	int i=0, j=-1;
...
void ModifyConstraintActivitiesEndTeachersDayForm::updateSubjectsComboBox(){
	int i=0, j=-1;
...
void ModifyConstraintActivitiesEndTeachersDayForm::updateActivityTagsComboBox(){
	int i=0, j=-1;
...
void ModifyConstraintActivitiesEndTeachersDayForm::ok()
{
...
void ModifyConstraintActivitiesEndTeachersDayForm::cancel()
{
	this->close();
}
