...
#include "constraintteachersmingapsbetweenbuildingchangesform_template.h"
...
class ConstraintTeachersMinGapsBetweenBuildingChangesForm : public ConstraintTeachersMinGapsBetweenBuildingChangesForm_template  {
public:
