...
TimetableExportiCalTeachersWithRooms1Form::TimetableExportiCalTeachersWithRooms1Form()
 : TimetableExportiCalTeachersWithRooms1Form_template()
{
...
void TimetableExportiCalTeachersWithRooms1Form::ok()
{
	//verify the data
...
void TimetableExportiCalTeachersWithRooms1Form::cancel()
{
	this->close();
}
