...
ModifyConstraintTeacherMaxGapsPerDayForm::ModifyConstraintTeacherMaxGapsPerDayForm(QWidget* parent, ConstraintTeacherMaxGapsPerDay* ctr): QDialog(parent)
{
	...
	connect(okPushButton, &QPushButton::clicked, this, &ModifyConstraintTeacherMaxGapsPerDayForm::ok);
	connect(cancelPushButton, &QPushButton::clicked, this, &ModifyConstraintTeacherMaxGapsPerDayForm::cancel);
