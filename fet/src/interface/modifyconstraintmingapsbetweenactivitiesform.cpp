...
ModifyConstraintMinGapsBetweenActivitiesForm::ModifyConstraintMinGapsBetweenActivitiesForm(QWidget* parent, ConstraintMinGapsBetweenActivities* ctr): QDialog(parent)
{
	...
	connect(cancelPushButton, &QPushButton::clicked, this, &ModifyConstraintMinGapsBetweenActivitiesForm::cancel);
	connect(okPushButton, &QPushButton::clicked, this, &ModifyConstraintMinGapsBetweenActivitiesForm::ok);
	connect(allActivitiesListWidget, &QListWidget::itemDoubleClicked, this, &ModifyConstraintMinGapsBetweenActivitiesForm::addActivity);
	connect(addAllActivitiesPushButton, &QPushButton::clicked, this, &ModifyConstraintMinGapsBetweenActivitiesForm::addAllActivities);
	connect(selectedActivitiesListWidget, &QListWidget::itemDoubleClicked, this, &ModifyConstraintMinGapsBetweenActivitiesForm::removeActivity);

	connect(clearPushButton, &QPushButton::clicked, this, &ModifyConstraintMinGapsBetweenActivitiesForm::clear);
	...
	connect(teachersComboBox, qOverload<int>(&QComboBox::currentIndexChanged), this, &ModifyConstraintMinGapsBetweenActivitiesForm::filterChanged);
	connect(studentsComboBox, qOverload<int>(&QComboBox::currentIndexChanged), this, &ModifyConstraintMinGapsBetweenActivitiesForm::filterChanged);
	connect(subjectsComboBox, qOverload<int>(&QComboBox::currentIndexChanged), this, &ModifyConstraintMinGapsBetweenActivitiesForm::filterChanged);
	connect(activityTagsComboBox, qOverload<int>(&QComboBox::currentIndexChanged), this, &ModifyConstraintMinGapsBetweenActivitiesForm::filterChanged);
}
