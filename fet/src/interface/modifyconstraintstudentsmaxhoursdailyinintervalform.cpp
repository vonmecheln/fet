/***************************************************************************
                          modifyconstraintstudentsmaxhoursdailyinintervalform.cpp  -  description
                             -------------------
    begin                : 2024
...
ModifyConstraintStudentsMaxHoursDailyInIntervalForm::ModifyConstraintStudentsMaxHoursDailyInIntervalForm(QWidget* parent, ConstraintStudentsMaxHoursDailyInInterval* ctr): QDialog(parent)
{
	setupUi(this);

	okPushButton->setDefault(true);

	connect(okPushButton, &QPushButton::clicked, this, &ModifyConstraintStudentsMaxHoursDailyInIntervalForm::ok);
	connect(cancelPushButton, &QPushButton::clicked, this, &ModifyConstraintStudentsMaxHoursDailyInIntervalForm::cancel);
...
ModifyConstraintStudentsMaxHoursDailyInIntervalForm::~ModifyConstraintStudentsMaxHoursDailyInIntervalForm()
{
	saveFETDialogGeometry(this);
}

void ModifyConstraintStudentsMaxHoursDailyInIntervalForm::ok()
{
	double weight;
...
void ModifyConstraintStudentsMaxHoursDailyInIntervalForm::cancel()
{
	this->close();
}
