/***************************************************************************
                          modifyconstraintstudentssetmaxroomchangesperdayinintervalform.cpp  -  description
                             -------------------
    begin                : 2024
...
ModifyConstraintStudentsSetMaxRoomChangesPerDayInIntervalForm::ModifyConstraintStudentsSetMaxRoomChangesPerDayInIntervalForm(QWidget* parent, ConstraintStudentsSetMaxRoomChangesPerDayInInterval* ctr): QDialog(parent)
{
	setupUi(this);

	okPushButton->setDefault(true);

	connect(okPushButton, &QPushButton::clicked, this, &ModifyConstraintStudentsSetMaxRoomChangesPerDayInIntervalForm::ok);
	connect(cancelPushButton, &QPushButton::clicked, this, &ModifyConstraintStudentsSetMaxRoomChangesPerDayInIntervalForm::cancel);
...
ModifyConstraintStudentsSetMaxRoomChangesPerDayInIntervalForm::~ModifyConstraintStudentsSetMaxRoomChangesPerDayInIntervalForm()
{
	saveFETDialogGeometry(this);
}

void ModifyConstraintStudentsSetMaxRoomChangesPerDayInIntervalForm::updateStudentsComboBox(QWidget* parent)
{
...
void ModifyConstraintStudentsSetMaxRoomChangesPerDayInIntervalForm::ok()
{
...
void ModifyConstraintStudentsSetMaxRoomChangesPerDayInIntervalForm::cancel()
{
	this->close();
}
