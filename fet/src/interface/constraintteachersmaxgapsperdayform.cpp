...
{
	AddConstraintTeachersMaxGapsPerDayForm *form=new AddConstraintTeachersMaxGapsPerDayForm();
	form->exec();
...
void ConstraintTeachersMaxGapsPerDayForm::modifyConstraint()
{
	...
	ModifyConstraintTeachersMaxGapsPerDayForm *form = new ModifyConstraintTeachersMaxGapsPerDayForm((ConstraintTeachersMaxGapsPerDay*)ctr);
	form->exec();
