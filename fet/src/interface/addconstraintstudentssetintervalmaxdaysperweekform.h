...
#include "addconstraintstudentssetintervalmaxdaysperweekform_template.h"
...
class AddConstraintStudentsSetIntervalMaxDaysPerWeekForm : public AddConstraintStudentsSetIntervalMaxDaysPerWeekForm_template  {
	Q_OBJECT
public:
