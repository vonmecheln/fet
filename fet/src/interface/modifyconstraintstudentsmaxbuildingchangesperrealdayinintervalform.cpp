/***************************************************************************
                          modifyconstraintstudentsmaxbuildingchangesperrealdayinintervalform.cpp  -  description
                             -------------------
    begin                : 2024
...
ModifyConstraintStudentsMaxBuildingChangesPerRealDayInIntervalForm::ModifyConstraintStudentsMaxBuildingChangesPerRealDayInIntervalForm(QWidget* parent, ConstraintStudentsMaxBuildingChangesPerRealDayInInterval* ctr): QDialog(parent)
{
	setupUi(this);

	okPushButton->setDefault(true);

	connect(okPushButton, &QPushButton::clicked, this, &ModifyConstraintStudentsMaxBuildingChangesPerRealDayInIntervalForm::ok);
	connect(cancelPushButton, &QPushButton::clicked, this, &ModifyConstraintStudentsMaxBuildingChangesPerRealDayInIntervalForm::cancel);
...
ModifyConstraintStudentsMaxBuildingChangesPerRealDayInIntervalForm::~ModifyConstraintStudentsMaxBuildingChangesPerRealDayInIntervalForm()
{
	saveFETDialogGeometry(this);
}

void ModifyConstraintStudentsMaxBuildingChangesPerRealDayInIntervalForm::ok()
{
	double weight;
...
void ModifyConstraintStudentsMaxBuildingChangesPerRealDayInIntervalForm::cancel()
{
	this->close();
}
