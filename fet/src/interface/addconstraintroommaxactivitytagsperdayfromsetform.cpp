/***************************************************************************
                          addconstraintroommaxactivitytagsperdayfromsetform.cpp  -  description
                             -------------------
    begin                : 2024
...
AddConstraintRoomMaxActivityTagsPerDayFromSetForm::AddConstraintRoomMaxActivityTagsPerDayFromSetForm(QWidget* parent): QDialog(parent)
{
	setupUi(this);
	...
	connect(addConstraintPushButton, &QPushButton::clicked, this, &AddConstraintRoomMaxActivityTagsPerDayFromSetForm::addCurrentConstraint);
	connect(closePushButton, &QPushButton::clicked, this, &AddConstraintRoomMaxActivityTagsPerDayFromSetForm::close);

	connect(allActivityTagsListWidget, &QListWidget::itemDoubleClicked, this, &AddConstraintRoomMaxActivityTagsPerDayFromSetForm::addActivityTag);
	connect(selectedActivityTagsListWidget, &QListWidget::itemDoubleClicked, this, &AddConstraintRoomMaxActivityTagsPerDayFromSetForm::removeActivityTag);

	connect(clearActivityTagsPushButton, &QPushButton::clicked, this, &AddConstraintRoomMaxActivityTagsPerDayFromSetForm::clearActivityTags);

	connect(filterCheckBox, &QCheckBox::toggled, this, &AddConstraintRoomMaxActivityTagsPerDayFromSetForm::filter);
	...
	connect(roomsComboBox, qOverload<int>(&QComboBox::currentIndexChanged), this, &AddConstraintRoomMaxActivityTagsPerDayFromSetForm::filter);
...
AddConstraintRoomMaxActivityTagsPerDayFromSetForm::~AddConstraintRoomMaxActivityTagsPerDayFromSetForm()
{
	saveFETDialogGeometry(this);
}

void AddConstraintRoomMaxActivityTagsPerDayFromSetForm::filter()
{
...
void AddConstraintRoomMaxActivityTagsPerDayFromSetForm::addActivityTag()
{
...
void AddConstraintRoomMaxActivityTagsPerDayFromSetForm::removeActivityTag()
{
...
void AddConstraintRoomMaxActivityTagsPerDayFromSetForm::clearActivityTags()
{
	selectedActivityTagsListWidget->clear();
}

void AddConstraintRoomMaxActivityTagsPerDayFromSetForm::addCurrentConstraint()
{
	...
	ctr=new ConstraintRoomMaxActivityTagsPerDayFromSet(weight, room->name, maxActivityTagsSpinBox->value(), selectedActivityTagsList);
