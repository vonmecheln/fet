...
#include "constraintteachermaxbuildingchangesperdayform_template.h"
...
class ConstraintTeacherMaxBuildingChangesPerDayForm : public ConstraintTeacherMaxBuildingChangesPerDayForm_template  {
public:
