...
#include "modifyconstraintactivitytagpreferredroomform_template.h"
...
class ModifyConstraintActivityTagPreferredRoomForm : public ModifyConstraintActivityTagPreferredRoomForm_template  {
