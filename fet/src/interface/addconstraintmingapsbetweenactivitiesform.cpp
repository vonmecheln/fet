...
AddConstraintMinGapsBetweenActivitiesForm::AddConstraintMinGapsBetweenActivitiesForm(QWidget* parent): QDialog(parent)
{
	...
	connect(closePushButton, &QPushButton::clicked, this, &AddConstraintMinGapsBetweenActivitiesForm::close);
	connect(addConstraintPushButton, &QPushButton::clicked, this, &AddConstraintMinGapsBetweenActivitiesForm::addConstraint);
	connect(allActivitiesListWidget, &QListWidget::itemDoubleClicked, this, &AddConstraintMinGapsBetweenActivitiesForm::addActivity);
	connect(addAllActivitiesPushButton, &QPushButton::clicked, this, &AddConstraintMinGapsBetweenActivitiesForm::addAllActivities);
	connect(selectedActivitiesListWidget, &QListWidget::itemDoubleClicked, this, &AddConstraintMinGapsBetweenActivitiesForm::removeActivity);
	connect(clearPushButton, &QPushButton::clicked, this, &AddConstraintMinGapsBetweenActivitiesForm::clear);
	...
	connect(teachersComboBox, qOverload<int>(&QComboBox::currentIndexChanged), this, &AddConstraintMinGapsBetweenActivitiesForm::filterChanged);
	connect(studentsComboBox, qOverload<int>(&QComboBox::currentIndexChanged), this, &AddConstraintMinGapsBetweenActivitiesForm::filterChanged);
	connect(subjectsComboBox, qOverload<int>(&QComboBox::currentIndexChanged), this, &AddConstraintMinGapsBetweenActivitiesForm::filterChanged);
	connect(activityTagsComboBox, qOverload<int>(&QComboBox::currentIndexChanged), this, &AddConstraintMinGapsBetweenActivitiesForm::filterChanged);
}
