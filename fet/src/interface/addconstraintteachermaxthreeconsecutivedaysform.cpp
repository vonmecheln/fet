/***************************************************************************
                          addconstraintteachermaxthreeconsecutivedaysform.cpp  -  description
                             -------------------
    begin                : 2021
...
AddConstraintTeacherMaxThreeConsecutiveDaysForm::AddConstraintTeacherMaxThreeConsecutiveDaysForm(QWidget* parent): QDialog(parent)
{
	setupUi(this);
...
AddConstraintTeacherMaxThreeConsecutiveDaysForm::~AddConstraintTeacherMaxThreeConsecutiveDaysForm()
{
	saveFETDialogGeometry(this);
}

void AddConstraintTeacherMaxThreeConsecutiveDaysForm::updateTeachersComboBox(){
...
void AddConstraintTeacherMaxThreeConsecutiveDaysForm::updateExceptionCheckBox(){
	allowAMAMExceptionCheckBox->setChecked(false);
}

void AddConstraintTeacherMaxThreeConsecutiveDaysForm::addCurrentConstraint()
{
	...
	ctr=new ConstraintTeacherMaxThreeConsecutiveDays(weight, ae, teacher_name);
...
void AddConstraintTeacherMaxThreeConsecutiveDaysForm::addCurrentConstraints()
{
