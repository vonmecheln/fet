...
#include "addconstraintstudentssetmaxbuildingchangesperdayform_template.h"
...
class AddConstraintStudentsSetMaxBuildingChangesPerDayForm : public AddConstraintStudentsSetMaxBuildingChangesPerDayForm_template  {
public:
