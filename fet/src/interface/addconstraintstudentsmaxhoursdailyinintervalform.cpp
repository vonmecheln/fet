/***************************************************************************
                          addconstraintstudentsmaxhoursdailyinintervalform.cpp  -  description
                             -------------------
    begin                : 2024
...
AddConstraintStudentsMaxHoursDailyInIntervalForm::AddConstraintStudentsMaxHoursDailyInIntervalForm(QWidget* parent): QDialog(parent)
{
	setupUi(this);

	addConstraintPushButton->setDefault(true);

	connect(addConstraintPushButton, &QPushButton::clicked, this, &AddConstraintStudentsMaxHoursDailyInIntervalForm::addCurrentConstraint);
	connect(closePushButton, &QPushButton::clicked, this, &AddConstraintStudentsMaxHoursDailyInIntervalForm::close);
...
AddConstraintStudentsMaxHoursDailyInIntervalForm::~AddConstraintStudentsMaxHoursDailyInIntervalForm()
{
	saveFETDialogGeometry(this);
}

void AddConstraintStudentsMaxHoursDailyInIntervalForm::addCurrentConstraint()
{
	...
	ctr=new ConstraintStudentsMaxHoursDailyInInterval(weight, maxHoursSpinBox->value(), startHour, endHour);
