...
ConstraintStudentsSetMaxTwoActivityTagsPerRealDayFromN1N2N3Form::ConstraintStudentsSetMaxTwoActivityTagsPerRealDayFromN1N2N3Form(QWidget* parent): QDialog(parent)
{
	...
	connect(constraintsListWidget, &QListWidget::currentRowChanged, this, &ConstraintStudentsSetMaxTwoActivityTagsPerRealDayFromN1N2N3Form::constraintChanged);
	connect(addConstraintPushButton, &QPushButton::clicked, this, &ConstraintStudentsSetMaxTwoActivityTagsPerRealDayFromN1N2N3Form::addConstraint);
	connect(closePushButton, &QPushButton::clicked, this, &ConstraintStudentsSetMaxTwoActivityTagsPerRealDayFromN1N2N3Form::close);
	connect(removeConstraintPushButton, &QPushButton::clicked, this, &ConstraintStudentsSetMaxTwoActivityTagsPerRealDayFromN1N2N3Form::removeConstraint);
	connect(modifyConstraintPushButton, &QPushButton::clicked, this, &ConstraintStudentsSetMaxTwoActivityTagsPerRealDayFromN1N2N3Form::modifyConstraint);
	connect(constraintsListWidget, &QListWidget::itemDoubleClicked, this, &ConstraintStudentsSetMaxTwoActivityTagsPerRealDayFromN1N2N3Form::modifyConstraint);
	connect(helpPushButton, &QPushButton::clicked, this, &ConstraintStudentsSetMaxTwoActivityTagsPerRealDayFromN1N2N3Form::help);
	...
	connect(studentsComboBox, qOverload<int>(&QComboBox::currentIndexChanged), this, &ConstraintStudentsSetMaxTwoActivityTagsPerRealDayFromN1N2N3Form::filterChanged);
}
