/***************************************************************************
                          addconstraintteachermaxactivitytagsperrealdayfromsetform.cpp  -  description
                             -------------------
    begin                : 2024
...
AddConstraintTeacherMaxActivityTagsPerRealDayFromSetForm::AddConstraintTeacherMaxActivityTagsPerRealDayFromSetForm(QWidget* parent): QDialog(parent)
{
	setupUi(this);

	addConstraintPushButton->setDefault(true);

	connect(addConstraintPushButton, &QPushButton::clicked, this, &AddConstraintTeacherMaxActivityTagsPerRealDayFromSetForm::addCurrentConstraint);
	connect(addConstraintsPushButton, &QPushButton::clicked, this, &AddConstraintTeacherMaxActivityTagsPerRealDayFromSetForm::addCurrentConstraints);
	connect(closePushButton, &QPushButton::clicked, this, &AddConstraintTeacherMaxActivityTagsPerRealDayFromSetForm::close);

	connect(allActivityTagsListWidget, &QListWidget::itemDoubleClicked, this, &AddConstraintTeacherMaxActivityTagsPerRealDayFromSetForm::addActivityTag);
	connect(selectedActivityTagsListWidget, &QListWidget::itemDoubleClicked, this, &AddConstraintTeacherMaxActivityTagsPerRealDayFromSetForm::removeActivityTag);

	connect(clearActivityTagsPushButton, &QPushButton::clicked, this, &AddConstraintTeacherMaxActivityTagsPerRealDayFromSetForm::clearActivityTags);
...
AddConstraintTeacherMaxActivityTagsPerRealDayFromSetForm::~AddConstraintTeacherMaxActivityTagsPerRealDayFromSetForm()
{
	saveFETDialogGeometry(this);
}

void AddConstraintTeacherMaxActivityTagsPerRealDayFromSetForm::addActivityTag()
{
...
void AddConstraintTeacherMaxActivityTagsPerRealDayFromSetForm::removeActivityTag()
{
...
void AddConstraintTeacherMaxActivityTagsPerRealDayFromSetForm::clearActivityTags()
{
	selectedActivityTagsListWidget->clear();
}

void AddConstraintTeacherMaxActivityTagsPerRealDayFromSetForm::addCurrentConstraint()
{
	...
	ctr=new ConstraintTeacherMaxActivityTagsPerRealDayFromSet(weight, teacher_name, maxActivityTagsSpinBox->value(), selectedActivityTagsList);
...
void AddConstraintTeacherMaxActivityTagsPerRealDayFromSetForm::addCurrentConstraints()
{
