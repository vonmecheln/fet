...
#include "modifyconstraintteachersmaxdaysperweekform_template.h"
...
class ModifyConstraintTeachersMaxDaysPerWeekForm : public ModifyConstraintTeachersMaxDaysPerWeekForm_template  {
	Q_OBJECT
