...
#include "modifyconstraintactivitytagpreferredroomsform_template.h"
...
class ModifyConstraintActivityTagPreferredRoomsForm : public ModifyConstraintActivityTagPreferredRoomsForm_template  {
public:
