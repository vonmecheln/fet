/***************************************************************************
                          modifyconstraintteachermaxroomchangesperrealdayinintervalform.cpp  -  description
                             -------------------
    begin                : 2024
...
ModifyConstraintTeacherMaxRoomChangesPerRealDayInIntervalForm::ModifyConstraintTeacherMaxRoomChangesPerRealDayInIntervalForm(QWidget* parent, ConstraintTeacherMaxRoomChangesPerRealDayInInterval* ctr): QDialog(parent)
{
	setupUi(this);

	okPushButton->setDefault(true);

	connect(okPushButton, &QPushButton::clicked, this, &ModifyConstraintTeacherMaxRoomChangesPerRealDayInIntervalForm::ok);
	connect(cancelPushButton, &QPushButton::clicked, this, &ModifyConstraintTeacherMaxRoomChangesPerRealDayInIntervalForm::cancel);
...
ModifyConstraintTeacherMaxRoomChangesPerRealDayInIntervalForm::~ModifyConstraintTeacherMaxRoomChangesPerRealDayInIntervalForm()
{
	saveFETDialogGeometry(this);
}

void ModifyConstraintTeacherMaxRoomChangesPerRealDayInIntervalForm::updateTeachersComboBox(){
...
void ModifyConstraintTeacherMaxRoomChangesPerRealDayInIntervalForm::ok()
{
	double weight;
...
void ModifyConstraintTeacherMaxRoomChangesPerRealDayInIntervalForm::cancel()
{
	this->close();
}
