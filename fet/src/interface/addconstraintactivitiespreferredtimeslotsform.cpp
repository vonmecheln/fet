...
//#define YES	(AddConstraintActivitiesPreferredTimeSlotsForm::tr("Allowed", "Please keep translation short"))
//#define NO	(AddConstraintActivitiesPreferredTimeSlotsForm::tr("Not allowed", "Please keep translation short"))
#define YES		(QString(" "))
#define NO		(QString("X"))
