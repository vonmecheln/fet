 ...
 (QWidget* parent, ConstraintTeachersMinGapsBetweenActivityTag* ctr): QDialog(parent)
{
	...
	connect(okPushButton, &QPushButton::clicked, this, &ModifyConstraintTeachersMinGapsBetweenActivityTagForm::ok);
	connect(cancelPushButton, &QPushButton::clicked, this, &ModifyConstraintTeachersMinGapsBetweenActivityTagForm::cancel);
