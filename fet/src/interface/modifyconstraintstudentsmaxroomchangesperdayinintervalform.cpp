/***************************************************************************
                          modifyconstraintstudentsmaxroomchangesperdayinintervalform.cpp  -  description
                             -------------------
    begin                : 2024
...
ModifyConstraintStudentsMaxRoomChangesPerDayInIntervalForm::ModifyConstraintStudentsMaxRoomChangesPerDayInIntervalForm(QWidget* parent, ConstraintStudentsMaxRoomChangesPerDayInInterval* ctr): QDialog(parent)
{
	setupUi(this);

	okPushButton->setDefault(true);

	connect(okPushButton, &QPushButton::clicked, this, &ModifyConstraintStudentsMaxRoomChangesPerDayInIntervalForm::ok);
	connect(cancelPushButton, &QPushButton::clicked, this, &ModifyConstraintStudentsMaxRoomChangesPerDayInIntervalForm::cancel);
...
ModifyConstraintStudentsMaxRoomChangesPerDayInIntervalForm::~ModifyConstraintStudentsMaxRoomChangesPerDayInIntervalForm()
{
	saveFETDialogGeometry(this);
}

void ModifyConstraintStudentsMaxRoomChangesPerDayInIntervalForm::ok()
{
	double weight;
...
void ModifyConstraintStudentsMaxRoomChangesPerDayInIntervalForm::cancel()
{
	this->close();
}
