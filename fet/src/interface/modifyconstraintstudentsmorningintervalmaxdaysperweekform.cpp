/***************************************************************************
                          modifyconstraintstudentsmorningintervalmaxdaysperweekform.cpp  -  description
                             -------------------
    begin                : 2020
...
ModifyConstraintStudentsMorningIntervalMaxDaysPerWeekForm::ModifyConstraintStudentsMorningIntervalMaxDaysPerWeekForm(QWidget* parent, ConstraintStudentsMorningIntervalMaxDaysPerWeek* ctr): QDialog(parent)
{
	setupUi(this);

	okPushButton->setDefault(true);

	connect(okPushButton, &QPushButton::clicked, this, &ModifyConstraintStudentsMorningIntervalMaxDaysPerWeekForm::ok);
	connect(cancelPushButton, &QPushButton::clicked, this, &ModifyConstraintStudentsMorningIntervalMaxDaysPerWeekForm::cancel);
...
ModifyConstraintStudentsMorningIntervalMaxDaysPerWeekForm::~ModifyConstraintStudentsMorningIntervalMaxDaysPerWeekForm()
{
	saveFETDialogGeometry(this);
}

void ModifyConstraintStudentsMorningIntervalMaxDaysPerWeekForm::updateMaxDaysSpinBox(){
	maxDaysSpinBox->setMinimum(0);
	maxDaysSpinBox->setMaximum(gt.rules.nDaysPerWeek/2);
}

void ModifyConstraintStudentsMorningIntervalMaxDaysPerWeekForm::ok()
{
	double weight;
...
void ModifyConstraintStudentsMorningIntervalMaxDaysPerWeekForm::cancel()
{
	this->close();
}
