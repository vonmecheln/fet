...
AddConstraintTeacherMaxBuildingChangesPerDayForm::AddConstraintTeacherMaxBuildingChangesPerDayForm(QWidget* parent): QDialog(parent)
{
	...
	connect(addConstraintPushButton, &QPushButton::clicked, this, &AddConstraintTeacherMaxBuildingChangesPerDayForm::addCurrentConstraint);
	connect(addConstraintsPushButton, &QPushButton::clicked, this, &AddConstraintTeacherMaxBuildingChangesPerDayForm::addCurrentConstraints);
	connect(closePushButton, &QPushButton::clicked, this, &AddConstraintTeacherMaxBuildingChangesPerDayForm::close);
