...
#include "addconstraintteachermaxhourscontinuouslyform_template.h"
...
class AddConstraintTeacherMaxHoursContinuouslyForm : public AddConstraintTeacherMaxHoursContinuouslyForm_template  {
public:
