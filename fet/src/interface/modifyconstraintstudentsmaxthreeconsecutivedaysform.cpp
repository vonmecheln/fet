...
ModifyConstraintStudentsMaxThreeConsecutiveDaysForm::ModifyConstraintStudentsMaxThreeConsecutiveDaysForm(QWidget* parent, ConstraintStudentsMaxThreeConsecutiveDays* ctr): QDialog(parent)
{
	...
	connect(okPushButton, &QPushButton::clicked, this, &ModifyConstraintStudentsMaxThreeConsecutiveDaysForm::ok);
	connect(cancelPushButton, &QPushButton::clicked, this, &ModifyConstraintStudentsMaxThreeConsecutiveDaysForm::cancel);
