...
ConstraintMaxTotalActivitiesFromSetInSelectedTimeSlotsForm::ConstraintMaxTotalActivitiesFromSetInSelectedTimeSlotsForm(QWidget* parent): QDialog(parent)
{
	...
	connect(constraintsListWidget, &QListWidget::currentRowChanged, this, &ConstraintMaxTotalActivitiesFromSetInSelectedTimeSlotsForm::constraintChanged);
	connect(addConstraintPushButton, &QPushButton::clicked, this, &ConstraintMaxTotalActivitiesFromSetInSelectedTimeSlotsForm::addConstraint);
	connect(closePushButton, &QPushButton::clicked, this, &ConstraintMaxTotalActivitiesFromSetInSelectedTimeSlotsForm::close);
	connect(removeConstraintPushButton, &QPushButton::clicked, this, &ConstraintMaxTotalActivitiesFromSetInSelectedTimeSlotsForm::removeConstraint);
	connect(modifyConstraintPushButton, &QPushButton::clicked, this, &ConstraintMaxTotalActivitiesFromSetInSelectedTimeSlotsForm::modifyConstraint);
	connect(constraintsListWidget, &QListWidget::itemDoubleClicked, this, &ConstraintMaxTotalActivitiesFromSetInSelectedTimeSlotsForm::modifyConstraint);

	connect(helpPushButton, &QPushButton::clicked, this, &ConstraintMaxTotalActivitiesFromSetInSelectedTimeSlotsForm::help);
...
///////////////
	...
	connect(teachersComboBox, qOverload<int>(&QComboBox::currentIndexChanged), this, &ConstraintMaxTotalActivitiesFromSetInSelectedTimeSlotsForm::filterChanged);
	connect(studentsComboBox, qOverload<int>(&QComboBox::currentIndexChanged), this, &ConstraintMaxTotalActivitiesFromSetInSelectedTimeSlotsForm::filterChanged);
	connect(subjectsComboBox, qOverload<int>(&QComboBox::currentIndexChanged), this, &ConstraintMaxTotalActivitiesFromSetInSelectedTimeSlotsForm::filterChanged);
	connect(activityTagsComboBox, qOverload<int>(&QComboBox::currentIndexChanged), this, &ConstraintMaxTotalActivitiesFromSetInSelectedTimeSlotsForm::filterChanged);
}
