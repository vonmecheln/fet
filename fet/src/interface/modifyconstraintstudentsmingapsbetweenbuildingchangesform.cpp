...
ModifyConstraintStudentsMinGapsBetweenBuildingChangesForm::ModifyConstraintStudentsMinGapsBetweenBuildingChangesForm(QWidget* parent, ConstraintStudentsMinGapsBetweenBuildingChanges* ctr): QDialog(parent)
{
	...
	connect(okPushButton, &QPushButton::clicked, this, &ModifyConstraintStudentsMinGapsBetweenBuildingChangesForm::ok);
	connect(cancelPushButton, &QPushButton::clicked, this, &ModifyConstraintStudentsMinGapsBetweenBuildingChangesForm::cancel);
