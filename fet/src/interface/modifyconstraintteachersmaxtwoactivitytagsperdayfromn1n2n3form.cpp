...
ModifyConstraintTeachersMaxTwoActivityTagsPerDayFromN1N2N3Form::ModifyConstraintTeachersMaxTwoActivityTagsPerDayFromN1N2N3Form(QWidget* parent, ConstraintTeachersMaxTwoActivityTagsPerDayFromN1N2N3* ctr): QDialog(parent)
{
	...
	connect(okPushButton, &QPushButton::clicked, this, &ModifyConstraintTeachersMaxTwoActivityTagsPerDayFromN1N2N3Form::ok);
	connect(cancelPushButton, &QPushButton::clicked, this, &ModifyConstraintTeachersMaxTwoActivityTagsPerDayFromN1N2N3Form::cancel);
