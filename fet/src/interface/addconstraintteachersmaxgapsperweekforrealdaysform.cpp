...
AddConstraintTeachersMaxGapsPerWeekForRealDaysForm::AddConstraintTeachersMaxGapsPerWeekForRealDaysForm(QWidget* parent): QDialog(parent)
{
	...
	connect(addConstraintPushButton, &QPushButton::clicked, this, &AddConstraintTeachersMaxGapsPerWeekForRealDaysForm::addCurrentConstraint);
	connect(addConstraintsPushButton, &QPushButton::clicked, this, &AddConstraintTeachersMaxGapsPerWeekForRealDaysForm::addCurrentConstraints);
	connect(closePushButton, &QPushButton::clicked, this, &AddConstraintTeachersMaxGapsPerWeekForRealDaysForm::close);
...
void AddConstraintTeachersMaxGapsPerWeekForRealDaysForm::addCurrentConstraints()
{
