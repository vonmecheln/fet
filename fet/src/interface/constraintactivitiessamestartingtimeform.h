...
#include "constraintactivitiessamestartingtimeform_template.h"
...
class ConstraintActivitiesSameStartingTimeForm : public ConstraintActivitiesSameStartingTimeForm_template  {
public:
