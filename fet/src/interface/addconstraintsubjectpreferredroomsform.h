...
#include "addconstraintsubjectpreferredroomsform_template.h"
...
class AddConstraintSubjectPreferredRoomsForm : public AddConstraintSubjectPreferredRoomsForm_template  {
public:
