...
ConstraintTeachersMaxTwoActivityTagsPerDayFromN1N2N3Form::ConstraintTeachersMaxTwoActivityTagsPerDayFromN1N2N3Form(QWidget* parent): QDialog(parent)
{
	...
	connect(constraintsListWidget, &QListWidget::currentRowChanged, this, &ConstraintTeachersMaxTwoActivityTagsPerDayFromN1N2N3Form::constraintChanged);
	connect(addConstraintPushButton, &QPushButton::clicked, this, &ConstraintTeachersMaxTwoActivityTagsPerDayFromN1N2N3Form::addConstraint);
	connect(closePushButton, &QPushButton::clicked, this, &ConstraintTeachersMaxTwoActivityTagsPerDayFromN1N2N3Form::close);
	connect(removeConstraintPushButton, &QPushButton::clicked, this, &ConstraintTeachersMaxTwoActivityTagsPerDayFromN1N2N3Form::removeConstraint);
	connect(modifyConstraintPushButton, &QPushButton::clicked, this, &ConstraintTeachersMaxTwoActivityTagsPerDayFromN1N2N3Form::modifyConstraint);
	connect(constraintsListWidget, &QListWidget::itemDoubleClicked, this, &ConstraintTeachersMaxTwoActivityTagsPerDayFromN1N2N3Form::modifyConstraint);
	connect(helpPushButton, &QPushButton::clicked, this, &ConstraintTeachersMaxTwoActivityTagsPerDayFromN1N2N3Form::help);
