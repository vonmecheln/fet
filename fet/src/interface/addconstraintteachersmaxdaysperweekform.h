...
#include "addconstraintteachersmaxdaysperweekform_template.h"
...
class AddConstraintTeachersMaxDaysPerWeekForm : public AddConstraintTeachersMaxDaysPerWeekForm_template  {
	Q_OBJECT
public:
