/***************************************************************************
                          modifyconstraintstudentsmaxactivitytagsperrealdayfromsetform.cpp  -  description
                             -------------------
    begin                : 2024
...
ModifyConstraintStudentsMaxActivityTagsPerRealDayFromSetForm::ModifyConstraintStudentsMaxActivityTagsPerRealDayFromSetForm(QWidget* parent, ConstraintStudentsMaxActivityTagsPerRealDayFromSet* ctr): QDialog(parent)
{
	setupUi(this);

	okPushButton->setDefault(true);

	connect(okPushButton, &QPushButton::clicked, this, &ModifyConstraintStudentsMaxActivityTagsPerRealDayFromSetForm::ok);
	connect(cancelPushButton, &QPushButton::clicked, this, &ModifyConstraintStudentsMaxActivityTagsPerRealDayFromSetForm::cancel);

	connect(allActivityTagsListWidget, &QListWidget::itemDoubleClicked, this, &ModifyConstraintStudentsMaxActivityTagsPerRealDayFromSetForm::addActivityTag);
	connect(selectedActivityTagsListWidget, &QListWidget::itemDoubleClicked, this, &ModifyConstraintStudentsMaxActivityTagsPerRealDayFromSetForm::removeActivityTag);

	connect(clearActivityTagsPushButton, &QPushButton::clicked, this, &ModifyConstraintStudentsMaxActivityTagsPerRealDayFromSetForm::clearActivityTags);
...
ModifyConstraintStudentsMaxActivityTagsPerRealDayFromSetForm::~ModifyConstraintStudentsMaxActivityTagsPerRealDayFromSetForm()
{
	saveFETDialogGeometry(this);
}

void ModifyConstraintStudentsMaxActivityTagsPerRealDayFromSetForm::addActivityTag()
{
...
void ModifyConstraintStudentsMaxActivityTagsPerRealDayFromSetForm::removeActivityTag()
{
...
void ModifyConstraintStudentsMaxActivityTagsPerRealDayFromSetForm::clearActivityTags()
{
	selectedActivityTagsListWidget->clear();
}

void ModifyConstraintStudentsMaxActivityTagsPerRealDayFromSetForm::ok()
{
	double weight;
...
void ModifyConstraintStudentsMaxActivityTagsPerRealDayFromSetForm::cancel()
{
	this->close();
}
