...
#include "addconstraintbasiccompulsoryspaceform_template.h"
...
class AddConstraintBasicCompulsorySpaceForm : public AddConstraintBasicCompulsorySpaceForm_template  {
public:
