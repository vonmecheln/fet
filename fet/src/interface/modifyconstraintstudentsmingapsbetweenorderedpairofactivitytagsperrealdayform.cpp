/***************************************************************************
                          modifyconstraintstudentsmingapsbetweenorderedpairofactivitytagsperrealdayform.cpp  -  description
                             -------------------
    begin                : 2024
...
ModifyConstraintStudentsMinGapsBetweenOrderedPairOfActivityTagsPerRealDayForm::ModifyConstraintStudentsMinGapsBetweenOrderedPairOfActivityTagsPerRealDayForm
 (QWidget* parent, ConstraintStudentsMinGapsBetweenOrderedPairOfActivityTagsPerRealDay* ctr): QDialog(parent)
{
	setupUi(this);

	okPushButton->setDefault(true);

	connect(okPushButton, &QPushButton::clicked, this, &ModifyConstraintStudentsMinGapsBetweenOrderedPairOfActivityTagsPerRealDayForm::ok);
	connect(cancelPushButton, &QPushButton::clicked, this, &ModifyConstraintStudentsMinGapsBetweenOrderedPairOfActivityTagsPerRealDayForm::cancel);

	connect(swapPushButton, &QPushButton::clicked, this, &ModifyConstraintStudentsMinGapsBetweenOrderedPairOfActivityTagsPerRealDayForm::swap);
...
void ModifyConstraintStudentsMinGapsBetweenOrderedPairOfActivityTagsPerRealDayForm::updateFirstActivityTagComboBox()
{
...
void ModifyConstraintStudentsMinGapsBetweenOrderedPairOfActivityTagsPerRealDayForm::updateSecondActivityTagComboBox()
{
...
void ModifyConstraintStudentsMinGapsBetweenOrderedPairOfActivityTagsPerRealDayForm::ok()
{
	double weight;
...
void ModifyConstraintStudentsMinGapsBetweenOrderedPairOfActivityTagsPerRealDayForm::cancel()
{
	this->close();
}

void ModifyConstraintStudentsMinGapsBetweenOrderedPairOfActivityTagsPerRealDayForm::swap()
{
