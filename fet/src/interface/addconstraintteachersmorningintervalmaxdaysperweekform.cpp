/***************************************************************************
                          addconstraintteachersmorningintervalmaxdaysperweekform.cpp  -  description
                             -------------------
    begin                : 2020
...
AddConstraintTeachersMorningIntervalMaxDaysPerWeekForm::AddConstraintTeachersMorningIntervalMaxDaysPerWeekForm(QWidget* parent): QDialog(parent)
{
	setupUi(this);

	addConstraintPushButton->setDefault(true);

	connect(addConstraintPushButton, &QPushButton::clicked, this, &AddConstraintTeachersMorningIntervalMaxDaysPerWeekForm::addCurrentConstraint);
	connect(addConstraintsPushButton, &QPushButton::clicked, this, &AddConstraintTeachersMorningIntervalMaxDaysPerWeekForm::addCurrentConstraints);
	connect(closePushButton, &QPushButton::clicked, this, &AddConstraintTeachersMorningIntervalMaxDaysPerWeekForm::close);
...
AddConstraintTeachersMorningIntervalMaxDaysPerWeekForm::~AddConstraintTeachersMorningIntervalMaxDaysPerWeekForm()
{
	saveFETDialogGeometry(this);
}

void AddConstraintTeachersMorningIntervalMaxDaysPerWeekForm::updateMaxDaysSpinBox(){
...
void AddConstraintTeachersMorningIntervalMaxDaysPerWeekForm::updateStartHoursComboBox()
{
...
void AddConstraintTeachersMorningIntervalMaxDaysPerWeekForm::updateEndHoursComboBox()
{
...
void AddConstraintTeachersMorningIntervalMaxDaysPerWeekForm::addCurrentConstraint()
{
	...
	ctr=new ConstraintTeachersMorningIntervalMaxDaysPerWeek(weight, max_days, startHour, endHour);
...
void AddConstraintTeachersMorningIntervalMaxDaysPerWeekForm::addCurrentConstraints()
{
