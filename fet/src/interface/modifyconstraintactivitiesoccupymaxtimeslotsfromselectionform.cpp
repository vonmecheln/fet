...
ModifyConstraintActivitiesOccupyMaxTimeSlotsFromSelectionForm::ModifyConstraintActivitiesOccupyMaxTimeSlotsFromSelectionForm(QWidget* parent, ConstraintActivitiesOccupyMaxTimeSlotsFromSelection* ctr): QDialog(parent)
{
	...
	connect(selectedTimesTable, &QTableWidget::cellEntered, this, &ModifyConstraintActivitiesOccupyMaxTimeSlotsFromSelectionForm::cellEntered);
...
void ModifyConstraintActivitiesOccupyMaxTimeSlotsFromSelectionForm::cellEntered(int row, int col)
{
