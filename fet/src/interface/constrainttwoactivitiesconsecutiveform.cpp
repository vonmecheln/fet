...
ConstraintTwoActivitiesConsecutiveForm::ConstraintTwoActivitiesConsecutiveForm()
{
    ...
    connect(constraintsListBox, SIGNAL(highlighted(int)), this /*ConstraintTwoActivitiesConsecutiveForm_template*/, SLOT(constraintChanged(int)));
    connect(addConstraintPushButton, SIGNAL(clicked()), this /*ConstraintTwoActivitiesConsecutiveForm_template*/, SLOT(addConstraint()));
    connect(closePushButton, SIGNAL(clicked()), this /*ConstraintTwoActivitiesConsecutiveForm_template*/, SLOT(close()));
    connect(removeConstraintPushButton, SIGNAL(clicked()), this /*ConstraintTwoActivitiesConsecutiveForm_template*/, SLOT(removeConstraint()));
    connect(modifyConstraintPushButton, SIGNAL(clicked()), this /*ConstraintTwoActivitiesConsecutiveForm_template*/, SLOT(modifyConstraint()));
    connect(constraintsListBox, SIGNAL(selected(QString)), this /*ConstraintTwoActivitiesConsecutiveForm_template*/, SLOT(modifyConstraint()));
...
{
	AddConstraintTwoActivitiesConsecutiveForm form;
	form.exec();
