...
AddConstraintStudentsMorningIntervalMaxDaysPerWeekForm::AddConstraintStudentsMorningIntervalMaxDaysPerWeekForm(QWidget* parent): QDialog(parent)
{
	setupUi(this);

	addConstraintPushButton->setDefault(true);

	connect(addConstraintPushButton, &QPushButton::clicked, this, &AddConstraintStudentsMorningIntervalMaxDaysPerWeekForm::addCurrentConstraint);
	connect(closePushButton, &QPushButton::clicked, this, &AddConstraintStudentsMorningIntervalMaxDaysPerWeekForm::close);
...
AddConstraintStudentsMorningIntervalMaxDaysPerWeekForm::~AddConstraintStudentsMorningIntervalMaxDaysPerWeekForm()
{
	saveFETDialogGeometry(this);
}

void AddConstraintStudentsMorningIntervalMaxDaysPerWeekForm::updateMaxDaysSpinBox(){
...
void AddConstraintStudentsMorningIntervalMaxDaysPerWeekForm::updateStartHoursComboBox()
{
...
void AddConstraintStudentsMorningIntervalMaxDaysPerWeekForm::updateEndHoursComboBox()
{
...
void AddConstraintStudentsMorningIntervalMaxDaysPerWeekForm::addCurrentConstraint()
{
	...
	ctr=new ConstraintStudentsMorningIntervalMaxDaysPerWeek(weight, /*compulsory,*/ max_days, /*students_name,*/ startHour, endHour);
