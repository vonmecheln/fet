/***************************************************************************
                          addconstraintteachermaxroomchangesperrealdayinintervalform.cpp  -  description
                             -------------------
    begin                : 2024
...
AddConstraintTeacherMaxRoomChangesPerRealDayInIntervalForm::AddConstraintTeacherMaxRoomChangesPerRealDayInIntervalForm(QWidget* parent): QDialog(parent)
{
	setupUi(this);

	addConstraintPushButton->setDefault(true);

	connect(addConstraintPushButton, &QPushButton::clicked, this, &AddConstraintTeacherMaxRoomChangesPerRealDayInIntervalForm::addCurrentConstraint);
	connect(addConstraintsPushButton, &QPushButton::clicked, this, &AddConstraintTeacherMaxRoomChangesPerRealDayInIntervalForm::addCurrentConstraints);
	connect(closePushButton, &QPushButton::clicked, this, &AddConstraintTeacherMaxRoomChangesPerRealDayInIntervalForm::close);
...
AddConstraintTeacherMaxRoomChangesPerRealDayInIntervalForm::~AddConstraintTeacherMaxRoomChangesPerRealDayInIntervalForm()
{
	saveFETDialogGeometry(this);
}

void AddConstraintTeacherMaxRoomChangesPerRealDayInIntervalForm::updateTeachersComboBox(){
...
void AddConstraintTeacherMaxRoomChangesPerRealDayInIntervalForm::addCurrentConstraint()
{
	...
	ctr=new ConstraintTeacherMaxRoomChangesPerRealDayInInterval(weight, teacher_name, maxChangesSpinBox->value(), startHour, endHour);
...
void AddConstraintTeacherMaxRoomChangesPerRealDayInIntervalForm::addCurrentConstraints()
{
