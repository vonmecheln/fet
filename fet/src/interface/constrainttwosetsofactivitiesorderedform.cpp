/***************************************************************************
                          constrainttwosetsofactivitiesorderedform.cpp  -  description
                             -------------------
    begin                : 2021
...
ConstraintTwoSetsOfActivitiesOrderedForm::ConstraintTwoSetsOfActivitiesOrderedForm(QWidget* parent): QDialog(parent)
{
	setupUi(this);
...
bool ConstraintTwoSetsOfActivitiesOrderedForm::filterOk(TimeConstraint* ctr)
{
	if(ctr->type!=CONSTRAINT_TWO_SETS_OF_ACTIVITIES_ORDERED)
		return false;
...
void ConstraintTwoSetsOfActivitiesOrderedForm::filterChanged()
{
...
void ConstraintTwoSetsOfActivitiesOrderedForm::constraintChanged(int index)
{
	if(index<0){
...
void ConstraintTwoSetsOfActivitiesOrderedForm::addConstraint()
{
	AddConstraintTwoSetsOfActivitiesOrderedForm form(this);
...
void ConstraintTwoSetsOfActivitiesOrderedForm::modifyConstraint()
{
...
void ConstraintTwoSetsOfActivitiesOrderedForm::removeConstraint()
{
	int i=constraintsListWidget->currentRow();
	if(i<0){
		QMessageBox::information(this, tr("FET information"), tr("Invalid selected constraint"));
