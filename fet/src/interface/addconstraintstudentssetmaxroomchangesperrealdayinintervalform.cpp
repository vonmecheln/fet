/***************************************************************************
                          addconstraintstudentssetmaxroomchangesperrealdayinintervalform.cpp  -  description
                             -------------------
    begin                : 2024
...
AddConstraintStudentsSetMaxRoomChangesPerRealDayInIntervalForm::AddConstraintStudentsSetMaxRoomChangesPerRealDayInIntervalForm(QWidget* parent): QDialog(parent)
{
	setupUi(this);

	addConstraintPushButton->setDefault(true);

	connect(addConstraintPushButton, &QPushButton::clicked, this, &AddConstraintStudentsSetMaxRoomChangesPerRealDayInIntervalForm::addCurrentConstraint);
	connect(closePushButton, &QPushButton::clicked, this, &AddConstraintStudentsSetMaxRoomChangesPerRealDayInIntervalForm::close);
...
AddConstraintStudentsSetMaxRoomChangesPerRealDayInIntervalForm::~AddConstraintStudentsSetMaxRoomChangesPerRealDayInIntervalForm()
{
	saveFETDialogGeometry(this);
}

void AddConstraintStudentsSetMaxRoomChangesPerRealDayInIntervalForm::updateStudentsSetComboBox()
{
	populateStudentsComboBox(studentsComboBox);
}

void AddConstraintStudentsSetMaxRoomChangesPerRealDayInIntervalForm::addCurrentConstraint()
{
	...
	ctr=new ConstraintStudentsSetMaxRoomChangesPerRealDayInInterval(weight, students_name, maxChangesSpinBox->value(), startHour, endHour);
