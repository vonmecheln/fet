...
ConstraintActivitiesOccupyMinTimeSlotsFromSelectionForm::ConstraintActivitiesOccupyMinTimeSlotsFromSelectionForm(QWidget* parent): QDialog(parent)
{
	...
	connect(constraintsListWidget, &QListWidget::currentRowChanged, this, &ConstraintActivitiesOccupyMinTimeSlotsFromSelectionForm::constraintChanged);
	connect(addConstraintPushButton, &QPushButton::clicked, this, &ConstraintActivitiesOccupyMinTimeSlotsFromSelectionForm::addConstraint);
	connect(closePushButton, &QPushButton::clicked, this, &ConstraintActivitiesOccupyMinTimeSlotsFromSelectionForm::close);
	connect(removeConstraintPushButton, &QPushButton::clicked, this, &ConstraintActivitiesOccupyMinTimeSlotsFromSelectionForm::removeConstraint);
	connect(modifyConstraintPushButton, &QPushButton::clicked, this, &ConstraintActivitiesOccupyMinTimeSlotsFromSelectionForm::modifyConstraint);
	connect(constraintsListWidget, &QListWidget::itemDoubleClicked, this, &ConstraintActivitiesOccupyMinTimeSlotsFromSelectionForm::modifyConstraint);

	connect(helpPushButton, &QPushButton::clicked, this, &ConstraintActivitiesOccupyMinTimeSlotsFromSelectionForm::help);
...
///////////////
	...
	connect(teachersComboBox, qOverload<int>(&QComboBox::currentIndexChanged), this, &ConstraintActivitiesOccupyMinTimeSlotsFromSelectionForm::filterChanged);
	connect(studentsComboBox, qOverload<int>(&QComboBox::currentIndexChanged), this, &ConstraintActivitiesOccupyMinTimeSlotsFromSelectionForm::filterChanged);
	connect(subjectsComboBox, qOverload<int>(&QComboBox::currentIndexChanged), this, &ConstraintActivitiesOccupyMinTimeSlotsFromSelectionForm::filterChanged);
	connect(activityTagsComboBox, qOverload<int>(&QComboBox::currentIndexChanged), this, &ConstraintActivitiesOccupyMinTimeSlotsFromSelectionForm::filterChanged);
}
