...
ModifyConstraintStudentsSetMaxAfternoonsPerWeekForm::ModifyConstraintStudentsSetMaxAfternoonsPerWeekForm(QWidget* parent, ConstraintStudentsSetMaxAfternoonsPerWeek* ctr): QDialog(parent)
{
	...
	connect(okPushButton, &QPushButton::clicked, this, &ModifyConstraintStudentsSetMaxAfternoonsPerWeekForm::ok);
	connect(cancelPushButton, &QPushButton::clicked, this, &ModifyConstraintStudentsSetMaxAfternoonsPerWeekForm::cancel);
