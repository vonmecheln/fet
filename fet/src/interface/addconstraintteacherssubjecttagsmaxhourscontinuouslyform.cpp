/***************************************************************************
                          addconstraintteacherssubjecttagsmaxhourscontinuouslyform.cpp  -  description
                             -------------------
    begin                : Apr 28, 2005
...
AddConstraintTeachersSubjectTagsMaxHoursContinuouslyForm::AddConstraintTeachersSubjectTagsMaxHoursContinuouslyForm()
{
...
void AddConstraintTeachersSubjectTagsMaxHoursContinuouslyForm::updateMaxHoursSpinBox(){
...
void AddConstraintTeachersSubjectTagsMaxHoursContinuouslyForm::constraintChanged()
{
	QString s;
...
void AddConstraintTeachersSubjectTagsMaxHoursContinuouslyForm::addCurrentConstraint()
{
