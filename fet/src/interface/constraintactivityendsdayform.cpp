...
{
	AddConstraintActivityEndsDayForm *form=new AddConstraintActivityEndsDayForm();
	form->exec();
...
void ConstraintActivityEndsDayForm::modifyConstraint()
{
	...
	ModifyConstraintActivityEndsDayForm *form = new ModifyConstraintActivityEndsDayForm((ConstraintActivityEndsDay*)ctr);
	form->exec();
