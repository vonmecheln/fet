...
#include "constraintstudentssetmaxbuildingchangesperweekform_template.h"
...
class ConstraintStudentsSetMaxBuildingChangesPerWeekForm : public ConstraintStudentsSetMaxBuildingChangesPerWeekForm_template  {
public:
