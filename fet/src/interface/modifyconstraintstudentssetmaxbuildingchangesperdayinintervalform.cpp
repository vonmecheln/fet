/***************************************************************************
                          modifyconstraintstudentssetmaxbuildingchangesperdayinintervalform.cpp  -  description
                             -------------------
    begin                : 2024
...
ModifyConstraintStudentsSetMaxBuildingChangesPerDayInIntervalForm::ModifyConstraintStudentsSetMaxBuildingChangesPerDayInIntervalForm(QWidget* parent, ConstraintStudentsSetMaxBuildingChangesPerDayInInterval* ctr): QDialog(parent)
{
	setupUi(this);

	okPushButton->setDefault(true);

	connect(okPushButton, &QPushButton::clicked, this, &ModifyConstraintStudentsSetMaxBuildingChangesPerDayInIntervalForm::ok);
	connect(cancelPushButton, &QPushButton::clicked, this, &ModifyConstraintStudentsSetMaxBuildingChangesPerDayInIntervalForm::cancel);
...
ModifyConstraintStudentsSetMaxBuildingChangesPerDayInIntervalForm::~ModifyConstraintStudentsSetMaxBuildingChangesPerDayInIntervalForm()
{
	saveFETDialogGeometry(this);
}

void ModifyConstraintStudentsSetMaxBuildingChangesPerDayInIntervalForm::updateStudentsComboBox(QWidget* parent)
{
...
void ModifyConstraintStudentsSetMaxBuildingChangesPerDayInIntervalForm::ok()
{
...
void ModifyConstraintStudentsSetMaxBuildingChangesPerDayInIntervalForm::cancel()
{
	this->close();
}
