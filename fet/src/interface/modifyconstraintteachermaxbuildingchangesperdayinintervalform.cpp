/***************************************************************************
                          modifyconstraintteachermaxbuildingchangesperdayinintervalform.cpp  -  description
                             -------------------
    begin                : 2024
...
ModifyConstraintTeacherMaxBuildingChangesPerDayInIntervalForm::ModifyConstraintTeacherMaxBuildingChangesPerDayInIntervalForm(QWidget* parent, ConstraintTeacherMaxBuildingChangesPerDayInInterval* ctr): QDialog(parent)
{
	setupUi(this);

	okPushButton->setDefault(true);

	connect(okPushButton, &QPushButton::clicked, this, &ModifyConstraintTeacherMaxBuildingChangesPerDayInIntervalForm::ok);
	connect(cancelPushButton, &QPushButton::clicked, this, &ModifyConstraintTeacherMaxBuildingChangesPerDayInIntervalForm::cancel);
...
ModifyConstraintTeacherMaxBuildingChangesPerDayInIntervalForm::~ModifyConstraintTeacherMaxBuildingChangesPerDayInIntervalForm()
{
	saveFETDialogGeometry(this);
}

void ModifyConstraintTeacherMaxBuildingChangesPerDayInIntervalForm::updateTeachersComboBox(){
...
void ModifyConstraintTeacherMaxBuildingChangesPerDayInIntervalForm::ok()
{
	double weight;
...
void ModifyConstraintTeacherMaxBuildingChangesPerDayInIntervalForm::cancel()
{
	this->close();
}
