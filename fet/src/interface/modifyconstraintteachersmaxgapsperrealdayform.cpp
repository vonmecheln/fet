...
ModifyConstraintTeachersMaxGapsPerRealDayForm::ModifyConstraintTeachersMaxGapsPerRealDayForm(QWidget* parent, ConstraintTeachersMaxGapsPerRealDay* ctr): QDialog(parent)
{
	...
	connect(okPushButton, &QPushButton::clicked, this, &ModifyConstraintTeachersMaxGapsPerRealDayForm::ok);
	connect(cancelPushButton, &QPushButton::clicked, this, &ModifyConstraintTeachersMaxGapsPerRealDayForm::cancel);
