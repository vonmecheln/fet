/***************************************************************************
                          addconstraintteachersmingapsbetweenactivitytagperrealdayform.cpp  -  description
                             -------------------
    begin                : 2024
...
AddConstraintTeachersMinGapsBetweenActivityTagPerRealDayForm::AddConstraintTeachersMinGapsBetweenActivityTagPerRealDayForm(QWidget* parent): QDialog(parent)
{
	setupUi(this);

	addConstraintPushButton->setDefault(true);

	connect(addConstraintPushButton, &QPushButton::clicked, this, &AddConstraintTeachersMinGapsBetweenActivityTagPerRealDayForm::addCurrentConstraint);
	connect(addConstraintsPushButton, &QPushButton::clicked, this, &AddConstraintTeachersMinGapsBetweenActivityTagPerRealDayForm::addCurrentConstraints);
	connect(closePushButton, &QPushButton::clicked, this, &AddConstraintTeachersMinGapsBetweenActivityTagPerRealDayForm::close);
...
AddConstraintTeachersMinGapsBetweenActivityTagPerRealDayForm::~AddConstraintTeachersMinGapsBetweenActivityTagPerRealDayForm()
{
	saveFETDialogGeometry(this);
}

void AddConstraintTeachersMinGapsBetweenActivityTagPerRealDayForm::updateActivityTagComboBox()
{
	for(ActivityTag* at : std::as_const(gt.rules.activityTagsList))
		activityTagComboBox->addItem(at->name);
}

void AddConstraintTeachersMinGapsBetweenActivityTagPerRealDayForm::addCurrentConstraint()
{
	...
	ctr=new ConstraintTeachersMinGapsBetweenActivityTagPerRealDay(weight, minGaps, activityTagName);
...
void AddConstraintTeachersMinGapsBetweenActivityTagPerRealDayForm::addCurrentConstraints()
{
