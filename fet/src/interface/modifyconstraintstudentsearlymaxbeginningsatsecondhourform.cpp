...
ModifyConstraintStudentsEarlyMaxBeginningsAtSecondHourForm::ModifyConstraintStudentsEarlyMaxBeginningsAtSecondHourForm(QWidget* parent, ConstraintStudentsEarlyMaxBeginningsAtSecondHour* ctr): QDialog(parent)
{
	...
	connect(okPushButton, &QPushButton::clicked, this, &ModifyConstraintStudentsEarlyMaxBeginningsAtSecondHourForm::ok);
	connect(cancelPushButton, &QPushButton::clicked, this, &ModifyConstraintStudentsEarlyMaxBeginningsAtSecondHourForm::cancel);
