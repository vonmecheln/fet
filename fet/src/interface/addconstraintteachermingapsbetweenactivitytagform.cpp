...
AddConstraintTeacherMinGapsBetweenActivityTagForm::AddConstraintTeacherMinGapsBetweenActivityTagForm(QWidget* parent): QDialog(parent)
{
	...
	connect(addConstraintPushButton, &QPushButton::clicked, this, &AddConstraintTeacherMinGapsBetweenActivityTagForm::addCurrentConstraint);
	connect(addConstraintsPushButton, &QPushButton::clicked, this, &AddConstraintTeacherMinGapsBetweenActivityTagForm::addCurrentConstraints);
	connect(closePushButton, &QPushButton::clicked, this, &AddConstraintTeacherMinGapsBetweenActivityTagForm::close);
...
void AddConstraintTeacherMinGapsBetweenActivityTagForm::addCurrentConstraints()
{
