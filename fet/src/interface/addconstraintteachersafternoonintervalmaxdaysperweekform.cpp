...
AddConstraintTeachersAfternoonIntervalMaxDaysPerWeekForm::AddConstraintTeachersAfternoonIntervalMaxDaysPerWeekForm(QWidget* parent): QDialog(parent)
{
	...
	connect(addConstraintPushButton, &QPushButton::clicked, this, &AddConstraintTeachersAfternoonIntervalMaxDaysPerWeekForm::addCurrentConstraint);
	connect(addConstraintsPushButton, &QPushButton::clicked, this, &AddConstraintTeachersAfternoonIntervalMaxDaysPerWeekForm::addCurrentConstraints);
	connect(closePushButton, &QPushButton::clicked, this, &AddConstraintTeachersAfternoonIntervalMaxDaysPerWeekForm::close);
...
void AddConstraintTeachersAfternoonIntervalMaxDaysPerWeekForm::addCurrentConstraints()
{
