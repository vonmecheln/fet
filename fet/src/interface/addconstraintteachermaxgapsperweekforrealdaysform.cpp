...
AddConstraintTeacherMaxGapsPerWeekForRealDaysForm::AddConstraintTeacherMaxGapsPerWeekForRealDaysForm(QWidget* parent): QDialog(parent)
{
	setupUi(this);

	addConstraintPushButton->setDefault(true);

	connect(addConstraintPushButton, &QPushButton::clicked, this, &AddConstraintTeacherMaxGapsPerWeekForRealDaysForm::addCurrentConstraint);
	connect(addConstraintsPushButton, &QPushButton::clicked, this, &AddConstraintTeacherMaxGapsPerWeekForRealDaysForm::addCurrentConstraints);
	connect(closePushButton, &QPushButton::clicked, this, &AddConstraintTeacherMaxGapsPerWeekForRealDaysForm::close);
...
AddConstraintTeacherMaxGapsPerWeekForRealDaysForm::~AddConstraintTeacherMaxGapsPerWeekForRealDaysForm()
{
	saveFETDialogGeometry(this);
}

void AddConstraintTeacherMaxGapsPerWeekForRealDaysForm::addCurrentConstraint()
{
	...
	ctr=new ConstraintTeacherMaxGapsPerWeekForRealDays(weight, teacher_name, maxGapsSpinBox->value());
