...
void LockUnlock::computeLockedUnlockedActivitiesTimeSpace()
{
	...
	/*cout<<"ids of locked time.count()=="<<idsOfLockedTime.count()<<endl;
	cout<<"ids of permanently locked time.count()=="<<idsOfPermanentlyLockedTime.count()<<endl;
	cout<<"ids of locked space.count()=="<<idsOfLockedSpace.count()<<endl;
	cout<<"ids of permanently locked space.count()=="<<idsOfPermanentlyLockedSpace.count()<<endl;
	cout<<"pcommspinbox->value()=="<<pcommunicationSpinBox->value()<<endl;
	cout<<endl;*/
}
...
void LockUnlock::lockEndStudentsDay()
{
	if(!students_schedule_ready || !teachers_schedule_ready || !rooms_schedule_ready){
		return;
	}
...
void LockUnlock::unlockEndStudentsDay()
{
	if(!students_schedule_ready || !teachers_schedule_ready || !rooms_schedule_ready){
		return;
	}
