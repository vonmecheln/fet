...
ModifyConstraintTeachersMaxSpanPerRealDayForm::ModifyConstraintTeachersMaxSpanPerRealDayForm(QWidget* parent, ConstraintTeachersMaxSpanPerRealDay* ctr): QDialog(parent)
{
	...
	connect(okPushButton, &QPushButton::clicked, this, &ModifyConstraintTeachersMaxSpanPerRealDayForm::ok);
	connect(cancelPushButton, &QPushButton::clicked, this, &ModifyConstraintTeachersMaxSpanPerRealDayForm::cancel);
