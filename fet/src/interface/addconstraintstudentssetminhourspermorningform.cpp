/***************************************************************************
                          addconstraintstudentssetminhourspermorningform.cpp  -  description
                             -------------------
    begin                : 2020
...
AddConstraintStudentsSetMinHoursPerMorningForm::AddConstraintStudentsSetMinHoursPerMorningForm(QWidget* parent): QDialog(parent)
{
	setupUi(this);
...
void AddConstraintStudentsSetMinHoursPerMorningForm::updateStudentsSetComboBox()
{
	populateStudentsComboBox(studentsComboBox);
}

void AddConstraintStudentsSetMinHoursPerMorningForm::addCurrentConstraint()
{
	...
	ctr=new ConstraintStudentsSetMinHoursPerMorning(weight, minHours, students_name, allowEmptyMorningsCheckBox->isChecked());
