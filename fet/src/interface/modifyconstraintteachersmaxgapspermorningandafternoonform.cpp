...
ModifyConstraintTeachersMaxGapsPerMorningAndAfternoonForm::ModifyConstraintTeachersMaxGapsPerMorningAndAfternoonForm(QWidget* parent, ConstraintTeachersMaxGapsPerMorningAndAfternoon* ctr): QDialog(parent)
{
	...
	connect(okPushButton, &QPushButton::clicked, this, &ModifyConstraintTeachersMaxGapsPerMorningAndAfternoonForm::ok);
	connect(cancelPushButton, &QPushButton::clicked, this, &ModifyConstraintTeachersMaxGapsPerMorningAndAfternoonForm::cancel);
