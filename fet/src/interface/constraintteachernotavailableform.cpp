/***************************************************************************
                          constraintteachernotavailableform.cpp  -  description
                             -------------------
    begin                : Feb 10, 2005
...
bool ConstraintTeacherNotAvailableForm::filterOk(TimeConstraint* ctr)
{
	if(ctr->type==CONSTRAINT_TEACHER_NOT_AVAILABLE){
		ConstraintTeacherNotAvailable* ctna=(ConstraintTeacherNotAvailable*) ctr;
...
void ConstraintTeacherNotAvailableForm::filterChanged()
{
...
void ConstraintTeacherNotAvailableForm::modifyConstraint()
{
...
void ConstraintTeacherNotAvailableForm::removeConstraint()
{
	int i=constraintsListBox->currentItem();
	if(i<0){
		QMessageBox::information(this, QObject::tr("FET information"), QObject::tr("Invalid selected constraint"));
