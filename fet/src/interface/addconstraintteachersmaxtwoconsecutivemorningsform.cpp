/***************************************************************************
                          addconstraintteachersmaxtwoconsecutivemorningsform.cpp  -  description
                             -------------------
    begin                : Oct 15, 2015
...
AddConstraintTeachersMaxTwoConsecutiveMorningsForm::AddConstraintTeachersMaxTwoConsecutiveMorningsForm(QWidget* parent): QDialog(parent)
{
	setupUi(this);
...
AddConstraintTeachersMaxTwoConsecutiveMorningsForm::~AddConstraintTeachersMaxTwoConsecutiveMorningsForm()
{
	saveFETDialogGeometry(this);
}

void AddConstraintTeachersMaxTwoConsecutiveMorningsForm::addCurrentConstraint()
{
	...
	ctr=new ConstraintTeachersMaxTwoConsecutiveMornings(weight);
...
void AddConstraintTeachersMaxTwoConsecutiveMorningsForm::addCurrentConstraints()
{
