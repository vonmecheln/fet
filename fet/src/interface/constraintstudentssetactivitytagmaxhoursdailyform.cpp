...
ConstraintStudentsSetActivityTagMaxHoursDailyForm::ConstraintStudentsSetActivityTagMaxHoursDailyForm()
{
    ...
    connect(helpPushButton, SIGNAL(clicked()), this /*ConstraintStudentsSetActivityTagMaxHoursContinuouslyForm_template*/, SLOT(help()));
...
{
	AddConstraintStudentsSetActivityTagMaxHoursDailyForm form;
	form.exec();
...
void ConstraintStudentsSetActivityTagMaxHoursDailyForm::help()
{
