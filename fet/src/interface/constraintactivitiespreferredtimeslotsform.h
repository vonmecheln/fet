...
#include "constraintactivitiespreferredtimeslotsform_template.h"
...
class ConstraintActivitiesPreferredTimeSlotsForm : public ConstraintActivitiesPreferredTimeSlotsForm_template  {
public:
