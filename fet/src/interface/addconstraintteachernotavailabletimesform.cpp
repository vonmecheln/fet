...
void AddConstraintTeacherNotAvailableTimesForm::help()
{
	...
	s+=tr("If you need to use weight under 100%, you can use activities preferred times with"
	 " only the teacher specified, but this is higly unrecommended, as gaps will be"
	 " counted and you may obtain an impossible timetable. Please DO NOT use this method unless really necessary."
	 " Or you may use this method if specifying only last slots of the days, so no gaps can appear");
