...
bool ModifyConstraint2ActivitiesOrderedForm::filterOk(Activity* act)
{
	Q_UNUSED(act);
...
void ModifyConstraint2ActivitiesOrderedForm::filterChanged()
{
	this->updateActivitiesComboBox();
}

void ModifyConstraint2ActivitiesOrderedForm::updateActivitiesComboBox(){
