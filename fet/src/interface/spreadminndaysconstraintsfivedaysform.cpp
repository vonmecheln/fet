...
SpreadMinNDaysConstraintsFiveDaysForm::SpreadMinNDaysConstraintsFiveDaysForm()
{
	setupUi(this);
...
void SpreadMinNDaysConstraintsFiveDaysForm::wasAccepted()
{
	double weight4;
...
void SpreadMinNDaysConstraintsFiveDaysForm::wasCanceled()
{
	this->reject();
}

void SpreadMinNDaysConstraintsFiveDaysForm::on_spread2CheckBox_toggled()
{
	weight2LineEdit->setEnabled(spread2CheckBox->isChecked());
	weight2Label->setEnabled(spread2CheckBox->isChecked());
}

void SpreadMinNDaysConstraintsFiveDaysForm::on_spread3CheckBox_toggled()
{
...
void SpreadMinNDaysConstraintsFiveDaysForm::on_spread4OrMoreCheckBox_toggled()
{
