/***************************************************************************
                          modifyconstraintteachersmaxbuildingchangesperrealdayinintervalform.cpp  -  description
                             -------------------
    begin                : 2024
...
ModifyConstraintTeachersMaxBuildingChangesPerRealDayInIntervalForm::ModifyConstraintTeachersMaxBuildingChangesPerRealDayInIntervalForm(QWidget* parent, ConstraintTeachersMaxBuildingChangesPerRealDayInInterval* ctr): QDialog(parent)
{
	setupUi(this);

	okPushButton->setDefault(true);

	connect(okPushButton, &QPushButton::clicked, this, &ModifyConstraintTeachersMaxBuildingChangesPerRealDayInIntervalForm::ok);
	connect(cancelPushButton, &QPushButton::clicked, this, &ModifyConstraintTeachersMaxBuildingChangesPerRealDayInIntervalForm::cancel);
...
ModifyConstraintTeachersMaxBuildingChangesPerRealDayInIntervalForm::~ModifyConstraintTeachersMaxBuildingChangesPerRealDayInIntervalForm()
{
	saveFETDialogGeometry(this);
}

void ModifyConstraintTeachersMaxBuildingChangesPerRealDayInIntervalForm::ok()
{
	double weight;
...
void ModifyConstraintTeachersMaxBuildingChangesPerRealDayInIntervalForm::cancel()
{
	this->close();
}
