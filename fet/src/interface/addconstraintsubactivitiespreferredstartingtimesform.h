...
#include "addconstraintsubactivitiespreferredstartingtimesform_template.h"
...
class AddConstraintSubactivitiesPreferredStartingTimesForm : public AddConstraintSubactivitiesPreferredStartingTimesForm_template  {
	Q_OBJECT
