/***************************************************************************
                          addconstraint2activitiesgroupedform.cpp  -  description
                             -------------------
    begin                : Aug 21, 2007
...
AddConstraint2ActivitiesGroupedForm::AddConstraint2ActivitiesGroupedForm()
{
...
bool AddConstraint2ActivitiesGroupedForm::filterOk(Activity* act)
{
...
void AddConstraint2ActivitiesGroupedForm::updateActivitiesComboBox(){
...
void AddConstraint2ActivitiesGroupedForm::filterChanged()
{
	this->updateActivitiesComboBox();
}

void AddConstraint2ActivitiesGroupedForm::constraintChanged()
{
	QString s;
	...
	s+=QObject::tr("2 activities grouped");
	s+=" ";
...
void AddConstraint2ActivitiesGroupedForm::addCurrentConstraint()
{
	...
	ctr=new Constraint2ActivitiesGrouped(weight, fid, sid);
