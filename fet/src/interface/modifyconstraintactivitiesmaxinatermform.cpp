...
ModifyConstraintActivitiesMaxInATermForm::ModifyConstraintActivitiesMaxInATermForm(QWidget* parent, ConstraintActivitiesMaxInATerm* ctr): QDialog(parent)
{
	setupUi(this);
	...
	connect(okPushButton, &QPushButton::clicked, this, &ModifyConstraintActivitiesMaxInATermForm::ok);
	connect(cancelPushButton, &QPushButton::clicked, this, &ModifyConstraintActivitiesMaxInATermForm::cancel);
	connect(allActivitiesListWidget, &QListWidget::itemDoubleClicked, this, &ModifyConstraintActivitiesMaxInATermForm::addActivity);
	connect(addAllActivitiesPushButton, &QPushButton::clicked, this, &ModifyConstraintActivitiesMaxInATermForm::addAllActivities);
	connect(selectedActivitiesListWidget, &QListWidget::itemDoubleClicked, this, &ModifyConstraintActivitiesMaxInATermForm::removeActivity);
	connect(clearPushButton, &QPushButton::clicked, this, &ModifyConstraintActivitiesMaxInATermForm::clear);
	...
	maxActivitiesInATermSpinBox->setValue(ctr->maxActivitiesInATerm);
	...
	connect(teachersComboBox, qOverload<int>(&QComboBox::currentIndexChanged), this, &ModifyConstraintActivitiesMaxInATermForm::filterChanged);
	connect(studentsComboBox, qOverload<int>(&QComboBox::currentIndexChanged), this, &ModifyConstraintActivitiesMaxInATermForm::filterChanged);
	connect(subjectsComboBox, qOverload<int>(&QComboBox::currentIndexChanged), this, &ModifyConstraintActivitiesMaxInATermForm::filterChanged);
	connect(activityTagsComboBox, qOverload<int>(&QComboBox::currentIndexChanged), this, &ModifyConstraintActivitiesMaxInATermForm::filterChanged);
}

ModifyConstraintActivitiesMaxInATermForm::~ModifyConstraintActivitiesMaxInATermForm()
{
	saveFETDialogGeometry(this);
}

void ModifyConstraintActivitiesMaxInATermForm::ok()
{
	double weight;
...
void ModifyConstraintActivitiesMaxInATermForm::cancel()
{
	this->close();
}

//activities
bool ModifyConstraintActivitiesMaxInATermForm::filterOk(Activity* act)
{
...
void ModifyConstraintActivitiesMaxInATermForm::filterChanged()
{
	this->updateActivitiesListWidget();
}

void ModifyConstraintActivitiesMaxInATermForm::updateActivitiesListWidget()
{
...
void ModifyConstraintActivitiesMaxInATermForm::addActivity()
{
...
void ModifyConstraintActivitiesMaxInATermForm::addAllActivities()
{
...
void ModifyConstraintActivitiesMaxInATermForm::removeActivity()
{
...
void ModifyConstraintActivitiesMaxInATermForm::clear()
{
	selectedActivitiesListWidget->clear();
	selectedActivitiesList.clear();
}
