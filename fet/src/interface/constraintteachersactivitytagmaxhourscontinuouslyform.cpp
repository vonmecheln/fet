...
ConstraintTeachersActivityTagMaxHoursContinuouslyForm::ConstraintTeachersActivityTagMaxHoursContinuouslyForm(QWidget* parent): QDialog(parent)
{
	setupUi(this);
...
{
	AddConstraintTeachersActivityTagMaxHoursContinuouslyForm form(this);
