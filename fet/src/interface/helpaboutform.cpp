...
HelpAboutForm::HelpAboutForm(QWidget* parent): QDialog(parent)
{
	...
	//The other place is in the file src/interface/fet.cpp.
	...
	about+=tr("Version: %1 (%2 %3).", "%1 is the current FET version, %2 is the current release month, %3 is the current release year").arg(FET_VERSION)
	 .arg(QCoreApplication::translate("MonthsNames", "September")).arg("2026");
	about+=QString("<br /><br />");
	...
	thanksTo+=QString("<br />");
	thanksTo+=QString("Devrim Altınkurt");
	thanksTo+=QString("<br />");
	...
	thanksTo+=QString("<br />");
	thanksTo+=QString("kilindor");
	thanksTo+=QString("<br />");
	thanksTo+=QString("hold_find");
	thanksTo+=QString("<br />");
	thanksTo+=QString("miky");
	thanksTo+=QString("<br />");
	thanksTo+=QString("ptrdtznr");
	thanksTo+=QString("<br />");
	thanksTo+=QString("Frank Rump");
	thanksTo+=QString("<br />");
	...
	thanksTo+=QString("<br />");
	thanksTo+=QString("Abdeljalil LAABAD");
	thanksTo+=QString("<br />");
	thanksTo+=QString("Ahmed Messaoudi");
	thanksTo+=QString("<br />");
