...
AddConstraintActivitiesBeginStudentsDayForm::AddConstraintActivitiesBeginStudentsDayForm(QWidget* parent): QDialog(parent)
{
	...
	connect(addConstraintPushButton, &QPushButton::clicked, this, &AddConstraintActivitiesBeginStudentsDayForm::addConstraint);
	connect(closePushButton, &QPushButton::clicked, this, &AddConstraintActivitiesBeginStudentsDayForm::close);
