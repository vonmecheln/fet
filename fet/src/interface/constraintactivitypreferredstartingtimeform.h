...
#include "constraintactivitypreferredstartingtimeform_template.h"
...
class ConstraintActivityPreferredStartingTimeForm : public ConstraintActivityPreferredStartingTimeForm_template  {
	Q_OBJECT
