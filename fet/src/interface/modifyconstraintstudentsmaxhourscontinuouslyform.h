...
#include "modifyconstraintstudentsmaxhourscontinuouslyform_template.h"
...
class ModifyConstraintStudentsMaxHoursContinuouslyForm : public ModifyConstraintStudentsMaxHoursContinuouslyForm_template  {
public:
