...
#include "addconstraintstudentssetmaxhoursdailyform_template.h"
...
class AddConstraintStudentsSetMaxHoursDailyForm : public AddConstraintStudentsSetMaxHoursDailyForm_template  {
public:
