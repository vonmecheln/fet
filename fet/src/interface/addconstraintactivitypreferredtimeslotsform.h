...
#include "addconstraintactivitypreferredtimeslotsform_template.h"
...
class AddConstraintActivityPreferredTimeSlotsForm : public AddConstraintActivityPreferredTimeSlotsForm_template  {
	Q_OBJECT
