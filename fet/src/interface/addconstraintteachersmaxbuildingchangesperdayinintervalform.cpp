/***************************************************************************
                          addconstraintteachersmaxbuildingchangesperdayinintervalform.cpp  -  description
                             -------------------
    begin                : 2024
...
AddConstraintTeachersMaxBuildingChangesPerDayInIntervalForm::AddConstraintTeachersMaxBuildingChangesPerDayInIntervalForm(QWidget* parent): QDialog(parent)
{
	setupUi(this);

	addConstraintPushButton->setDefault(true);

	connect(addConstraintPushButton, &QPushButton::clicked, this, &AddConstraintTeachersMaxBuildingChangesPerDayInIntervalForm::addCurrentConstraint);
	connect(addConstraintsPushButton, &QPushButton::clicked, this, &AddConstraintTeachersMaxBuildingChangesPerDayInIntervalForm::addCurrentConstraints);
	connect(closePushButton, &QPushButton::clicked, this, &AddConstraintTeachersMaxBuildingChangesPerDayInIntervalForm::close);
...
AddConstraintTeachersMaxBuildingChangesPerDayInIntervalForm::~AddConstraintTeachersMaxBuildingChangesPerDayInIntervalForm()
{
	saveFETDialogGeometry(this);
}

void AddConstraintTeachersMaxBuildingChangesPerDayInIntervalForm::addCurrentConstraint()
{
	...
	ctr=new ConstraintTeachersMaxBuildingChangesPerDayInInterval(weight, maxChangesSpinBox->value(), startHour, endHour);
...
void AddConstraintTeachersMaxBuildingChangesPerDayInIntervalForm::addCurrentConstraints()
{
