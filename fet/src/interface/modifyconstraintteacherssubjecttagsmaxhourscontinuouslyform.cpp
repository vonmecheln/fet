/***************************************************************************
                          modifyconstraintteacherssubjecttagsmaxhourscontinuouslyform.cpp  -  description
                             -------------------
    begin                : Apr 28, 2005
...
ModifyConstraintTeachersSubjectTagsMaxHoursContinuouslyForm::ModifyConstraintTeachersSubjectTagsMaxHoursContinuouslyForm(ConstraintTeachersSubjectTagsMaxHoursContinuously* ctr)
{
...
void ModifyConstraintTeachersSubjectTagsMaxHoursContinuouslyForm::updateMaxHoursSpinBox(){
	maxHoursSpinBox->setMinValue(1);
	maxHoursSpinBox->setMaxValue(gt.rules.nHoursPerDay);	
}

void ModifyConstraintTeachersSubjectTagsMaxHoursContinuouslyForm::constraintChanged()
{
	QString s;
...
void ModifyConstraintTeachersSubjectTagsMaxHoursContinuouslyForm::ok()
{
	double weight;
	QString tmp=weightLineEdit->text();
	sscanf(tmp, "%lf", &weight);
...
void ModifyConstraintTeachersSubjectTagsMaxHoursContinuouslyForm::cancel()
{
	this->close();
}
