/***************************************************************************
                          modifyconstraintstudentssetmaxroomchangesperweekform.cpp  -  description
                             -------------------
    begin                : 2019
...
ModifyConstraintStudentsSetMaxRoomChangesPerWeekForm::ModifyConstraintStudentsSetMaxRoomChangesPerWeekForm(QWidget* parent, ConstraintStudentsSetMaxRoomChangesPerWeek* ctr): QDialog(parent)
{
	...
	connect(okPushButton, &QPushButton::clicked, this, &ModifyConstraintStudentsSetMaxRoomChangesPerWeekForm::ok);
	connect(cancelPushButton, &QPushButton::clicked, this, &ModifyConstraintStudentsSetMaxRoomChangesPerWeekForm::cancel);
...
ModifyConstraintStudentsSetMaxRoomChangesPerWeekForm::~ModifyConstraintStudentsSetMaxRoomChangesPerWeekForm()
{
	saveFETDialogGeometry(this);
}

void ModifyConstraintStudentsSetMaxRoomChangesPerWeekForm::updateStudentsComboBox(QWidget* parent){
...
void ModifyConstraintStudentsSetMaxRoomChangesPerWeekForm::ok()
{
...
void ModifyConstraintStudentsSetMaxRoomChangesPerWeekForm::cancel()
{
	this->close();
}
