...
#include "addconstraintteachermaxbuildingchangesperdayform_template.h"
...
class AddConstraintTeacherMaxBuildingChangesPerDayForm : public AddConstraintTeacherMaxBuildingChangesPerDayForm_template  {
public:
