...
ModifyConstraintMaxHalfDaysBetweenActivitiesForm::ModifyConstraintMaxHalfDaysBetweenActivitiesForm(QWidget* parent, ConstraintMaxHalfDaysBetweenActivities* ctr): QDialog(parent)
{
	setupUi(this);
...
void ModifyConstraintMaxHalfDaysBetweenActivitiesForm::filterChanged()
{
...
bool ModifyConstraintMaxHalfDaysBetweenActivitiesForm::filterOk(Activity* act)
{
...
void ModifyConstraintMaxHalfDaysBetweenActivitiesForm::ok()
{
	double weight;
...
void ModifyConstraintMaxHalfDaysBetweenActivitiesForm::cancel()
{
	this->close();
}

void ModifyConstraintMaxHalfDaysBetweenActivitiesForm::addActivity()
{
...
void ModifyConstraintMaxHalfDaysBetweenActivitiesForm::addAllActivities()
{
...
void ModifyConstraintMaxHalfDaysBetweenActivitiesForm::removeActivity()
{
...
void ModifyConstraintMaxHalfDaysBetweenActivitiesForm::clear()
{
	selectedActivitiesListWidget->clear();
	selectedActivitiesList.clear();
}
