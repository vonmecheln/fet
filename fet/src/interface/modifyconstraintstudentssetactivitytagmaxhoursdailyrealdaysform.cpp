...
ModifyConstraintStudentsSetActivityTagMaxHoursDailyRealDaysForm::ModifyConstraintStudentsSetActivityTagMaxHoursDailyRealDaysForm(QWidget* parent, ConstraintStudentsSetActivityTagMaxHoursDailyRealDays* ctr): QDialog(parent)
{
	...
	connect(okPushButton, &QPushButton::clicked, this, &ModifyConstraintStudentsSetActivityTagMaxHoursDailyRealDaysForm::ok);
	connect(cancelPushButton, &QPushButton::clicked, this, &ModifyConstraintStudentsSetActivityTagMaxHoursDailyRealDaysForm::cancel);
