/***************************************************************************
                          addconstraintteachersmaxbuildingchangesperrealdayinintervalform.cpp  -  description
                             -------------------
    begin                : 2024
...
AddConstraintTeachersMaxBuildingChangesPerRealDayInIntervalForm::AddConstraintTeachersMaxBuildingChangesPerRealDayInIntervalForm(QWidget* parent): QDialog(parent)
{
	setupUi(this);

	addConstraintPushButton->setDefault(true);

	connect(addConstraintPushButton, &QPushButton::clicked, this, &AddConstraintTeachersMaxBuildingChangesPerRealDayInIntervalForm::addCurrentConstraint);
	connect(addConstraintsPushButton, &QPushButton::clicked, this, &AddConstraintTeachersMaxBuildingChangesPerRealDayInIntervalForm::addCurrentConstraints);
	connect(closePushButton, &QPushButton::clicked, this, &AddConstraintTeachersMaxBuildingChangesPerRealDayInIntervalForm::close);
...
AddConstraintTeachersMaxBuildingChangesPerRealDayInIntervalForm::~AddConstraintTeachersMaxBuildingChangesPerRealDayInIntervalForm()
{
	saveFETDialogGeometry(this);
}

void AddConstraintTeachersMaxBuildingChangesPerRealDayInIntervalForm::addCurrentConstraint()
{
	...
	ctr=new ConstraintTeachersMaxBuildingChangesPerRealDayInInterval(weight, maxChangesSpinBox->value(), startHour, endHour);
...
void AddConstraintTeachersMaxBuildingChangesPerRealDayInIntervalForm::addCurrentConstraints()
{
