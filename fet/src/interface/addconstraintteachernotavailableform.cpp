/***************************************************************************
                          addconstraintteachernotavailableform.cpp  -  description
                             -------------------
    begin                : Feb 10, 2005
...
AddConstraintTeacherNotAvailableForm::AddConstraintTeacherNotAvailableForm()
{
...
void AddConstraintTeacherNotAvailableForm::updateTeachersComboBox(){
...
void AddConstraintTeacherNotAvailableForm::updatePeriodGroupBox(){
...
void AddConstraintTeacherNotAvailableForm::constraintChanged()
{
	QString s;
...
void AddConstraintTeacherNotAvailableForm::addCurrentConstraint()
{
