...
#include "modifyconstraintstudentsintervalmaxdaysperweekform_template.h"
...
class ModifyConstraintStudentsIntervalMaxDaysPerWeekForm : public ModifyConstraintStudentsIntervalMaxDaysPerWeekForm_template  {
	Q_OBJECT
public:
