/***************************************************************************
                          addconstraintstudentssetmaxbuildingchangesperrealdayinintervalform.cpp  -  description
                             -------------------
    begin                : 2024
...
AddConstraintStudentsSetMaxBuildingChangesPerRealDayInIntervalForm::AddConstraintStudentsSetMaxBuildingChangesPerRealDayInIntervalForm(QWidget* parent): QDialog(parent)
{
	setupUi(this);

	addConstraintPushButton->setDefault(true);

	connect(addConstraintPushButton, &QPushButton::clicked, this, &AddConstraintStudentsSetMaxBuildingChangesPerRealDayInIntervalForm::addCurrentConstraint);
	connect(closePushButton, &QPushButton::clicked, this, &AddConstraintStudentsSetMaxBuildingChangesPerRealDayInIntervalForm::close);
...
AddConstraintStudentsSetMaxBuildingChangesPerRealDayInIntervalForm::~AddConstraintStudentsSetMaxBuildingChangesPerRealDayInIntervalForm()
{
	saveFETDialogGeometry(this);
}

void AddConstraintStudentsSetMaxBuildingChangesPerRealDayInIntervalForm::updateStudentsSetComboBox()
{
	populateStudentsComboBox(studentsComboBox);
}

void AddConstraintStudentsSetMaxBuildingChangesPerRealDayInIntervalForm::addCurrentConstraint()
{
	...
	ctr=new ConstraintStudentsSetMaxBuildingChangesPerRealDayInInterval(weight, students_name, maxChangesSpinBox->value(), startHour, endHour);
