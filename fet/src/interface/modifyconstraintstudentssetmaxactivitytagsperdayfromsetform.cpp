/***************************************************************************
                          modifyconstraintstudentssetmaxactivitytagsperdayfromsetform.cpp  -  description
                             -------------------
    begin                : 2024
...
ModifyConstraintStudentsSetMaxActivityTagsPerDayFromSetForm::ModifyConstraintStudentsSetMaxActivityTagsPerDayFromSetForm(QWidget* parent, ConstraintStudentsSetMaxActivityTagsPerDayFromSet* ctr): QDialog(parent)
{
	setupUi(this);

	okPushButton->setDefault(true);

	connect(okPushButton, &QPushButton::clicked, this, &ModifyConstraintStudentsSetMaxActivityTagsPerDayFromSetForm::ok);
	connect(cancelPushButton, &QPushButton::clicked, this, &ModifyConstraintStudentsSetMaxActivityTagsPerDayFromSetForm::cancel);

	connect(allActivityTagsListWidget, &QListWidget::itemDoubleClicked, this, &ModifyConstraintStudentsSetMaxActivityTagsPerDayFromSetForm::addActivityTag);
	connect(selectedActivityTagsListWidget, &QListWidget::itemDoubleClicked, this, &ModifyConstraintStudentsSetMaxActivityTagsPerDayFromSetForm::removeActivityTag);

	connect(clearActivityTagsPushButton, &QPushButton::clicked, this, &ModifyConstraintStudentsSetMaxActivityTagsPerDayFromSetForm::clearActivityTags);
...
ModifyConstraintStudentsSetMaxActivityTagsPerDayFromSetForm::~ModifyConstraintStudentsSetMaxActivityTagsPerDayFromSetForm()
{
	saveFETDialogGeometry(this);
}

void ModifyConstraintStudentsSetMaxActivityTagsPerDayFromSetForm::addActivityTag()
{
...
void ModifyConstraintStudentsSetMaxActivityTagsPerDayFromSetForm::removeActivityTag()
{
...
void ModifyConstraintStudentsSetMaxActivityTagsPerDayFromSetForm::clearActivityTags()
{
	selectedActivityTagsListWidget->clear();
}

void ModifyConstraintStudentsSetMaxActivityTagsPerDayFromSetForm::ok()
{
	double weight;
...
void ModifyConstraintStudentsSetMaxActivityTagsPerDayFromSetForm::cancel()
{
	this->close();
}
