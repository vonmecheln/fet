...
void ListOfRelatedTimeConstraintsForm::moveTimeConstraintUp()
{
...
void ListOfRelatedTimeConstraintsForm::moveTimeConstraintDown()
{
	/*if(filterCheckBox->isChecked()){
...
void ListOfRelatedTimeConstraintsForm::useColorsChanged()
{
	constraintChanged();
}
