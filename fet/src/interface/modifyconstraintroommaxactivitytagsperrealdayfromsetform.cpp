/***************************************************************************
                          modifyconstraintroommaxactivitytagsperrealdayfromsetform.cpp  -  description
                             -------------------
    begin                : 2024
...
ModifyConstraintRoomMaxActivityTagsPerRealDayFromSetForm::ModifyConstraintRoomMaxActivityTagsPerRealDayFromSetForm(QWidget* parent, ConstraintRoomMaxActivityTagsPerRealDayFromSet* ctr): QDialog(parent)
{
	setupUi(this);
	...
	connect(okPushButton, &QPushButton::clicked, this, &ModifyConstraintRoomMaxActivityTagsPerRealDayFromSetForm::ok);
	connect(cancelPushButton, &QPushButton::clicked, this, &ModifyConstraintRoomMaxActivityTagsPerRealDayFromSetForm::cancel);

	connect(allActivityTagsListWidget, &QListWidget::itemDoubleClicked, this, &ModifyConstraintRoomMaxActivityTagsPerRealDayFromSetForm::addActivityTag);
	connect(selectedActivityTagsListWidget, &QListWidget::itemDoubleClicked, this, &ModifyConstraintRoomMaxActivityTagsPerRealDayFromSetForm::removeActivityTag);

	connect(clearActivityTagsPushButton, &QPushButton::clicked, this, &ModifyConstraintRoomMaxActivityTagsPerRealDayFromSetForm::clearActivityTags);

	connect(filterCheckBox, &QCheckBox::toggled, this, &ModifyConstraintRoomMaxActivityTagsPerRealDayFromSetForm::filter);
	...
	connect(roomsComboBox, qOverload<int>(&QComboBox::currentIndexChanged), this, &ModifyConstraintRoomMaxActivityTagsPerRealDayFromSetForm::filter);
...
ModifyConstraintRoomMaxActivityTagsPerRealDayFromSetForm::~ModifyConstraintRoomMaxActivityTagsPerRealDayFromSetForm()
{
	saveFETDialogGeometry(this);
}

void ModifyConstraintRoomMaxActivityTagsPerRealDayFromSetForm::filter()
{
...
void ModifyConstraintRoomMaxActivityTagsPerRealDayFromSetForm::addActivityTag()
{
...
void ModifyConstraintRoomMaxActivityTagsPerRealDayFromSetForm::removeActivityTag()
{
...
void ModifyConstraintRoomMaxActivityTagsPerRealDayFromSetForm::clearActivityTags()
{
	selectedActivityTagsListWidget->clear();
}

void ModifyConstraintRoomMaxActivityTagsPerRealDayFromSetForm::ok()
{
	double weight;
...
void ModifyConstraintRoomMaxActivityTagsPerRealDayFromSetForm::cancel()
{
	this->close();
}
