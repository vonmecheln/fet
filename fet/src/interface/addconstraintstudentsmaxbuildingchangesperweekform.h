...
#include "addconstraintstudentsmaxbuildingchangesperweekform_template.h"
...
class AddConstraintStudentsMaxBuildingChangesPerWeekForm : public AddConstraintStudentsMaxBuildingChangesPerWeekForm_template  {
public:
