/***************************************************************************
                          modifyconstraintteachersmorningintervalmaxdaysperweekform.cpp  -  description
                             -------------------
    begin                : 2020
...
ModifyConstraintTeachersMorningIntervalMaxDaysPerWeekForm::ModifyConstraintTeachersMorningIntervalMaxDaysPerWeekForm(QWidget* parent, ConstraintTeachersMorningIntervalMaxDaysPerWeek* ctr): QDialog(parent)
{
	setupUi(this);

	okPushButton->setDefault(true);

	connect(okPushButton, &QPushButton::clicked, this, &ModifyConstraintTeachersMorningIntervalMaxDaysPerWeekForm::ok);
	connect(cancelPushButton, &QPushButton::clicked, this, &ModifyConstraintTeachersMorningIntervalMaxDaysPerWeekForm::cancel);
...
ModifyConstraintTeachersMorningIntervalMaxDaysPerWeekForm::~ModifyConstraintTeachersMorningIntervalMaxDaysPerWeekForm()
{
	saveFETDialogGeometry(this);
}

void ModifyConstraintTeachersMorningIntervalMaxDaysPerWeekForm::updateMaxDaysSpinBox(){
	maxDaysSpinBox->setMinimum(0);
	maxDaysSpinBox->setMaximum(gt.rules.nDaysPerWeek/2);
}

void ModifyConstraintTeachersMorningIntervalMaxDaysPerWeekForm::ok()
{
	double weight;
...
void ModifyConstraintTeachersMorningIntervalMaxDaysPerWeekForm::cancel()
{
	this->close();
}
