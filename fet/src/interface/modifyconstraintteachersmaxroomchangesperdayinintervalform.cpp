/***************************************************************************
                          modifyconstraintteachersmaxroomchangesperdayinintervalform.cpp  -  description
                             -------------------
    begin                : 2024
...
ModifyConstraintTeachersMaxRoomChangesPerDayInIntervalForm::ModifyConstraintTeachersMaxRoomChangesPerDayInIntervalForm(QWidget* parent, ConstraintTeachersMaxRoomChangesPerDayInInterval* ctr): QDialog(parent)
{
	setupUi(this);

	okPushButton->setDefault(true);

	connect(okPushButton, &QPushButton::clicked, this, &ModifyConstraintTeachersMaxRoomChangesPerDayInIntervalForm::ok);
	connect(cancelPushButton, &QPushButton::clicked, this, &ModifyConstraintTeachersMaxRoomChangesPerDayInIntervalForm::cancel);
...
ModifyConstraintTeachersMaxRoomChangesPerDayInIntervalForm::~ModifyConstraintTeachersMaxRoomChangesPerDayInIntervalForm()
{
	saveFETDialogGeometry(this);
}

void ModifyConstraintTeachersMaxRoomChangesPerDayInIntervalForm::ok()
{
	double weight;
...
void ModifyConstraintTeachersMaxRoomChangesPerDayInIntervalForm::cancel()
{
	this->close();
}
