...
#include "constraintstudentsmaxhourscontinuouslyform_template.h"
...
class ConstraintStudentsMaxHoursContinuouslyForm : public ConstraintStudentsMaxHoursContinuouslyForm_template  {
public:
