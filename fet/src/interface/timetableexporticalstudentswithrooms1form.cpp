...
TimetableExportiCalStudentsWithRooms1Form::TimetableExportiCalStudentsWithRooms1Form()
 : TimetableExportiCalStudentsWithRooms1Form_template()
{
...
void TimetableExportiCalStudentsWithRooms1Form::ok()
{
	//verify the data
...
void TimetableExportiCalStudentsWithRooms1Form::cancel()
{
	this->close();
}
