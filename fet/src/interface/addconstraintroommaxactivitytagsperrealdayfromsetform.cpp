/***************************************************************************
                          addconstraintroommaxactivitytagsperrealdayfromsetform.cpp  -  description
                             -------------------
    begin                : 2024
...
AddConstraintRoomMaxActivityTagsPerRealDayFromSetForm::AddConstraintRoomMaxActivityTagsPerRealDayFromSetForm(QWidget* parent): QDialog(parent)
{
	setupUi(this);
	...
	connect(addConstraintPushButton, &QPushButton::clicked, this, &AddConstraintRoomMaxActivityTagsPerRealDayFromSetForm::addCurrentConstraint);
	connect(closePushButton, &QPushButton::clicked, this, &AddConstraintRoomMaxActivityTagsPerRealDayFromSetForm::close);

	connect(allActivityTagsListWidget, &QListWidget::itemDoubleClicked, this, &AddConstraintRoomMaxActivityTagsPerRealDayFromSetForm::addActivityTag);
	connect(selectedActivityTagsListWidget, &QListWidget::itemDoubleClicked, this, &AddConstraintRoomMaxActivityTagsPerRealDayFromSetForm::removeActivityTag);

	connect(clearActivityTagsPushButton, &QPushButton::clicked, this, &AddConstraintRoomMaxActivityTagsPerRealDayFromSetForm::clearActivityTags);

	connect(filterCheckBox, &QCheckBox::toggled, this, &AddConstraintRoomMaxActivityTagsPerRealDayFromSetForm::filter);
	...
	connect(roomsComboBox, qOverload<int>(&QComboBox::currentIndexChanged), this, &AddConstraintRoomMaxActivityTagsPerRealDayFromSetForm::filter);
...
AddConstraintRoomMaxActivityTagsPerRealDayFromSetForm::~AddConstraintRoomMaxActivityTagsPerRealDayFromSetForm()
{
	saveFETDialogGeometry(this);
}

void AddConstraintRoomMaxActivityTagsPerRealDayFromSetForm::filter()
{
...
void AddConstraintRoomMaxActivityTagsPerRealDayFromSetForm::addActivityTag()
{
...
void AddConstraintRoomMaxActivityTagsPerRealDayFromSetForm::removeActivityTag()
{
...
void AddConstraintRoomMaxActivityTagsPerRealDayFromSetForm::clearActivityTags()
{
	selectedActivityTagsListWidget->clear();
}

void AddConstraintRoomMaxActivityTagsPerRealDayFromSetForm::addCurrentConstraint()
{
	...
	ctr=new ConstraintRoomMaxActivityTagsPerRealDayFromSet(weight, room->name, maxActivityTagsSpinBox->value(), selectedActivityTagsList);
