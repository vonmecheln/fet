/***************************************************************************
                          modifyconstraintstudentsmaxbuildingchangesperdayinintervalform.cpp  -  description
                             -------------------
    begin                : 2024
...
ModifyConstraintStudentsMaxBuildingChangesPerDayInIntervalForm::ModifyConstraintStudentsMaxBuildingChangesPerDayInIntervalForm(QWidget* parent, ConstraintStudentsMaxBuildingChangesPerDayInInterval* ctr): QDialog(parent)
{
	setupUi(this);

	okPushButton->setDefault(true);

	connect(okPushButton, &QPushButton::clicked, this, &ModifyConstraintStudentsMaxBuildingChangesPerDayInIntervalForm::ok);
	connect(cancelPushButton, &QPushButton::clicked, this, &ModifyConstraintStudentsMaxBuildingChangesPerDayInIntervalForm::cancel);
...
ModifyConstraintStudentsMaxBuildingChangesPerDayInIntervalForm::~ModifyConstraintStudentsMaxBuildingChangesPerDayInIntervalForm()
{
	saveFETDialogGeometry(this);
}

void ModifyConstraintStudentsMaxBuildingChangesPerDayInIntervalForm::ok()
{
	double weight;
...
void ModifyConstraintStudentsMaxBuildingChangesPerDayInIntervalForm::cancel()
{
	this->close();
}
