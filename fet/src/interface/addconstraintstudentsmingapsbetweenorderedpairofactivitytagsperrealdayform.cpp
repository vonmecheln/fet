/***************************************************************************
                          addconstraintstudentsmingapsbetweenorderedpairofactivitytagsperrealdayform.cpp  -  description
                             -------------------
    begin                : 2024
...
AddConstraintStudentsMinGapsBetweenOrderedPairOfActivityTagsPerRealDayForm::AddConstraintStudentsMinGapsBetweenOrderedPairOfActivityTagsPerRealDayForm(QWidget* parent): QDialog(parent)
{
	setupUi(this);

	addConstraintPushButton->setDefault(true);

	connect(addConstraintPushButton, &QPushButton::clicked, this, &AddConstraintStudentsMinGapsBetweenOrderedPairOfActivityTagsPerRealDayForm::addCurrentConstraint);
	connect(closePushButton, &QPushButton::clicked, this, &AddConstraintStudentsMinGapsBetweenOrderedPairOfActivityTagsPerRealDayForm::close);

	connect(swapPushButton, &QPushButton::clicked, this, &AddConstraintStudentsMinGapsBetweenOrderedPairOfActivityTagsPerRealDayForm::swap);
...
AddConstraintStudentsMinGapsBetweenOrderedPairOfActivityTagsPerRealDayForm::~AddConstraintStudentsMinGapsBetweenOrderedPairOfActivityTagsPerRealDayForm()
{
	saveFETDialogGeometry(this);
}

void AddConstraintStudentsMinGapsBetweenOrderedPairOfActivityTagsPerRealDayForm::updateFirstActivityTagComboBox()
{
	for(ActivityTag* at : std::as_const(gt.rules.activityTagsList))
		firstActivityTagComboBox->addItem(at->name);
}

void AddConstraintStudentsMinGapsBetweenOrderedPairOfActivityTagsPerRealDayForm::updateSecondActivityTagComboBox()
{
	for(ActivityTag* at : std::as_const(gt.rules.activityTagsList))
		secondActivityTagComboBox->addItem(at->name);
}

void AddConstraintStudentsMinGapsBetweenOrderedPairOfActivityTagsPerRealDayForm::addCurrentConstraint()
{
	...
	ctr=new ConstraintStudentsMinGapsBetweenOrderedPairOfActivityTagsPerRealDay(weight, minGaps, firstActivityTagName, secondActivityTagName);
...
void AddConstraintStudentsMinGapsBetweenOrderedPairOfActivityTagsPerRealDayForm::swap()
{
