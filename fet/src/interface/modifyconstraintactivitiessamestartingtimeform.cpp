...
ModifyConstraintActivitiesSameStartingTimeForm::ModifyConstraintActivitiesSameStartingTimeForm(QWidget* parent, ConstraintActivitiesSameStartingTime* ctr): QDialog(parent)
{
	...
	connect(cancelPushButton, &QPushButton::clicked, this, &ModifyConstraintActivitiesSameStartingTimeForm::cancel);
	connect(okPushButton, &QPushButton::clicked, this, &ModifyConstraintActivitiesSameStartingTimeForm::ok);
	connect(allActivitiesListWidget, &QListWidget::itemDoubleClicked, this, &ModifyConstraintActivitiesSameStartingTimeForm::addActivity);
	connect(addAllActivitiesPushButton, &QPushButton::clicked, this, &ModifyConstraintActivitiesSameStartingTimeForm::addAllActivities);
	connect(selectedActivitiesListWidget, &QListWidget::itemDoubleClicked, this, &ModifyConstraintActivitiesSameStartingTimeForm::removeActivity);

	connect(clearPushButton, &QPushButton::clicked, this, &ModifyConstraintActivitiesSameStartingTimeForm::clear);
	...
	connect(teachersComboBox, qOverload<int>(&QComboBox::currentIndexChanged), this, &ModifyConstraintActivitiesSameStartingTimeForm::filterChanged);
	connect(studentsComboBox, qOverload<int>(&QComboBox::currentIndexChanged), this, &ModifyConstraintActivitiesSameStartingTimeForm::filterChanged);
	connect(subjectsComboBox, qOverload<int>(&QComboBox::currentIndexChanged), this, &ModifyConstraintActivitiesSameStartingTimeForm::filterChanged);
	connect(activityTagsComboBox, qOverload<int>(&QComboBox::currentIndexChanged), this, &ModifyConstraintActivitiesSameStartingTimeForm::filterChanged);
}
