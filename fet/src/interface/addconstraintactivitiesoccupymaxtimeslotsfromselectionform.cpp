...
AddConstraintActivitiesOccupyMaxTimeSlotsFromSelectionForm::AddConstraintActivitiesOccupyMaxTimeSlotsFromSelectionForm(QWidget* parent): QDialog(parent)
{
	...
	connect(addConstraintPushButton, &QPushButton::clicked, this, &AddConstraintActivitiesOccupyMaxTimeSlotsFromSelectionForm::addCurrentConstraint);
	connect(closePushButton, &QPushButton::clicked, this, &AddConstraintActivitiesOccupyMaxTimeSlotsFromSelectionForm::close);
	connect(selectedTimesTable, &QTableWidget::itemClicked, this, &AddConstraintActivitiesOccupyMaxTimeSlotsFromSelectionForm::itemClicked);
	connect(setAllUnselectedPushButton, &QPushButton::clicked, this, &AddConstraintActivitiesOccupyMaxTimeSlotsFromSelectionForm::setAllUnselected);
	connect(setAllSelectedPushButton, &QPushButton::clicked, this, &AddConstraintActivitiesOccupyMaxTimeSlotsFromSelectionForm::setAllSelected);
	connect(allActivitiesListWidget, &QListWidget::itemDoubleClicked, this, &AddConstraintActivitiesOccupyMaxTimeSlotsFromSelectionForm::addActivity);
	connect(addAllActivitiesPushButton, &QPushButton::clicked, this, &AddConstraintActivitiesOccupyMaxTimeSlotsFromSelectionForm::addAllActivities);
	connect(selectedActivitiesListWidget, &QListWidget::itemDoubleClicked, this, &AddConstraintActivitiesOccupyMaxTimeSlotsFromSelectionForm::removeActivity);
	connect(clearPushButton, &QPushButton::clicked, this, &AddConstraintActivitiesOccupyMaxTimeSlotsFromSelectionForm::clear);
	...
	connect(selectedTimesTable->horizontalHeader(), &QHeaderView::sectionClicked, this, &AddConstraintActivitiesOccupyMaxTimeSlotsFromSelectionForm::horizontalHeaderClicked);
	connect(selectedTimesTable->verticalHeader(), &QHeaderView::sectionClicked, this, &AddConstraintActivitiesOccupyMaxTimeSlotsFromSelectionForm::verticalHeaderClicked);

	selectedTimesTable->setSelectionMode(QAbstractItemView::NoSelection);
	
	setStretchAvailabilityTableNicely(selectedTimesTable);
	
	connect(selectedTimesTable, &QTableWidget::cellEntered, this, &AddConstraintActivitiesOccupyMaxTimeSlotsFromSelectionForm::cellEntered);
	...
	connect(teachersComboBox, qOverload<int>(&QComboBox::currentIndexChanged), this, &AddConstraintActivitiesOccupyMaxTimeSlotsFromSelectionForm::filterChanged);
	connect(studentsComboBox, qOverload<int>(&QComboBox::currentIndexChanged), this, &AddConstraintActivitiesOccupyMaxTimeSlotsFromSelectionForm::filterChanged);
	connect(subjectsComboBox, qOverload<int>(&QComboBox::currentIndexChanged), this, &AddConstraintActivitiesOccupyMaxTimeSlotsFromSelectionForm::filterChanged);
	connect(activityTagsComboBox, qOverload<int>(&QComboBox::currentIndexChanged), this, &AddConstraintActivitiesOccupyMaxTimeSlotsFromSelectionForm::filterChanged);
}
...
void AddConstraintActivitiesOccupyMaxTimeSlotsFromSelectionForm::cellEntered(int row, int col)
{
