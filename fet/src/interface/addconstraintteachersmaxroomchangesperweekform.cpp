/***************************************************************************
                          addconstraintteachersmaxroomchangesperweekform.cpp  -  description
                             -------------------
    begin                : 2019
...
AddConstraintTeachersMaxRoomChangesPerWeekForm::AddConstraintTeachersMaxRoomChangesPerWeekForm(QWidget* parent): QDialog(parent)
{
	...
	connect(addConstraintPushButton, &QPushButton::clicked, this, &AddConstraintTeachersMaxRoomChangesPerWeekForm::addCurrentConstraint);
	connect(addConstraintsPushButton, &QPushButton::clicked, this, &AddConstraintTeachersMaxRoomChangesPerWeekForm::addCurrentConstraints);
	connect(closePushButton, &QPushButton::clicked, this, &AddConstraintTeachersMaxRoomChangesPerWeekForm::close);
...
AddConstraintTeachersMaxRoomChangesPerWeekForm::~AddConstraintTeachersMaxRoomChangesPerWeekForm()
{
	saveFETDialogGeometry(this);
}

void AddConstraintTeachersMaxRoomChangesPerWeekForm::addCurrentConstraint()
{
	...
	ctr=new ConstraintTeachersMaxRoomChangesPerWeek(weight, maxChangesSpinBox->value());
...
void AddConstraintTeachersMaxRoomChangesPerWeekForm::addCurrentConstraints()
{
	...
	for(Teacher* tch : std::as_const(gt.rules.teachersList)){
		SpaceConstraint *ctr=new ConstraintTeacherMaxRoomChangesPerWeek(weight, tch->name, maxChangesSpinBox->value());
		bool tmp2=gt.rules.addSpaceConstraint(ctr);
		assert(tmp2);
