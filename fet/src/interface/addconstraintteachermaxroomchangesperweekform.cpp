...
AddConstraintTeacherMaxRoomChangesPerWeekForm::AddConstraintTeacherMaxRoomChangesPerWeekForm(QWidget* parent): QDialog(parent)
{
	...
	connect(addConstraintPushButton, &QPushButton::clicked, this, &AddConstraintTeacherMaxRoomChangesPerWeekForm::addCurrentConstraint);
	connect(addConstraintsPushButton, &QPushButton::clicked, this, &AddConstraintTeacherMaxRoomChangesPerWeekForm::addCurrentConstraints);
	connect(closePushButton, &QPushButton::clicked, this, &AddConstraintTeacherMaxRoomChangesPerWeekForm::close);
...
void AddConstraintTeacherMaxRoomChangesPerWeekForm::addCurrentConstraints()
{
