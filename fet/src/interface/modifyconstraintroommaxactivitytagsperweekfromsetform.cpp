/***************************************************************************
                          modifyconstraintroommaxactivitytagsperweekfromsetform.cpp  -  description
                             -------------------
    begin                : 2024
...
ModifyConstraintRoomMaxActivityTagsPerWeekFromSetForm::ModifyConstraintRoomMaxActivityTagsPerWeekFromSetForm(QWidget* parent, ConstraintRoomMaxActivityTagsPerWeekFromSet* ctr): QDialog(parent)
{
	setupUi(this);
	...
	connect(okPushButton, &QPushButton::clicked, this, &ModifyConstraintRoomMaxActivityTagsPerWeekFromSetForm::ok);
	connect(cancelPushButton, &QPushButton::clicked, this, &ModifyConstraintRoomMaxActivityTagsPerWeekFromSetForm::cancel);

	connect(allActivityTagsListWidget, &QListWidget::itemDoubleClicked, this, &ModifyConstraintRoomMaxActivityTagsPerWeekFromSetForm::addActivityTag);
	connect(selectedActivityTagsListWidget, &QListWidget::itemDoubleClicked, this, &ModifyConstraintRoomMaxActivityTagsPerWeekFromSetForm::removeActivityTag);

	connect(clearActivityTagsPushButton, &QPushButton::clicked, this, &ModifyConstraintRoomMaxActivityTagsPerWeekFromSetForm::clearActivityTags);

	connect(filterCheckBox, &QCheckBox::toggled, this, &ModifyConstraintRoomMaxActivityTagsPerWeekFromSetForm::filter);
	...
	connect(roomsComboBox, qOverload<int>(&QComboBox::currentIndexChanged), this, &ModifyConstraintRoomMaxActivityTagsPerWeekFromSetForm::filter);
...
ModifyConstraintRoomMaxActivityTagsPerWeekFromSetForm::~ModifyConstraintRoomMaxActivityTagsPerWeekFromSetForm()
{
	saveFETDialogGeometry(this);
}

void ModifyConstraintRoomMaxActivityTagsPerWeekFromSetForm::filter()
{
...
void ModifyConstraintRoomMaxActivityTagsPerWeekFromSetForm::addActivityTag()
{
...
void ModifyConstraintRoomMaxActivityTagsPerWeekFromSetForm::removeActivityTag()
{
...
void ModifyConstraintRoomMaxActivityTagsPerWeekFromSetForm::clearActivityTags()
{
	selectedActivityTagsListWidget->clear();
}

void ModifyConstraintRoomMaxActivityTagsPerWeekFromSetForm::ok()
{
	double weight;
...
void ModifyConstraintRoomMaxActivityTagsPerWeekFromSetForm::cancel()
{
	this->close();
}
