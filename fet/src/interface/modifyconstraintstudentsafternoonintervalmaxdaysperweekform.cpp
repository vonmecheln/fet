/***************************************************************************
                          modifyconstraintstudentsafternoonintervalmaxdaysperweekform.cpp  -  description
                             -------------------
    begin                : 2020
...
ModifyConstraintStudentsAfternoonIntervalMaxDaysPerWeekForm::ModifyConstraintStudentsAfternoonIntervalMaxDaysPerWeekForm(QWidget* parent, ConstraintStudentsAfternoonIntervalMaxDaysPerWeek* ctr): QDialog(parent)
{
	setupUi(this);

	okPushButton->setDefault(true);

	connect(okPushButton, &QPushButton::clicked, this, &ModifyConstraintStudentsAfternoonIntervalMaxDaysPerWeekForm::ok);
	connect(cancelPushButton, &QPushButton::clicked, this, &ModifyConstraintStudentsAfternoonIntervalMaxDaysPerWeekForm::cancel);
...
ModifyConstraintStudentsAfternoonIntervalMaxDaysPerWeekForm::~ModifyConstraintStudentsAfternoonIntervalMaxDaysPerWeekForm()
{
	saveFETDialogGeometry(this);
}

void ModifyConstraintStudentsAfternoonIntervalMaxDaysPerWeekForm::updateMaxDaysSpinBox(){
	maxDaysSpinBox->setMinimum(0);
	maxDaysSpinBox->setMaximum(gt.rules.nDaysPerWeek/2);
}

void ModifyConstraintStudentsAfternoonIntervalMaxDaysPerWeekForm::ok()
{
	double weight;
...
void ModifyConstraintStudentsAfternoonIntervalMaxDaysPerWeekForm::cancel()
{
	this->close();
}
