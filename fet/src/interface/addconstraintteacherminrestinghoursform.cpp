...
AddConstraintTeacherMinRestingHoursForm::AddConstraintTeacherMinRestingHoursForm(QWidget* parent): QDialog(parent)
{
	...
	connect(addConstraintPushButton, &QPushButton::clicked, this, &AddConstraintTeacherMinRestingHoursForm::addCurrentConstraint);
	connect(addConstraintsPushButton, &QPushButton::clicked, this, &AddConstraintTeacherMinRestingHoursForm::addCurrentConstraints);
	connect(closePushButton, &QPushButton::clicked, this, &AddConstraintTeacherMinRestingHoursForm::close);
...
void AddConstraintTeacherMinRestingHoursForm::addCurrentConstraint()
{
	...
	ctr=new ConstraintTeacherMinRestingHours(weight, minRestingHoursSpinBox->value(), circularCheckBox->isChecked(), teacher_name);
...
void AddConstraintTeacherMinRestingHoursForm::addCurrentConstraints()
{
	...
	for(Teacher* tch : std::as_const(gt.rules.teachersList)){
		TimeConstraint *ctr=new ConstraintTeacherMinRestingHours(weight, minRestingHoursSpinBox->value(), circularCheckBox->isChecked(), tch->name);
		bool tmp2=gt.rules.addTimeConstraint(ctr);
		assert(tmp2);
