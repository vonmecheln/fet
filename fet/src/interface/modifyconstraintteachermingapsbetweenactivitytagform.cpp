/***************************************************************************
                          modifyconstraintteachermingapsbetweenactivitytagform.cpp  -  description
                             -------------------
    begin                : 2021
...
ModifyConstraintTeacherMinGapsBetweenActivityTagForm::ModifyConstraintTeacherMinGapsBetweenActivityTagForm
 (QWidget* parent, ConstraintTeacherMinGapsBetweenActivityTag* ctr): QDialog(parent)
{
	setupUi(this);

	okPushButton->setDefault(true);

	connect(okPushButton, &QPushButton::clicked, this, &ModifyConstraintTeacherMinGapsBetweenActivityTagForm::ok);
	connect(cancelPushButton, &QPushButton::clicked, this, &ModifyConstraintTeacherMinGapsBetweenActivityTagForm::cancel);
...
void ModifyConstraintTeacherMinGapsBetweenActivityTagForm::updateTeacherComboBox(){
...
void ModifyConstraintTeacherMinGapsBetweenActivityTagForm::updateActivityTagComboBox()
{
...
void ModifyConstraintTeacherMinGapsBetweenActivityTagForm::ok()
{
	double weight;
...
void ModifyConstraintTeacherMinGapsBetweenActivityTagForm::cancel()
{
	this->close();
}
