/***************************************************************************
                          modifyconstraintstudentsmaxroomchangesperrealdayinintervalform.cpp  -  description
                             -------------------
    begin                : 2024
...
ModifyConstraintStudentsMaxRoomChangesPerRealDayInIntervalForm::ModifyConstraintStudentsMaxRoomChangesPerRealDayInIntervalForm(QWidget* parent, ConstraintStudentsMaxRoomChangesPerRealDayInInterval* ctr): QDialog(parent)
{
	setupUi(this);

	okPushButton->setDefault(true);

	connect(okPushButton, &QPushButton::clicked, this, &ModifyConstraintStudentsMaxRoomChangesPerRealDayInIntervalForm::ok);
	connect(cancelPushButton, &QPushButton::clicked, this, &ModifyConstraintStudentsMaxRoomChangesPerRealDayInIntervalForm::cancel);
...
ModifyConstraintStudentsMaxRoomChangesPerRealDayInIntervalForm::~ModifyConstraintStudentsMaxRoomChangesPerRealDayInIntervalForm()
{
	saveFETDialogGeometry(this);
}

void ModifyConstraintStudentsMaxRoomChangesPerRealDayInIntervalForm::ok()
{
	double weight;
...
void ModifyConstraintStudentsMaxRoomChangesPerRealDayInIntervalForm::cancel()
{
	this->close();
}
