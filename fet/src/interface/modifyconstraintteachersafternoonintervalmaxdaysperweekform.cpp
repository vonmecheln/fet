/***************************************************************************
                          modifyconstraintteachersafternoonintervalmaxdaysperweekform.cpp  -  description
                             -------------------
    begin                : 2020
...
ModifyConstraintTeachersAfternoonIntervalMaxDaysPerWeekForm::ModifyConstraintTeachersAfternoonIntervalMaxDaysPerWeekForm(QWidget* parent, ConstraintTeachersAfternoonIntervalMaxDaysPerWeek* ctr): QDialog(parent)
{
	setupUi(this);

	okPushButton->setDefault(true);

	connect(okPushButton, &QPushButton::clicked, this, &ModifyConstraintTeachersAfternoonIntervalMaxDaysPerWeekForm::ok);
	connect(cancelPushButton, &QPushButton::clicked, this, &ModifyConstraintTeachersAfternoonIntervalMaxDaysPerWeekForm::cancel);
...
ModifyConstraintTeachersAfternoonIntervalMaxDaysPerWeekForm::~ModifyConstraintTeachersAfternoonIntervalMaxDaysPerWeekForm()
{
	saveFETDialogGeometry(this);
}

void ModifyConstraintTeachersAfternoonIntervalMaxDaysPerWeekForm::updateMaxDaysSpinBox(){
	maxDaysSpinBox->setMinimum(0);
	maxDaysSpinBox->setMaximum(gt.rules.nDaysPerWeek/2);
}

void ModifyConstraintTeachersAfternoonIntervalMaxDaysPerWeekForm::ok()
{
	double weight;
...
void ModifyConstraintTeachersAfternoonIntervalMaxDaysPerWeekForm::cancel()
{
	this->close();
}
