/***************************************************************************
                          addconstraintteachermingapsbetweenorderedpairofactivitytagsperrealdayform.cpp  -  description
                             -------------------
    begin                : 2024
...
AddConstraintTeacherMinGapsBetweenOrderedPairOfActivityTagsPerRealDayForm::AddConstraintTeacherMinGapsBetweenOrderedPairOfActivityTagsPerRealDayForm(QWidget* parent): QDialog(parent)
{
	setupUi(this);

	addConstraintPushButton->setDefault(true);

	connect(addConstraintPushButton, &QPushButton::clicked, this, &AddConstraintTeacherMinGapsBetweenOrderedPairOfActivityTagsPerRealDayForm::addCurrentConstraint);
	connect(addConstraintsPushButton, &QPushButton::clicked, this, &AddConstraintTeacherMinGapsBetweenOrderedPairOfActivityTagsPerRealDayForm::addCurrentConstraints);
	connect(closePushButton, &QPushButton::clicked, this, &AddConstraintTeacherMinGapsBetweenOrderedPairOfActivityTagsPerRealDayForm::close);
	
	connect(swapPushButton, &QPushButton::clicked, this, &AddConstraintTeacherMinGapsBetweenOrderedPairOfActivityTagsPerRealDayForm::swap);
...
AddConstraintTeacherMinGapsBetweenOrderedPairOfActivityTagsPerRealDayForm::~AddConstraintTeacherMinGapsBetweenOrderedPairOfActivityTagsPerRealDayForm()
{
	saveFETDialogGeometry(this);
}

void AddConstraintTeacherMinGapsBetweenOrderedPairOfActivityTagsPerRealDayForm::updateTeacherComboBox()
{
	for(Teacher* tch : std::as_const(gt.rules.teachersList))
		teacherComboBox->addItem(tch->name);
}

void AddConstraintTeacherMinGapsBetweenOrderedPairOfActivityTagsPerRealDayForm::updateFirstActivityTagComboBox()
{
	for(ActivityTag* at : std::as_const(gt.rules.activityTagsList))
		firstActivityTagComboBox->addItem(at->name);
}

void AddConstraintTeacherMinGapsBetweenOrderedPairOfActivityTagsPerRealDayForm::updateSecondActivityTagComboBox()
{
	for(ActivityTag* at : std::as_const(gt.rules.activityTagsList))
		secondActivityTagComboBox->addItem(at->name);
}

void AddConstraintTeacherMinGapsBetweenOrderedPairOfActivityTagsPerRealDayForm::addCurrentConstraint()
{
	...
	ctr=new ConstraintTeacherMinGapsBetweenOrderedPairOfActivityTagsPerRealDay(weight, teacher_name, minGaps, firstActivityTagName, secondActivityTagName);
...
void AddConstraintTeacherMinGapsBetweenOrderedPairOfActivityTagsPerRealDayForm::addCurrentConstraints()
{
	...
	QString ctrs;
	for(Teacher* tch : std::as_const(gt.rules.teachersList)){
		TimeConstraint *ctr=new ConstraintTeacherMinGapsBetweenOrderedPairOfActivityTagsPerRealDay(weight, tch->name, minGaps, firstActivityTagName, secondActivityTagName);
		bool tmp2=gt.rules.addTimeConstraint(ctr);
		assert(tmp2);
...
void AddConstraintTeacherMinGapsBetweenOrderedPairOfActivityTagsPerRealDayForm::swap()
{
