...
#include "constraintteachersmaxbuildingchangesperdayform_template.h"
...
class ConstraintTeachersMaxBuildingChangesPerDayForm : public ConstraintTeachersMaxBuildingChangesPerDayForm_template  {
public:
