/***************************************************************************
                          modifyconstraintteachersmingapsbetweenorderedpairofactivitytagsperrealdayform.cpp  -  description
                             -------------------
    begin                : 2024
...
ModifyConstraintTeachersMinGapsBetweenOrderedPairOfActivityTagsPerRealDayForm::ModifyConstraintTeachersMinGapsBetweenOrderedPairOfActivityTagsPerRealDayForm
 (QWidget* parent, ConstraintTeachersMinGapsBetweenOrderedPairOfActivityTagsPerRealDay* ctr): QDialog(parent)
{
	setupUi(this);

	okPushButton->setDefault(true);

	connect(okPushButton, &QPushButton::clicked, this, &ModifyConstraintTeachersMinGapsBetweenOrderedPairOfActivityTagsPerRealDayForm::ok);
	connect(cancelPushButton, &QPushButton::clicked, this, &ModifyConstraintTeachersMinGapsBetweenOrderedPairOfActivityTagsPerRealDayForm::cancel);

	connect(swapPushButton, &QPushButton::clicked, this, &ModifyConstraintTeachersMinGapsBetweenOrderedPairOfActivityTagsPerRealDayForm::swap);
...
void ModifyConstraintTeachersMinGapsBetweenOrderedPairOfActivityTagsPerRealDayForm::updateFirstActivityTagComboBox()
{
...
void ModifyConstraintTeachersMinGapsBetweenOrderedPairOfActivityTagsPerRealDayForm::updateSecondActivityTagComboBox()
{
...
void ModifyConstraintTeachersMinGapsBetweenOrderedPairOfActivityTagsPerRealDayForm::ok()
{
	double weight;
...
void ModifyConstraintTeachersMinGapsBetweenOrderedPairOfActivityTagsPerRealDayForm::cancel()
{
	this->close();
}

void ModifyConstraintTeachersMinGapsBetweenOrderedPairOfActivityTagsPerRealDayForm::swap()
{
