/***************************************************************************
                          addconstraintstudentsmaxroomchangesperrealdayinintervalform.cpp  -  description
                             -------------------
    begin                : 2024
...
AddConstraintStudentsMaxRoomChangesPerRealDayInIntervalForm::AddConstraintStudentsMaxRoomChangesPerRealDayInIntervalForm(QWidget* parent): QDialog(parent)
{
	setupUi(this);

	addConstraintPushButton->setDefault(true);

	connect(addConstraintPushButton, &QPushButton::clicked, this, &AddConstraintStudentsMaxRoomChangesPerRealDayInIntervalForm::addCurrentConstraint);
	connect(closePushButton, &QPushButton::clicked, this, &AddConstraintStudentsMaxRoomChangesPerRealDayInIntervalForm::close);
...
AddConstraintStudentsMaxRoomChangesPerRealDayInIntervalForm::~AddConstraintStudentsMaxRoomChangesPerRealDayInIntervalForm()
{
	saveFETDialogGeometry(this);
}

void AddConstraintStudentsMaxRoomChangesPerRealDayInIntervalForm::addCurrentConstraint()
{
	...
	ctr=new ConstraintStudentsMaxRoomChangesPerRealDayInInterval(weight, maxChangesSpinBox->value(), startHour, endHour);
