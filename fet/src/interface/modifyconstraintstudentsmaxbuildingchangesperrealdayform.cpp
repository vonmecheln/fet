...
ModifyConstraintStudentsMaxBuildingChangesPerRealDayForm::ModifyConstraintStudentsMaxBuildingChangesPerRealDayForm(QWidget* parent, ConstraintStudentsMaxBuildingChangesPerRealDay* ctr): QDialog(parent)
{
	...
	connect(okPushButton, &QPushButton::clicked, this, &ModifyConstraintStudentsMaxBuildingChangesPerRealDayForm::ok);
	connect(cancelPushButton, &QPushButton::clicked, this, &ModifyConstraintStudentsMaxBuildingChangesPerRealDayForm::cancel);
