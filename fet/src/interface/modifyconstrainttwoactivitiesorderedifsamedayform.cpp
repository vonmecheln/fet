/***************************************************************************
                          modifyconstrainttwoactivitiesorderedifsamedayform.cpp  -  description
                             -------------------
    begin                : 2018
...
ModifyConstraintTwoActivitiesOrderedIfSameDayForm::ModifyConstraintTwoActivitiesOrderedIfSameDayForm(QWidget* parent, ConstraintTwoActivitiesOrderedIfSameDay* ctr): QDialog(parent)
{
	setupUi(this);
...
ModifyConstraintTwoActivitiesOrderedIfSameDayForm::~ModifyConstraintTwoActivitiesOrderedIfSameDayForm()
{
	saveFETDialogGeometry(this);
}

bool ModifyConstraintTwoActivitiesOrderedIfSameDayForm::filterOk(Activity* act)
{
	Q_UNUSED(act);
...
void ModifyConstraintTwoActivitiesOrderedIfSameDayForm::filterChanged()
{
	this->updateActivitiesComboBox();
}

void ModifyConstraintTwoActivitiesOrderedIfSameDayForm::updateActivitiesComboBox(){
...
void ModifyConstraintTwoActivitiesOrderedIfSameDayForm::ok()
{
	double weight;
...
void ModifyConstraintTwoActivitiesOrderedIfSameDayForm::cancel()
{
	this->close();
}

void ModifyConstraintTwoActivitiesOrderedIfSameDayForm::swap()
{
