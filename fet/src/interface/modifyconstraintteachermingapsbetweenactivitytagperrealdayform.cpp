/***************************************************************************
                          modifyconstraintteachermingapsbetweenactivitytagperrealdayform.cpp  -  description
                             -------------------
    begin                : 2024
...
ModifyConstraintTeacherMinGapsBetweenActivityTagPerRealDayForm::ModifyConstraintTeacherMinGapsBetweenActivityTagPerRealDayForm
 (QWidget* parent, ConstraintTeacherMinGapsBetweenActivityTagPerRealDay* ctr): QDialog(parent)
{
	setupUi(this);

	okPushButton->setDefault(true);

	connect(okPushButton, &QPushButton::clicked, this, &ModifyConstraintTeacherMinGapsBetweenActivityTagPerRealDayForm::ok);
	connect(cancelPushButton, &QPushButton::clicked, this, &ModifyConstraintTeacherMinGapsBetweenActivityTagPerRealDayForm::cancel);
...
void ModifyConstraintTeacherMinGapsBetweenActivityTagPerRealDayForm::updateTeacherComboBox(){
...
void ModifyConstraintTeacherMinGapsBetweenActivityTagPerRealDayForm::updateActivityTagComboBox()
{
...
void ModifyConstraintTeacherMinGapsBetweenActivityTagPerRealDayForm::ok()
{
	double weight;
...
void ModifyConstraintTeacherMinGapsBetweenActivityTagPerRealDayForm::cancel()
{
	this->close();
}
