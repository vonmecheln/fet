...
#include "addconstraintstudentsintervalmaxdaysperweekform_template.h"
...
class AddConstraintStudentsIntervalMaxDaysPerWeekForm : public AddConstraintStudentsIntervalMaxDaysPerWeekForm_template  {
	Q_OBJECT
public:
