...
ModifyConstraintStudentsSetAfternoonsEarlyMaxBeginningsAtSecondHourForm::ModifyConstraintStudentsSetAfternoonsEarlyMaxBeginningsAtSecondHourForm(QWidget* parent, ConstraintStudentsSetAfternoonsEarlyMaxBeginningsAtSecondHour* ctr): QDialog(parent)
{
	...
	connect(okPushButton, &QPushButton::clicked, this, &ModifyConstraintStudentsSetAfternoonsEarlyMaxBeginningsAtSecondHourForm::ok);
	connect(cancelPushButton, &QPushButton::clicked, this, &ModifyConstraintStudentsSetAfternoonsEarlyMaxBeginningsAtSecondHourForm::cancel);
