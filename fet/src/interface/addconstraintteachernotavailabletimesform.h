...
#include "addconstraintteachernotavailabletimesform_template.h"
...
class AddConstraintTeacherNotAvailableTimesForm : public AddConstraintTeacherNotAvailableTimesForm_template  {
	Q_OBJECT
public:
