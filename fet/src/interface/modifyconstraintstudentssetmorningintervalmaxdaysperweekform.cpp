/***************************************************************************
                          modifyconstraintstudentssetmorningintervalmaxdaysperweekform.cpp  -  description
                             -------------------
    begin                : 2020
...
ModifyConstraintStudentsSetMorningIntervalMaxDaysPerWeekForm::ModifyConstraintStudentsSetMorningIntervalMaxDaysPerWeekForm(QWidget* parent, ConstraintStudentsSetMorningIntervalMaxDaysPerWeek* ctr): QDialog(parent)
{
	setupUi(this);

	okPushButton->setDefault(true);

	connect(okPushButton, &QPushButton::clicked, this, &ModifyConstraintStudentsSetMorningIntervalMaxDaysPerWeekForm::ok);
	connect(cancelPushButton, &QPushButton::clicked, this, &ModifyConstraintStudentsSetMorningIntervalMaxDaysPerWeekForm::cancel);
...
ModifyConstraintStudentsSetMorningIntervalMaxDaysPerWeekForm::~ModifyConstraintStudentsSetMorningIntervalMaxDaysPerWeekForm()
{
	saveFETDialogGeometry(this);
}

void ModifyConstraintStudentsSetMorningIntervalMaxDaysPerWeekForm::updateStudentsComboBox(QWidget* parent){
...
void ModifyConstraintStudentsSetMorningIntervalMaxDaysPerWeekForm::updateMaxDaysSpinBox(){
	maxDaysSpinBox->setMinimum(0);
	maxDaysSpinBox->setMaximum(gt.rules.nDaysPerWeek/2);
}

void ModifyConstraintStudentsSetMorningIntervalMaxDaysPerWeekForm::ok()
{
...
void ModifyConstraintStudentsSetMorningIntervalMaxDaysPerWeekForm::cancel()
{
	this->close();
}
