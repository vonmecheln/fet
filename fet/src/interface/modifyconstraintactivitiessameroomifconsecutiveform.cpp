...
void ModifyConstraintActivitiesSameRoomIfConsecutiveForm::ok()
{
	double weight;
...
//activities
bool ModifyConstraintActivitiesSameRoomIfConsecutiveForm::filterOk(Activity* act)
{
...
void ModifyConstraintActivitiesSameRoomIfConsecutiveForm::addActivity()
{
...
void ModifyConstraintActivitiesSameRoomIfConsecutiveForm::removeActivity()
{
...
void ModifyConstraintActivitiesSameRoomIfConsecutiveForm::clear()
{
	selectedActivitiesListWidget->clear();
	selectedActivitiesList.clear();
}
