...
AddConstraintMinDaysBetweenActivitiesForm::AddConstraintMinDaysBetweenActivitiesForm(QWidget* parent): QDialog(parent)
{
	...
	connect(closePushButton, &QPushButton::clicked, this, &AddConstraintMinDaysBetweenActivitiesForm::close);
	connect(addConstraintPushButton, &QPushButton::clicked, this, &AddConstraintMinDaysBetweenActivitiesForm::addConstraint);
	connect(allActivitiesListWidget, &QListWidget::itemDoubleClicked, this, &AddConstraintMinDaysBetweenActivitiesForm::addActivity);
	connect(addAllActivitiesPushButton, &QPushButton::clicked, this, &AddConstraintMinDaysBetweenActivitiesForm::addAllActivities);
	connect(selectedActivitiesListWidget, &QListWidget::itemDoubleClicked, this, &AddConstraintMinDaysBetweenActivitiesForm::removeActivity);
	connect(clearPushButton, &QPushButton::clicked, this, &AddConstraintMinDaysBetweenActivitiesForm::clear);
	...
	connect(teachersComboBox, qOverload<int>(&QComboBox::currentIndexChanged), this, &AddConstraintMinDaysBetweenActivitiesForm::filterChanged);
	connect(studentsComboBox, qOverload<int>(&QComboBox::currentIndexChanged), this, &AddConstraintMinDaysBetweenActivitiesForm::filterChanged);
	connect(subjectsComboBox, qOverload<int>(&QComboBox::currentIndexChanged), this, &AddConstraintMinDaysBetweenActivitiesForm::filterChanged);
	connect(activityTagsComboBox, qOverload<int>(&QComboBox::currentIndexChanged), this, &AddConstraintMinDaysBetweenActivitiesForm::filterChanged);
}
