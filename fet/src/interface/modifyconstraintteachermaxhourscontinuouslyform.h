...
#include "modifyconstraintteachermaxhourscontinuouslyform_template.h"
...
class ModifyConstraintTeacherMaxHoursContinuouslyForm : public ModifyConstraintTeacherMaxHoursContinuouslyForm_template  {
public:
