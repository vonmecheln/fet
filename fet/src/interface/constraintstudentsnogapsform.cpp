/***************************************************************************
                          constraintstudentsnogapsform.cpp  -  description
                             -------------------
    begin                : Feb 11, 2005
...
bool ConstraintStudentsNoGapsForm::filterOk(TimeConstraint* ctr)
{
	if(ctr->type==CONSTRAINT_STUDENTS_NO_GAPS)
		return true;
	else
		return false;
}

void ConstraintStudentsNoGapsForm::filterChanged()
{
...
void ConstraintStudentsNoGapsForm::modifyConstraint()
{
...
void ConstraintStudentsNoGapsForm::removeConstraint()
{
	int i=constraintsListBox->currentItem();
	if(i<0){
		QMessageBox::information(this, QObject::tr("FET information"), QObject::tr("Invalid selected constraint"));
