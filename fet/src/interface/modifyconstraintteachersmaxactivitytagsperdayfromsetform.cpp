/***************************************************************************
                          modifyconstraintteachersmaxactivitytagsperdayfromsetform.cpp  -  description
                             -------------------
    begin                : 2024
...
ModifyConstraintTeachersMaxActivityTagsPerDayFromSetForm::ModifyConstraintTeachersMaxActivityTagsPerDayFromSetForm(QWidget* parent, ConstraintTeachersMaxActivityTagsPerDayFromSet* ctr): QDialog(parent)
{
	setupUi(this);

	okPushButton->setDefault(true);

	connect(okPushButton, &QPushButton::clicked, this, &ModifyConstraintTeachersMaxActivityTagsPerDayFromSetForm::ok);
	connect(cancelPushButton, &QPushButton::clicked, this, &ModifyConstraintTeachersMaxActivityTagsPerDayFromSetForm::cancel);

	connect(allActivityTagsListWidget, &QListWidget::itemDoubleClicked, this, &ModifyConstraintTeachersMaxActivityTagsPerDayFromSetForm::addActivityTag);
	connect(selectedActivityTagsListWidget, &QListWidget::itemDoubleClicked, this, &ModifyConstraintTeachersMaxActivityTagsPerDayFromSetForm::removeActivityTag);

	connect(clearActivityTagsPushButton, &QPushButton::clicked, this, &ModifyConstraintTeachersMaxActivityTagsPerDayFromSetForm::clearActivityTags);
...
ModifyConstraintTeachersMaxActivityTagsPerDayFromSetForm::~ModifyConstraintTeachersMaxActivityTagsPerDayFromSetForm()
{
	saveFETDialogGeometry(this);
}

void ModifyConstraintTeachersMaxActivityTagsPerDayFromSetForm::addActivityTag()
{
...
void ModifyConstraintTeachersMaxActivityTagsPerDayFromSetForm::removeActivityTag()
{
...
void ModifyConstraintTeachersMaxActivityTagsPerDayFromSetForm::clearActivityTags()
{
	selectedActivityTagsListWidget->clear();
}

void ModifyConstraintTeachersMaxActivityTagsPerDayFromSetForm::ok()
{
	double weight;
...
void ModifyConstraintTeachersMaxActivityTagsPerDayFromSetForm::cancel()
{
	this->close();
}
