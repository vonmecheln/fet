/***************************************************************************
                          modifyconstraintstudentssetmingapsbetweenactivitytagform.cpp  -  description
                             -------------------
    begin                : 2021
...
ModifyConstraintStudentsSetMinGapsBetweenActivityTagForm::ModifyConstraintStudentsSetMinGapsBetweenActivityTagForm
 (QWidget* parent, ConstraintStudentsSetMinGapsBetweenActivityTag* ctr): QDialog(parent)
{
	setupUi(this);

	okPushButton->setDefault(true);

	connect(okPushButton, &QPushButton::clicked, this, &ModifyConstraintStudentsSetMinGapsBetweenActivityTagForm::ok);
	connect(cancelPushButton, &QPushButton::clicked, this, &ModifyConstraintStudentsSetMinGapsBetweenActivityTagForm::cancel);
...
void ModifyConstraintStudentsSetMinGapsBetweenActivityTagForm::updateStudentsComboBox(QWidget* parent){
...
void ModifyConstraintStudentsSetMinGapsBetweenActivityTagForm::updateActivityTagComboBox()
{
...
void ModifyConstraintStudentsSetMinGapsBetweenActivityTagForm::ok()
{
...
void ModifyConstraintStudentsSetMinGapsBetweenActivityTagForm::cancel()
{
	this->close();
}
