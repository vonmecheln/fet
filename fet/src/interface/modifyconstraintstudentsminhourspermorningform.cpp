/***************************************************************************
                          modifyconstraintstudentsminhourspermorningform.cpp  -  description
                             -------------------
    begin                : 2020
...
ModifyConstraintStudentsMinHoursPerMorningForm::ModifyConstraintStudentsMinHoursPerMorningForm(QWidget* parent, ConstraintStudentsMinHoursPerMorning* ctr): QDialog(parent)
{
	setupUi(this);
...
ModifyConstraintStudentsMinHoursPerMorningForm::~ModifyConstraintStudentsMinHoursPerMorningForm()
{
	saveFETDialogGeometry(this);
}

void ModifyConstraintStudentsMinHoursPerMorningForm::ok()
{
	double weight;
...
void ModifyConstraintStudentsMinHoursPerMorningForm::cancel()
{
	this->close();
}

void ModifyConstraintStudentsMinHoursPerMorningForm::allowEmptyMorningsCheckBoxToggled()
{
	if(gt.rules.mode!=MORNINGS_AFTERNOONS){
