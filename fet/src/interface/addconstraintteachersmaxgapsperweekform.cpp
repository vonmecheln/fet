...
AddConstraintTeachersMaxGapsPerWeekForm::AddConstraintTeachersMaxGapsPerWeekForm(QWidget* parent): QDialog(parent)
{
	...
	connect(addConstraintPushButton, &QPushButton::clicked, this, &AddConstraintTeachersMaxGapsPerWeekForm::addCurrentConstraint);
	connect(addConstraintsPushButton, &QPushButton::clicked, this, &AddConstraintTeachersMaxGapsPerWeekForm::addCurrentConstraints);
	connect(closePushButton, &QPushButton::clicked, this, &AddConstraintTeachersMaxGapsPerWeekForm::close);
...
void AddConstraintTeachersMaxGapsPerWeekForm::addCurrentConstraints()
{
