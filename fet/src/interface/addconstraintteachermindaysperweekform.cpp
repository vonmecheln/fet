...
AddConstraintTeacherMinDaysPerWeekForm::AddConstraintTeacherMinDaysPerWeekForm(QWidget* parent): QDialog(parent)
{
	setupUi(this);

	addConstraintPushButton->setDefault(true);

	connect(addConstraintPushButton, &QPushButton::clicked, this, &AddConstraintTeacherMinDaysPerWeekForm::addCurrentConstraint);
	connect(addConstraintsPushButton, &QPushButton::clicked, this, &AddConstraintTeacherMinDaysPerWeekForm::addCurrentConstraints);
	connect(closePushButton, &QPushButton::clicked, this, &AddConstraintTeacherMinDaysPerWeekForm::close);
...
void AddConstraintTeacherMinDaysPerWeekForm::addCurrentConstraint()
{
	...
	ctr=new ConstraintTeacherMinDaysPerWeek(weight, min_days, teacher_name);
...
void AddConstraintTeacherMinDaysPerWeekForm::addCurrentConstraints()
{
	...
	for(Teacher* tch : std::as_const(gt.rules.teachersList)){
		TimeConstraint *ctr=new ConstraintTeacherMinDaysPerWeek(weight, min_days, tch->name);
		bool tmp2=gt.rules.addTimeConstraint(ctr);
		assert(tmp2);
