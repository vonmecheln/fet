...
#ifndef TIMEPOPULATION_H
#define TIMEPOPULATION_H
...
private:
	...
	*/
	TimeChromosome chromosomes[MAX_POPULATION_SIZE * 2];
...
public:
	...
	*/
	...
	It calls the method TimeChromosome::init for every chromosome
	*/
	void init(Rules& r, int np);

	/**
	Invokes method TimeChromosome::makeTimesUnallocated for all the chromosomes
	*/
	void makeTimesUnallocated(Rules& r);

	/**
	Invokes method TimeChromosome::makeTimesRandom for all the chromosomes
	*/
	void makeTimesRandom(Rules& r);

	/**
	Returns the individual with the best fitness (the smallest fitness factor)
	*/
	TimeChromosome& bestChromosome(Rules& r);

	/**
	Returns the individual with the worst fitness (the biggest fitness factor)
	For statistical purposes...
	*/
	TimeChromosome& worstChromosome(Rules& r);

	/**
	Returns the median chromosome (n/2-1'st)
	For statistical purposes...
	*/
	TimeChromosome& medianChromosome(Rules& r);
