...
each pair of activities</source>
        <translation>Ελάχιστο απαιτούμενο 
διάστημα σε ημέρες μεταξύ 
...
Recommended:
95.0%-100.0%</source>
        <translation>Πιθανότητα εμφάνισης 
προστιθέμενου όρου
 (ελάχ. ημέρες μεταξύ 
εργασιών όρος)
Συνιστώμενο:
...
(συνιστώμενο: 0.0%-100.0%)</translation>
    </message>
</context>
<context>
...
a timetable, maybe you can try optimizing first without these constraints</source>
        <translation>Ο περιορισμός αυτός εννοεί πως οι εργασίες δεν πρέπει να
τοποθετούνται σε κοινές ωριαίες ζώνες. Δεν χρειάζεται να 
τοποθετηθεί αυτός ο όρος για εργασίες κοινές για μαθητές
ή καθηγητές. Βάλτε αυτό τον όρο μόνο αν πράγματι επιθυμείτε
οι εργασίες να μην είναι συνεχόμενες. Αν το FET αποτύχει στην
δημιρουργία προγράμματος, ίσως πρέπει να αρθεί πρώτα αυτός
ο περιορισμός</translation>
    ...
    <message>
        ...
        <translation>Πιθανότης (συνιστάται: 0.0%-100.0%)</translation>
    </message>
</context>
<context>
...
(ή κενό για όλους), σετ μαθητών, τμήμα, χαρ/σμό μαθήματος.</translation>
    </message>
</context>
<context>
...
careful at the order, it might be different from what you need)</source>
        <translation>Σύνολο (παρακαλώ επιλέξτε αυτό εάν θέλετε να εισαχθούν μόνο
αντιπρόσωποι των υπο-εργασιών. Θα προστεθούν περισσότεροι
ΌροιεργασίεςΤαυτόχρονης Εναρξης, ένα για κάθε αντιστοιχία ζεύγους.
Αλλά ο αριθμός υπο-εργασιών πρέπει να ταιριάξει
και να είναι στην διαδοχη σωστά διότι ίσως οδηγήσουν σε λάθη)</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Πιθανότης (απαιτείται: 100.0%)</translation>
    </message>
    <message>
...
not induce gaps for teachers or students</source>
 ...
 δεν υπολογίζεται ως κενό</translation>
    </message>
</context>
<context>
...
αναγκαστικά συνεχόμενες</translation>
    ...
    <message>
        ...
        <translation>Βάρος επιλογής (συνιστώμενο: 95.0%-100.0%)</translation>
    </message>
    <message>
...
gaps (early gaps).</source>
        <translation>Προσέξτε ότι για να τρέξει ο αλγόριθμος πρέπει για κάθε τμήμα ή:
<byte value="x9"/>1.να μην έχει κενά ή
<byte value="x9"/>2.να μην έχει κενά και νωρίς, με την ίδια ποσόστωση %.
Είναι καλύτερο να επιλέγετε 100 % γιατί σε άλλη περίπτωση
ή δεν υπάρχει λύση ή αυτή δεν είναι βέλτιστη.
...
gaps.</source>
        <translation> Προσέξτε ότι για να τρέξει ο αλγόριθμος πρέπει για κάθε τμήμα ή:
1.να μην έχει κενά ή
2.να μην έχει κενά και νωρίς, με την ίδια ποσόστωση %.
Είναι καλύτερο να επιλέγετε 100 % γιατί σε άλλη περίπτωση
ή δεν υπάρχει λύση ή αυτή δεν είναι βέλτιστη.
Σημείωση: τμήμα όχι εύκαιρο και διάλλειμα δεν υπολογίζονται ως κενές ώρες.</translation>
    </message>
...
Note: students set not available and break are not counted as 
gaps.</source>
        <translation>Προσέξτε ότι για να τρέξει ο αλγόριθμος πρέπει
για κάθε τμήμα ή:
1.να μην έχει κενά ή
2.να μην έχει κενά και νωρίς, με την ίδια ποσόστωση %.
Είναι καλύτερο να επιλέγετε 100 % γιατί σε άλλη περίπτωση
ή δεν λύση ή αυτή δεν είναι βέλτιστη.
Σημείωση: τμήμα όχι εύκαιρο και διάλλειμα 
...
not available period, there will be no gaps counted</source>
        <translation>Ο περιορισμός αυτός δεν προσμετράται ως κενή ώρα για τα τμήματα.
...
available and break are not counted as gaps.</source>
        <translation>Μπορεί να χρησιμοποιηθεί μόνο ένας περιορισμός
αυτού του τύπου με βαρύτητα 100%, αλλιώς το 
εξαγώμενο πρόγραμμα δεν είναι βέλτιστο. Προσπαθήστε
να χρησιμοποιείτε αρχικά μεγάλη τιμή κενών εβδομαδιαίως
και σταδιακά μειώνετε όσο εξάγονται καλά προγράμματα.
Ίσως η αρχική τιμή 3 είναι μικρή για το σχολείο σας.
Σημείωση: αν καθηγητής μη εύκαιρος και διάλειμα
δεν υπολογίζονται ως κενά.</translation>
    </message>
</context>
<context>
...
to start with 2 min hours and highten them as you find new timetables</source>
        <translation>Σημείωση:το FET χρησιμοποιεί αυτό τον όρο μόνο για τις εργάσιμες
ημέρες ενός καθηγητή. Προσέξτε στην χρήση αυτού του περιορισμού
ώστε να μην εξάγεται αδύνατο πρόγραμμα. Συνιστάται να αρχίζετε
με ελάχιστες ώρες και να τις αυξάνετε εφόσον εξάγετε σωστά νέα
...
not available period, there will be no gaps counted</source>
        <translation>Ο περιορισμός αυτός δεν προσμετράται ως κενή
 ώρα για τους καθηγητές. Αν ο καθηγητής έχει μάθημα
πριν και μετά δεν προσμετρώνται και τα ενδιάμεσα κενά</translation>
    </message>
</context>
<context>
...
need to use higher values. Note: teacher not 
available and break are not counted as gaps.</source>
        <translation>Είναι καλύτερο να επιλέγετε μόνο έναν περιορισμό
 αυτού του τύπου και με 100 % γιατί σε άλλη περίπτωση
ή δεν υπάρχει λύση ή αυτή δεν είναι βέλτιστη.
Σημείωση: τμήμα όχι εύκαιρο και διάλλειμα
 δεν υπολογίζονται ως κενές ώρες.</translation>
    </message>
...
but they might be too large and you might get a impossible timetable.</source>
        <translation>Σημείωση:το FET χρησιμοποιεί αυτό τον όρο μόνο για τις εργάσιμεςημέρες ενός καθηγητή. Προσέξτε στην χρήση αυτού του περιορισμούώστε να μην εξάγεται αδύνατο πρόγραμμα. Συνιστάται να αρχίζετεμε 2 ελάχιστες ώρες και να τις αυξάνετε εφόσον εξάγετε σωστά νέαπρογράμματα.</translation>
    </message>
</context>
<context>
...
If you want, you can turn off automatic search for updates in Settings menu</source>
        <translation>Δεν μπορεί να ψάξει για τις νέες εκδόσεις στο διαδίκτυο - το μήνυμα λάθους είναι: %1, ψάχνω για το αρχείο http://www.lalescu.ro/liviu/fet/crtversion/crtversion.txt. Ίσως η δομή ιστοσελίδας άλλαξε. Παρακαλώ επισκεφτείτε την ιστοσελίδα FET http://www.lalescu.ro/liviu/fet/ και πάρτε την πιό πρόσφατη έκδοση ή, εάν η ιστοσελίδα δεν λειτουργεί,προσπαθήστε να ψάξετε για τη νέα σελίδα FET στο διαδίκτυο. Μπορείτε να έρθετε σε επαφή με το συντάκτη. Επίσης, μερικές φορές το lalescu.ro έχει προσωρινά προβλήματα, προσπαθήστε πάλι αργότερα
...
You can choose to disable automatic search for updates in the Settings menu</source>
        <translation>Μια άλλη έκδοση: %1, είναι διαθέσιμη στην ιστοσελίδα FET: http://www.lalescu.ro/liviu/fet/ 
Πρέπει με το χέρι να μεταφορτώσετε και να εγκαταστήσετε (ανοίξτε την ιστοσελίδα FET σε έναν ξεφυλλιστή Διαδικτύου). Παρακαλώ διαβάστε τις πληροφορίες της ιστοσελίδας σχετικά με τη νεώτερη έκδοση και επιλέξτε είτε να κρατήσετε την τρέχουσα έκδοση είτε τη βελτίωση της (η συνιστώμενη επιλογή είναι να αναβαθμίσετε).Ίσως πρέπει να χτυπήσετε αναζωογόνηση στον ξεφυλλιστή Ιστού σας εάν οι συνδέσεις δεν λειτουργούν

Μπορείτε να επιλέξετε να θέσετε εκτός λειτουργίας την αυτόματη αναζήτηση των νέων εκδόσεων στις επιλογές ρυθμίσεων</translation>
    </message>
    <message>
...
Σταματήστε τον καταμερισμό πριν προχωρήσετε.</translation>
    ...
    <message>
        ...
        <translation>Σίγουρα θέλετε να προσθέσετε νέα δεδομένα (κανόνες);</translation>
    </message>
    <message>
        <location filename="../src/interface/fetmainform.cpp" line="338"/>
        <source>FET - a free evolutionary timetabling program</source>
        <translation>FET - ένα ελεύθερο εθελοντικό πρόγραμμα χρονοδιαγράμματος</translation>
    </message>
    <message>
        <location filename="../src/interface/fetmainform.cpp" line="367"/>
        <source>open file dialog</source>
        <translation>άνοιξε φάκελο διάλογος</translation>
    </message>
    <message>
        <location filename="../src/interface/fetmainform.cpp" line="367"/>
    ...
    <message>
        ...
        <translation>Άκυρο αρχείο</translation>
    </message>
    <message>
        <location filename="../src/interface/fetmainform.cpp" line="405"/>
        <source>&amp;OK</source>
    ...
    <message>
        ...
        <translation>Σίγουρα θέλετε να ακυρώσετε όλες τις ρυθμίσεις σε προκαθορισμένες;
</translation>
    </message>
    <message>
...
5. Timetable html level will be 2)</source>
        <translation>(αυτές είναι:
1. Κύριας φόρμας γεωμετρία θα επανέλθει σε αρχικές ρυθμίσεις
2. Η αναζήτηση νέων εκδοσεων κατά την έναρξη θα απενεργοποιηθει
3. Γλώσσα θα χρησιμοποιηθεί en_GB (απαιτείται επανεκίννηση για την
    ενεργοποίηση αλλαγής γλώσσας)
4 Ο φάκελλος αρχείων εργασίας θα είναι sample_inputs
5. Επίπεδο html χρονοδιαγράμματος θα είναι το 2)</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Διάλλειμα (όλοι &apos;καθηγητές + μαθητές&apos; δεν είναι εύκαιροι)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>ε&amp;λ (Ελληνικά)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Html επίπεδο παραχθέντων χρονοδιαγραμμάτων</translation>
    </message>
</context>
<context>
    ...
    <message>
        ...
        <translation>Το πρόγραμμα έχει %1 συντελεστή συγκρούσεων και έγινε σε %2 ώρες, %3 λεπτά και %4 δεύτερα</translation>
    </message>
</context>
<context>
...
not the interval (not like 08:00-09:00 or like 13:45-14:55)</source>
        <translation>Αριθμός ωρών (περίοδοι) ανά ημέρα
(παρακαλούμε όπως καθορίζεται το όνομα της
τελευταίας ώρας της ημέρας) Προσέξτε διότι πρέπει να
εισάγετε αρ.+1 ονόματα όπως : 08:00 ή 13:45
όχι την διάρκεια ( π.χ. όχι 08:00-09:00 κ&apos; όχι 13:45-14:55)</translation>
    </message>
</context>
<context>
...
activities and add a new split activity</source>
        <translation>Η τιμή από εδώ δεν αλλάζει
αν απαιτείται αφαιρέστε την εργασία
και προσθέστε μια νέα χωρισμένη </translation>
    </message>
</context>
<context>
...
(recommended: 0.0%-100.0%)</source>
        <translation>Πιθανότητα 
(συνιστώμενο: 0.0%-100%)</translation>
    </message>
</context>
<context>
...
Είναι καλύτερο να επιλέγετε 100 % γιατί σε άλλη περίπτωση
ή δεν υπάρχει λύση ή αυτή δεν είναι βέλτιστη.
Σημείωση: τμήμα όχι εύκαιρο και διάλλειμα δεν υπολογίζονται
...
ημέρες ενός καθηγητή. Προσέξτε στην χρήση αυτού του περιορισμού
ώστε να μην εξάγεται αδύνατο πρόγραμμα. Συνιστάται να αρχίζετε
με 2 ελάχιστες ώρες και να τις αυξάνετε εφόσον εξάγετε σωστά νέα
προγράμματα</translation>
    </message>
    <message>
...
If a teacher has lessons before and after this
not available period, there will be no gaps counted</source>
        <translation>Ο περιορισμός αυτός δεν προσμετράται ως κενή ώρα για τους καθηγητές. Αν ο καθηγητής έχει μάθημαπριν και μετά δεν προσμετρώνται και τα ενδιάμεσα κενά</translation>
    </message>
</context>
<context>
...
lower it as you find new timetables. Note: teacher not 
available and break are not counted as gaps.</source>
        <translation>Μπορεί να χρησιμοποιηθεί μόνο ένας περιορισμόςαυτού του τύπου με βαρύτητα 100%, αλλιώς το εξαγώμενο πρόγραμμα δεν είναι βέλτιστο. Προσπαθήστενα χρησιμοποιείτε αρχικά μεγάλη τιμή κενών εβδομαδιαίως και σταδιακά μειώνετε όσο εξάγονται καλά προγράμματα.Σημείωση: αν καθηγητής μη εύκαιρος και διάλειμα δεν υπολογίζονται ως κενά.</translation>
    </message>
</context>
<context>
...
to start with 2 min hours. Maybe you could try higher values after that,
but they might be too large and you might get a impossible timetable.</source>
        <translation>Σημείωση:το FET χρησιμοποιεί αυτό τον όρο μόνο για τις εργάσιμες ημέρες
 ενός καθηγητή. Προσέξτε στην χρήση αυτού του περιορισμού ώστε
 να μην εξάγεται αδύνατο πρόγραμμα. Συνιστάται να αρχίζετε με 
2 ελάχιστες ώρες και να τις αυξάνετε εφόσον εξάγετε σωστά νέα
προγράμματα.</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Άκυρη εργασία</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Άκυρη πρώτη εργασία</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Άκυρη δεύτερη εργασία</translation>
    </message>
    <message>
...
(CONSTRAINT_ACTIVITIES_SAME_STARTING_TIME too little)</source>
        <translation>Πολλές εργασίες - αναφέρερετε το λάθος
(CONSTRAINT_ACTIVITIES_SAME_STARTING_TIME too little)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Άκυρη βαρύτης (%) επιλογή - (απαιτούμενο: 100%)</translation>
    </message>
    <message>
...
MAX_CONSTRAINT_ACTIVITY_PREFERRED_ROOMS πρέπει να αυξηθεί (έχετε πολλές επιλεγμένες αίθουσες)</translation>
    ...
    <message>
        ...
        <translation>Αυξήστε την μεταβλητή  MAX_N_CONSTRAINT_ACTIVITY_PREFERRED_TIMES</translation>
    </message>
    <message>
...
MAX_CONSTRAINT_SUBJECT_PREFERRED_ROOMS must be increased (you have too many selected rooms)</source>
        <translation>Αναφέρετε το λάθος στον συγγραφέα
MAX_CONSTRAINT_SUBJECT_PREFERRED_ROOMS πρέπει να αυξηθεί (έχετε πολλές επιλεγμένες αίθουσες)</translation>
    </message>
    <message>
...
It is advisable to generate the timetable without the rooms, then, if a solution is possible, to add rooms</source>
        <translation>Είναι ενδεδειγμένο να εισαχθούν μόνο οι ειδικές αίθουσες, οι οποίες δεν είναι διαθέσιμες,
 ή για τις δραστηριότητες με τις ειδικές αίθουσες που απαιτούνται (καμία ανάγκη να εισαχθούν οι εγχώριες αίθουσες
 για τους καθηγητές ή τους μαθητές)  Είναι ενδεδειγμένο να παραχθεί το χρονοδιάγραμμα χωρίς τις αίθουσες,
...
please abort now and give it another name
        ...
        <translation>Αυτη τάξη υπάρχει ήδη, αλλά σε άλλο έτος
 Εάν παρεμβάλλετε ττην τάξη στο τρεχον έτος,αυτό
 σημαίνει ότι μερικά έτη μοιράζονται ίδιες τάξεις (επικάλυψη)
 Εάν θέλετε να κάνετε νέα ανεξάρτητη τάξη ,
ακυρώσατε τώρα και του δώστε ένα άλλο όνομα
</translation>
    </message>
    <message>
...
please abort now and give it another name
        ...
        <translation>Αυτό το τμήμα υπάρχει ήδη, αλλά σε μια άλλη τάξη
 Εάν παρεμβάλλετε το τμήμα στην τρέχουσα τάξη,
αυτή σημαίνει ότι τάξεις μοιράζονται το ίδιο τμήμα (επικάλυψη)
 Εάν θέλετε να κάνετε νέο ανεξάρτητο τμήμα ,
ακυρώσατε τώρα και του δώστε του ένα άλλο όνομα
</translation>
    </message>
    <message>
 ...
 Important note: if you plan to use option &apos;divide&apos;, please try to use it only once for each year at the beginning, because a second use of option &apos;divide&apos; for the same year will remove all activities and constraints referring to old groups and subgroups from this year.</source>
        <translation>Έτος προστιθέμενο. Ίσως θελήσετε να το διαιρέσετε σε τμήματα - αυτό γίνεται στο διάλογο ετών - κουμπί &quot;διαιρείτε το έτος...&quot;, ή με με το χέρι να προσθέσετε τις τάξεις και τα τμήματα στις επιλογές τάξεων ή τμημάτων 
...
(only renamed days will be handled correctly)
        ...
        <translation>Προσέξτε ό,τι FET δεν λαμβάνει υπόψιν
παλαιούς όρους με σβησμένες ημέρες
(μόνο οι μετονομασθείσες ημέρες χρησιμοποιούνται σωστά)
</translation>
    </message>
    <message>
...
(only renamed hours will be handled correctly)
        ...
        <translation>Προσέξτε ό,τι FET δεν λαμβάνει υπόψιν
παλαιούς όρους με σβησμένες ώρες
(μόνο οι μετονομασθείσες ώρες χρησιμοποιούνται σωστά)
</translation>
    </message>
    <message>
...
referring to this activity before proceeding</source>
        <translation>id εργασίας έχει διαφορετικό όρο ίδιου τύπου ήδη
Αφαιρέστε κάθε άλλο όρο τύπου εργασία σε προτιμητέα ώρα
...
referring to this activity before proceeding</source>
        <translation>id εργασίας έχει διαφορετικό όρο ίδιου τύπου ήδη
Αφαιρέστε κάθε άλλο όρο τύπου εργασία σε προτιμητέων ωρών
σχετικό με αυτή την εργασία πριν προχωρήσετε</translation>
    </message>
    <message>
...
MAX_CONSTRAINT_SUBJECT_PREFERRED_ROOM must be increased (you have too many selected rooms)</source>
        <translation>Αναφέρετε το λάθος στον συγγραφέα
MAX_CONSTRAINT_SUBJECT_PREFERRED_ROOM πρέπει να αυξηθεί (έχετε πολλές επιλεγμένες αίθουσες)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Άκυρος επιλεγμένος καθηγητής</translation>
    </message>
    <message>
...
because the teacher is invalid</source>
        <translation>Το χρονοδιάγραμμα καθηγητή δεν μπορεί να εξαχθεί,
διότι ο καθηγητής αυτός έχει άκυρη εγγραφή</translation>
    ...
    <message>
        ...
        <translation>Σίγουρα θέλετε να διαγράψετε το έτος και όλες τις αναφερόμενες σε αυτή τάξεις, τμήματα, εργασίες και όρους;
</translation>
    </message>
    <message>
...
Please modify your data accordingly and try again</source>
        <translation>Για το τμήμα %1 δεν μπορεί να σεβαστεί τον περιορισμό των ελάχιστων ωρών καθημερινά την ημέρα %2, λόγω των σπουδαστών καθορισμένων ως μη διαθέσιμων ή/και του κενού. Πιθανώς έχετε μια ημέρα χωρίς μάθημα για αυτήν το τμήμα. Η λύση περιγράφεται στη βοήθεια/στις συχνές ερωτήσεις (για συντομία: κρατήστε τον περιορισμό που οι ελάχιστες ώρες είναι καθημερινές για αυτούς τους σπουδαστές, απομακρύνετε τους αντίστοιχους περιορισμούς σπουδαστές μη διαθέσιμους (ή το κενό) για αυτούς τους σπουδαστές, προσθέστε μια πλαστή δραστηριότητα για αυτούς τους σπουδαστές  με το πλαστό θέμα και διάρκεια τον αριθμό ωρών ανά ημέρα και προσθέστε έναν περιορισμό  δραστηριότητα σε προτιμητέα ώρα στην αντίστοιχη ημέρα, την πρώτη ώρα) 

Παρακαλώ τροποποιήστε τα στοιχεία σας αναλόγως και προσπαθήστε πάλι</translation>
    </message>
    <message>
        ...
        <translation>Δεν μπορείτε να βελτιστοποιήσετε για το δάσκαλο %1, επειδή ο αριθμός ωρών για το δάσκαλο είναι %2   και έχετε  μόνο %3  ημέρες Χ %4 ώρες σε μια εβδομάδα. Πιθανώς πρέπει να αυξήσετε με 1 τον αριθμό ωρών ανά ημέρα (πιθανώς παρανοήσατε τη σημείωση ωρών FET</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Δεν μπορείτε να βελτιστοποιήσετε για το δάσκαλο %1, επειδή ο αριθμός ωρών για το δάσκαλο είναι %2   και έχετε τις ελεύθερες θέσεις μόνο %3 από τον περιορισμό καθηγητής μη εύκαιρος ή/και το κενό. Ίσως εισαγάγατε το λανθασμένο περιορισμό καθηγητής μη εύκαιρος ή/και το κενό ή ο αριθμός ωρών ανά ημέρα είναι λιγότερος κατά 1, λόγω παρανόησης</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Αδυναμία βελτιστοποίησης, διότι έχετε όρο καθηγητές μέγιστα κενά με ποσόστωση κάτω από 100. Κάνετε την ποσόστωση 100% και ξαναπροσπαθήστε</translation>
    </message>
    <message>
        <location filename="../src/engine/generate_pre.cpp" line="1427"/>
        <source>Skip rest of max gaps problems</source>
        <translation>Παράβλεψη υπόλοιπων προβλημάτων ανώτατων χασμάτων</translation>
    </message>
    <message>
        <location filename="../src/engine/generate_pre.cpp" line="1427"/>
        <source>See next incompatibility max gaps</source>
        <translation>Δες επόμενο ασυμβίβαστο μεγίστων κενών</translation>
    </message>
    <message>
        ...
        <translation>Αδυναμία βελτιστοποίησης, διότι έχετε όρο καθηγητή %1 μέγιστα κενά με ποσόστωση κάτω από 100. Κάνετε την ποσόστωση 100% και ξαναπροσπαθήστε</translation>
    </message>
    <message>
        ...
        <translation>Δεν θα μπορέστε να βελτιστοποιήσετε για τον καθηγητή %1, επειδή υπάρχουν δύο περιορισμοί αριθμού ανώτατων κενών σχετικά με αυτόν, και το ποσοστό βάρους είναι υψηλότερο στον περιορισμό με τα περισσότερα κενά που επιτρέπονται. Μπορείτε μόνο να έχετε ως περιορισμό για κάθε καθηγητή με ποσοστό μέγιστο και ελάχιστο αριθμό επιτεπόμενων κενών. Παρακαλώ τροποποιήστε τα στοιχεία σας αναλόγως και προσπαθήστε πάλι. Για περισσότερες λεπτομέρειες, δείτε την λίστα ταχυδρομείου ή στείλετε μήνυμα με το ηλεκτρονικό ταχυδρομείο στον συντάκτη</translation>
    </message>
    <message>
        ...
        <translation>Δεν μπορείτε να βελτιστοποιήσετε για τμήμα %1, επειδή ο αριθμός ωρών για το τμήμα είναι %2 και έχετε τις ημέρες Χ %3  μόνο %4 ώρες σε μια εβδομάδα. Πιθανώς πρέπει να αυξήσετε με 1 τον αριθμό ωρών ανά ημέρα (πιθανώς παρανοήσατε την σημείωση ωρών FET)</translation>
    </message>
    <message>
        <location filename="../src/engine/generate_pre.cpp" line="1468"/>
        <source>Skip rest of students problems</source>
        <translation>Παράβλεψη υπόλοιπων προβλημάτων μαθητών</translation>
    </message>
    <message>
        <location filename="../src/engine/generate_pre.cpp" line="1468"/>
        <source>See next students problem</source>
        <translation>Δες επόμενο πρόβλημα μαθητών</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Παράβλεψη υπόλοιπων προβλημάτων μαθ. όχι εύκαιροι</translation>
    </message>
    <message>
        <location filename="../src/engine/generate_pre.cpp" line="1491"/>
        <source>See next stud. not avail. problem</source>
        <translation>Δες επόμ. μαθητές μη εύκαιροι πρόβλ</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Προσπέρασε προβλήματα μεγ. ημερών</translation>
    </message>
    <message>
        <location filename="../src/engine/generate_pre.cpp" line="1549"/>
        <source>See next incompatibility max days</source>
        <translation>Δες επόμενο ασυμβίβαστο μεγίστων ημερών</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Δες επόμενη ασυμβατότητα μέγ. ημέρες την εβδομάδα</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Παράβλεψη υπολοίπων προβλημάτων νωρίς - χωρίς κενά</translation>
    </message>
    <message>
        <location filename="../src/engine/generate_pre.cpp" line="1716"/>
        <source>See next incompatibility no gaps - early</source>
        <translation>Δες επόμενη ασυμβατότητα όχι κενά - νωρίς</translation>
    </message>
    <message>
...
Please modify your data correspondingly and try again</source>
    ...
    <message>
        ...
        <translation>Προσπέρασε υπόλοιπα προβλήματα περιορισμών</translation>
    </message>
    <message>
        <location filename="../src/engine/generate_pre.cpp" line="2495"/>
        <source>See next incorrect constraint</source>
        <translation>Δες επόμενο λάθος όρο</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Παράβλεψη υπόλοιπων εργασιών χωρίς αίθουσες</translation>
    </message>
    <message>
        <location filename="../src/engine/generate_pre.cpp" line="2903"/>
    ...
    <message>
        ...
        <translation>Δεν μπορείτε να παραγάγετε το χρονοδιάγραμμα, επειδή για τη δραστηριότητα με id==%1 δεν έχετε καμία αίθουσα (με τον επιτρεπόμενο αριθμό σπουδαστών)</translation>
    </message>
    <message>
...
Please note that the default weight percentage of constraints min n days between activities will be 95% (mainly satisfied, not always) and &apos;force consecutive if same day&apos; will be set to true (meaning that if the activities are in the same day, they will be placed continuously, in a bigger duration activity)If you want, you can modify this percent to be 100%, manually in the fet input file or from the interface</source>
        <translation>Ανοίγοντας το παλαιότερο αρχείο - θα μετατραπεί στην πιό πρόσφατη μορφή, που αυτόματα ορίζει τα ποσοστά βάρους στους περιορισμούς και ρίχνει την ισότητα στις δραστηριότητες (αλλάζει τις επιλογές σας). Συνιστάται να κάνετε ένα αντίγραφο του παλαιού αρχείου σας πρίν σώσετε με την νέα μορφή.
...
not added - must be a duplicate</source>
    ...
    <message>
        ...
        <translation>Βασικός συνδυασμός όρων (χώρου), WP:%1%</translation>
    </message>
    <message>
...
(referring to rooms allocation) for any timetable
    ...
    <message>
        ...
        <translation>- αίθουσες διορίζονται σε πάνω από μια εργασία συνεχόμενα
</translation>
    </message>
    <message>
        ...
        <translation>- εργασίες με περισσότερους μαθητές από την χωρητικότητα αίθουσας
</translation>
    </message>
    <message>
...
%1</source>
 ...
 %1</translation>
    ...
    <message>
        ...
        <translation>Χρόνου όροι αναφερόμενοι στο έτος μαθητών:</translation>
    </message>
    <message>
        ...
        <translation>Χώρου όροι αναφερόμενοι στο έτος μαθητών:</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Οι χρονικοί περιορισμοί αφορούσαν άμεσα αυτήν την τάξη:</translation>
    </message>
    <message>
        ...
        <translation>Οι χώρου περιορισμοί αφορούσαν άμεσα αυτήν την τάξη:</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Οι χρονικοί περιορισμοί αφορούσαν άμεσα αυτό το τμήμα:</translation>
    </message>
    <message>
        ...
        <translation>Οι χώρου περιορισμοί αφορούσαν άμεσα αυτό το τμήμα:</translation>
    </message>
    <message>
...
(referring to time allocation) for any timetable
        ...
        <translation>Αυτοί είναι οι βασικοί υποχρεωτικοί περιορισμοί 
(αναφερόμενοι στη χρονική κατανομή) για οποιοδήποτε χρονοδιάγραμμα
</translation>
    </message>
    <message>
        ...
        <translation>Βασικοί περιορισμοί χρόνου αποφευκταίοι:
</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>- μαθητές διορίζονται σε περισσότερες από μια εργασίες ταυτόχρονα
</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>καθηγητής %1 έχει πάνω από μία ακαταχώρητη εργασία την ημέρα %2, ώρα %3</translation>
    </message>
    <message>
        ...
        <translation>τμήμα %1 έχει πάνω από μια εργασία σε εκκρεμότητα σε ημ. %2, ώρα %3</translation>
    </message>
    <message>
...
%1</source>
        <translation>Ο όρος καθηγητής όχι εύκαιρος είναι λάθος επειδή αναφέρεται σε ανύπαρκτο καθηγητή. 
Διορθώστε (η αφαίρεση ίσως είναι λύση) και προσπαθήστε πάλι. Αναφέρατε πιθανά σφάλματα.
Ο όρος είναι:
%1</translation>
    </message>
    <message>
...
%1</source>
        <translation>Ο όρος καθηγητής μη διαθέσιμος είναι λάθος επειδή αναφέρεται σε αφαιρεθείσα ημέρα.
 Διορθώστε και προσπαθήστε πάλι.Διόρθωση σημαίνει αλλαγή όρου και πληροφοριών. Ο όρος είναι:
%1</translation>
    </message>
    <message>
...
%1</source>
        <translation>Ο όρος καθηγητής μη διαθέσιμος είναι λάθος επειδή αναφέρεται σε αφαιρεθείσα ώρα έναρξης.
Διορθώστε και προσπαθήστε πάλι.Διόρθωση σημαίνει αλλαγή όρου και πληροφοριών. Ο όρος είναι:
%1</translation>
    </message>
    <message>
...
%1</source>
        <translation>Ο όρος καθηγητής μη διαθέσιμος είναι λάθος επειδή αναφέρεται σε αφαιρεθείσα ώρα λήξης.
Διορθώστε και προσπαθήστε πάλι.Διόρθωση σημαίνει αλλαγή όρου και πληροφοριών. Ο όρος είναι:
%1</translation>
    </message>
    <message>
...
%1</translation>
    ...
    <message>
        ...
        <translation>Χρονικός περιορισμός καθηγητής όχι εύκαιρος σπάει για καθ. %1 ημ. %2, ώρα %3</translation>
    </message>
    <message>
...
%1</source>
        <translation>Ο όρος σετ μαθητών όχι εύκαιρο είναι λάθος επειδή αναφέρεται σε ανύπαρκτο σετ. 
Διορθώστε (η αφαίρεση ίσως είναι λύση) και προσπαθήστε πάλι. Αναφέρατε πιθανά σφάλματα.
Ο όρος είναι:
%1</translation>
    </message>
...
%1</source>
        <translation>Ο όρος σετ μαθητών μη διαθέσιμο είναι λάθος επειδή αναφέρεται σε αφαιρεθείσα ημέρα.
Διορθώστε και προσπαθήστε πάλι.Διόρθωση σημαίνει αλλαγή όρου και πληροφοριών. Ο όρος είναι:
%1</translation>
    </message>
    <message>
...
%1</source>
        <translation>Ο όρος σετ μαθητών μη διαθέσιμο είναι λάθος επειδή αναφέρεται σε αφαιρεθείσα ώρα έναρξης.
Διορθώστε και προσπαθήστε πάλι.Διόρθωση σημαίνει αλλαγή όρου και πληροφοριών. Ο όρος είναι:
%1</translation>
    </message>
    <message>
...
%1</source>
        <translation>Ο όρος σετ μαθητών μη διαθέσιμο είναι λάθος επειδή αναφέρεται σε αφαιρεθείσα ώρα λήξης.
Διορθώστε και προσπαθήστε πάλι.Διόρθωση σημαίνει αλλαγή όρου και πληροφοριών. Ο όρος είναι:
%1</translation>
    </message>
    <message>
...
%1</translation>
    ...
    <message>
        ...
        <translation>Χρονικός περιορισμός μαθητές όχι διαθέσιμοι</translation>
    </message>
    <message>
...
%1</translation>
    ...
    <message>
        ...
        <translation>συγκρούσεις αυξάνονται=%1</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Χρονικός περιορισμός εργασίες όχι ταυτόχρονες</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Ελάχ. N ημέρες μεταξύ των εργασιών</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Ελάχιστες N ημέρες ενδιάμεσα των εργασιών</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Οι εργασίες τοποθετήθηκαν συνεχόμενες στο χρονοδιάγραμμα, διότι το επιλέξατε για την περίπτωση που αυτές θα ήταν ίδια ημέρα</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Καθηγητής  %1 δεν πρέπει να έχει πάνω από %2 ώρες την ημέρα</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Χρόνου όρος καθηγητής μεγ. ημέρες ανά εβδομ. σπάει για</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Χρόνου όρος καθηγητές μέγιστα κενά την εβδομάδα σπάει: καθ. %1, συγκρούσεις αυξάνονται=%2</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Χρόνου όρος καθηγητής μέγιστα κενά την εβδομάδα σπάει: καθ. %1, συγκρούσεις αυξάνονται=%2</translation>
    </message>
    <message>
...
%1</source>
        <translation>Όρος κενό είναι λάθος διότι αναφέρεται σε αφαιρεθείσα ημέρα. Διορθώστε και ξαναπροσπαθήστε. Διόρθωση σημαίνει αλλαγή του όρου και αναβάθμιση πληροφοριών. Ο όρος είναι:
%1</translation>
    </message>
    <message>
...
%1</source>
        <translation>Όρος κενό είναι λάθος διότι αναφέρεται σε αφαιρεθείσα ώρα έναρξης. Διορθώστε και ξαναπροσπαθήστε. Διόρθωση σημαίνει αλλαγή του όρου και αναβάθμιση πληροφοριών. Ο όρος είναι:
%1</translation>
    </message>
    <message>
...
%1</source>
        <translation>Όρος κενό είναι λάθος διότι αναφέρεται σε αφαιρεθείσα ώρα λήξης. Διορθώστε και ξαναπροσπαθήστε. Διόρθωση σημαίνει αλλαγή του όρου και αναβάθμιση πληροφοριών. Ο όρος είναι:
%1</translation>
    </message>
    <message>
...
%1</source>
        <translation>Όρος κενό είναι λάθος διότι αναφέρεται σε ώρα έναρξης &gt;= ώρα λήξης. Διορθώστε και ξαναπροσπαθήστε. Διόρθωση σημαίνει αλλαγή του όρου και αναβάθμιση πληροφοριών. Ο όρος είναι:%1</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Αυτό αυξάνει τις συγκρούσεις συνολικά κατά</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Όλοι τα σετ μαθητών πρέπει να έχουν μέγιστο αριθμό ωρών ημερησίως</translation>
    </message>
    <message>
        <location filename="../src/engine/timeconstraint.cpp" line="4299"/>
        <source>Maximum recommended hours daily=%1</source>
        <translation>Μέγιστες συνιστώμενες ώρες ημερησίως=%1</translation>
    </message>
    <message>
...
%1</source>
    ...
    <message>
        ...
        <translation> Άκυρη (δεν υπάρχει) δραστηριότητα με id για όρο εργασία σε προτιμητέα ώρα</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Χρόνου όρος εργασία σε προτιμητέα ώρα σπάει για την εργασία με id=%1, αυξάνοντας συγκρούσεις κατά %2</translation>
    </message>
    <message>
...
%1</source>
 ...
 Παρακαλώ το διορθώστε (ίσως αφαιρώντας είναι μια λύση)):
%1</translation>
    </message>
    <message>
...
%1</source>
        <translation>Όρος εργασία σε προτιμητέες ώρες είναι λάθος διότι αναφέρεται σε αφαιρεθείσα ημέρα. Διορθώστε και ξαναπροσπαθήστε. Διόρθωση σημαίνει αλλαγή του όρου και αναβάθμιση πληροφοριών. Ο όρος είναι:
%1</translation>
    </message>
    <message>
...
%1</source>
        <translation>Όρος εργασία σε προτιμητέες ώρες είναι λάθος επειδή η προτιμητέα ώρα είναι πολύ αργά (μετά από κάποια αποδεκτή θέση). Παρακαλώ διορθώστε και προσπαθήστε πάλι. Η διόρθωση σημαίνει αλλαγή όρου και πληροφοριών. Ο περιορισμός είναι:
%1</translation>
    </message>
    <message>
...
%1</source>
        <translation>Όρος εργασία σε προτιμητέες ώρες είναι λάθος επειδή αναφέρεται σε αφαιρεθείσα ώρα. Παρακαλώ διορθώστε και προσπαθήστε πάλι. Η διόρθωση σημαίνει αλλαγή όρου και πληροφοριών. Ο περιορισμός είναι:
%1</translation>
    </message>
    <message>
        ...
        <translation>  Άκυρη (δεν υπάρχει) δραστηριότητα με id για όρο εργασία σε προτιμητέες ώρες</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Χρόνου όρος εργασία σε προτιμητέες ώρες σπάει για την εργασία με id=%1, αυξάνοντας συγκρούσεις κατά %2</translation>
    </message>
    <message>
...
%1</source>
        <translation>Όρος εργασίες σε προτιμητέες ώρες είναι λάθος επειδή αναφέρεται σε αφαιρούμενη ημέρα. Παρακαλώ διορθώστε και προσπαθήστε πάλι. Η διόρθωση σημαίνει αλλαγή όρου και πληροφοριών. Ο περιορισμός είναι:
%1</translation>
    </message>
    <message>
...
%1</source>
        <translation>Όρος εργασίες σε προτιμητέες ώρες είναι λάθος επειδή η προτιμητέα ώρα είναι πολύ αργά (μετά από κάποια αποδεκτή θέση). Παρακαλώ διορθώστε και προσπαθήστε πάλι. Η διόρθωση σημαίνει αλλαγή όρου και πληροφοριών. Ο περιορισμός είναι:
%1</translation>
    </message>
    <message>
...
%1</source>
        <translation>Όρος εργασίες σε προτιμητέες ώρες είναι λάθος επειδή αναφέρεται σε αφαιρεθείσα ώρα. Παρακαλώ διορθώστε και προσπαθήστε πάλι. Η διόρθωση σημαίνει αλλαγή όρου και πληροφοριών. Ο περιορισμός είναι:
%1</translation>
    </message>
    <message>
...
%1</source>
        <translation>Επόμενος όρος είναι λάθος (δεν περιέχει εργασίες. Διορθώστε):
%1</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Χρόνου όρος εργασίες σε προτιμητέες ώρες σπάει για την εργασία με id=%1,   αυξάνοντας συγκρούσεις κατά %2</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation> Άκυρη (ανύπαρκτη) εργασίας id</translation>
    </message>
    <message>
        ...
        <translation>Χρόνου όρος εργασίες ταυτόχρονης έναρξης σπάει, διότι εργασία με id=%1 δεν είναι ίδια ώρα με την id=%2</translation>
    </message>
    <message>
...
%1</source>
    ...
    <message>
        ...
        <translation>Όρος 2 εργασίες συνεχόμενες: </translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Όρος 2 εργασίες συνεχόμενες (η δεύτερη εργασία πρέπει να τοποθετηθεί μετά την πρώτη, πιθανώς με ενδιάμεσο κενό)</translation>
    </message>
    <message>
        <location filename="../src/engine/timeconstraint.cpp" line="6447"/>
        <source> Invalid (inexistent) activity id for first activity</source>
        <translation> Άκυρο (ανύπαρκτο) εργασίας id για την πρώτη εργασία</translation>
    </message>
    <message>
        ...
        <translation> Άκυρο (ανύπαρκτο) εργασίας id για την δεύτερη εργασία</translation>
    </message>
    <message>
 ...
 For more details, join the mailing list or email the author</source>
        <translation>Δεν μπορείτε να βελτιστοποιήσετε για το τμήμα %1, επειδή υπάρχουν πάρα πολλοί περιορισμοί των ανώτατων ωρών τύπων καθημερινά σχετικά με αυτό, οι οποίες δεν μπορούν να συμπιεστούν σε 2 περιορισμούς αυτού του τύπου. Δύο περιορισμοί μεγίστων ωρών μπορούν να συμπιεστούν σε έναν ενιαίο εάν οι μέγιστες ώρες είναι λιγότερες στον πρώτο και το ποσοστό βάρους είναι υψηλότερο στο πρώτο. Είναι δυνατό να χρησιμοποιηθεί οποιοσδήποτε αριθμός τέτοιων περιορισμών για μια υποομάδα, αλλά η συνισταμένη τους πρέπει να είναι μέγιστοι 2 περιορισμοί των ανώτατων ωρών τύπων καθημερινά. 

 Παράδειγμα: έχετε την άδεια να χρησιμοποιήσετε 3 περιορισμούς: 6 ώρες 95%, 7 ώρες 100% και 8 ωρών 100% , οι οποίες μπορούν να συμπιεστούν σε 2 περιορισμούς: 6 ώρες 95%, 7 ώρες 100% 

 Παρακαλώ τροποποιήστε τα στοιχεία σας αναλόγως και προσπαθήστε πάλι. 
 ...
 Παρακαλώ τροποποιήστε τα στοιχεία σας αναλόγως και προσπαθήστε πάλι. Για περισσότερες λεπτομέρειες, δείτε την λίστα ταχυδρομείου ή στείλετε μήνυμα με το ηλεκτρονικό ταχυδρομείο στον συντάκτη</translation>
    ...
    <message>
        ...
        <translation>Προσπέρασε προβλήματα ελαχ. ημερών</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Καθηγητές ελάχ. %1 ώρες/ημέρα</translation>
    </message>
    <message>
        <location filename="../src/engine/timeconstraint.cpp" line="6963"/>
        <source>Teachers must not have less than %1 hours daily</source>
        <translation>Καθηγητές δεν πρέπει να έχουν πάνω από %1 ώρες/ημέρα</translation>
    </message>
    <message>
        ...
        <translation>Σημ.: FET εξελίσσεται να χρησιμοποιεί τον όρο μόνο τις εργάσιμες ημέρες καθηγητών</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Σημ.: FET εξελίσσεται να χρησιμοποιεί τον όρο μόνο τις εργάσιμες ημέρες καθηγητή</translation>
    </message>
    <message>
...
Note: this constraint is strong. It means that students must have hours beginning at the very first available slot for them. If such constraint is too strong and your school allows later beginning of courses, you might want to use a combination of students set not available/break in the last slots of each day or other constraints instead</source>
    ...
    <message>
        ...
        <translation>Αλλαγή όλων των ποσοστώσεων ελάχ. αρ. ημερών</translation>
    </message>
    <message>
...
number between 0.0 and 100.0, recommended 95.0 at least)</source>
        <translation>Προειδοποίηση: όλα τα ελάχιστα βάρη ημερών ν
θα αλλάξουν στην επιλεγμένη αξία. Είστε βέβαιοι;
Εάν ναι, παρακαλώ εισάγετε το ποσοστό βάρους για όλους τους
όρους των ελάχιστων n ημερών τύπων μεταξύ των εργασιών
 (οποιοσδήποτε  αριθμός μεταξύ 0.0 και 100.0, 95.0 τουλάχιστον)</translation>
    </message>
    <message>
...
If you really need that, please talk to the author
 ...
 χαρ/σμούς μαθημάτων θα είναι κενά πεδία)</translation>
    ...
    <message>
        ...
        <translation>Όχι σετ μαθητών για την εργασία</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Εργασίες ομάς id=%1</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Συνολική διάρκεια=%1</translation>
    </message>
    <message>
        <location filename="../src/engine/activity.cpp" line="600"/>
        <source>Active: yes</source>
        <translation>Ενεργό: ναι</translation>
    </message>
    <message>
...
From now on, if you have an empty year, there will be added an automatic group only in the generated timetables, not in the data file.

For more details, join the mailing list or email the author.</source>
        <translation type="obsolete">Το αρχείο σας περιέχει τάξη %1 που ίσως δεν χρειάζεται. Από το FET 5.4.17, επιδιορθώνεται μια πιθανά κακή περίπτωση. Συνιστάται να αφαιρέσετε το αρχείο αυτό με κατάληξη WHOLE YEAR, για αναβάθμιση ταχύτητας.

Εάν θέλετε προσθέστε τάξη σε κενό έτος - στην περίπτωση αυτή μην βάλετε κατάληξη WHOLE YEAR, ώστε να αποφύγετε αυτή την ειδοποίηση.

Στο εξής όταν έχετε κενό έτος θα προστίθεται αυτόματα νέα τάξη μόνο στα δημιουργηθέντα χρονοδιαγράμματα, όχι στο αρχείο δεδομένων.
...
From now on, if you have an empty group, there will be added an automatic subgroup only in the generated timetables, not in the data file.

For more details, join the mailing list or email the author.</source>
        <translation type="obsolete">Το αρχείο σας περιέχει τμήμα %1 που ίσως δεν χρειάζεται. Από το FET 5.4.17, επιδιορθώνεται μια πιθανά κακή περίπτωση. Συνιστάται να αφαιρέσετε το αρχείο αυτό με κατάληξη WHOLE GROUP, για αναβάθμιση ταχύτητας.Εάν θέλετε προσθέστε τάξη σε κενό έτος - στην περίπτωση αυτή μην βάλετε κατάληξη WHOLE GROUP, ώστε να αποφύγετε αυτή την ειδοποίηση.Στο εξής όταν έχετε κενό έτος θα προστίθεται αυτόματα νέα τάξη μόνο στα δημιουργηθέντα χρονοδιαγράμματα, όχι στο αρχείο δεδομένων.Για περισσότερες πληροφορίες δείτε την λίστα ταχυδρομείου ή επικοινωνήστε με τον εκδότη.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Υπολογισμός ... παρακαλούμε περιμένετε</translation>
    </message>
    <message>
...
-  1 kb μεγαλύτερο από επίπεδο 0
- css αρχείο θα περιέχει στοιχεία όπως: elements table, caption, thead, tfoot, tbody,th , td
...
- style x-axis and y-axis of tablehead (useful to style width and height of the activity cells)</source>
        <translation>Επίπεδο 2 - σύνηθες css (προεπιλογή)
- όλα όσα περιέχει το 1 με διπλάσια ανάλυση και μέγεθος αρχείου από επίπεδο 1
- στυλ x-άξονα and y-άξονα πίνακα (χρήσιμο για ρύθμιση ύψους - πλάτους των κελιών εργασίας)</translation>
    </message>
    <message>
...
- style (or hide) line 1, line 2 and line 3 of the activity cells</source>
        <translation>Επίπεδο 3 - αυξημένο css
- όλα όσα περιέχει το 2 με διπλάσια ανάλυση και μέγεθος αρχείου
- εμφάνιση (ή όχι) μάθημα, χαρ/σμός, καθηγητής, μαθητής, αίθουσα
...
- όλα του 3 με περίπου 3 φορές μεγαλύτερη ανάλυση από το επίπεδο 2
...
- όλα του 4 με περίπου 4 φορές μεγαλύτερη ανάλυση από το επίπεδο 2
- εμφάνιση ίδιων μαθημάτων, χαρ/σμών, καθηγητών, μαθητών κ&apos; αιθουσών
...
<context>
    ...
    <message>
        ...
        <translation>Το έτος %1 δεν είναι κενό και θα εκκενωθεί πρίν προσθέτει τα τμήματα που επιλέξατε. Αυτό σημαίνει ότι όλοι οι δραστηριότητες και οι περιορισμοί για τάξεις και τμήματα σε αυτό το έτος θα αρθούν. Συστήνεται να σωθεί το αρχείο σας πρίν συνεχίσετε. Επίσης  ως εναλλακτική λύση, μπορείτε να τροποποιήσετε με το χέρι τάξεις/τμήματα από τις αντίστοιχες επιλογές, έτσι ώστε δεν θα χάσετε τους περιορισμούς και τις δραστηριότητες που αναφέρονται σε αυτά. Θέλετε πραγματικά το κενό έτος;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Έτος %1 θα εκκενωθεί. δηλαδή όλοι οι περιορισμοί και εργασίες που αναφέρονται σε τάξεις/τμήματα του έτους %1 θα αφαιρεθούν. Είστε σίγουρος;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Δεν μπορεί να προστεθεί τάξη %1, διότι το όνομα χρησιμοποιείται. Επιλέξτε διαφορετικό ή αφαιρέστε την παλαιά τάξη</translation>
    </message>
    <message>
        ...
        <translation>Δεν μπορεί να προστεθεί τμήμα %1, διότι το όνομα χρησιμοποιείται. Επιλέξτε διαφορετικό ή αφαιρέστε το παλιό τμήμα</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Ίσως πρώτα να θελήσετε να εξετάσετε εάν διαιρώντας ένα έτος είναι απαραίτητοι και με ποιες επιλογές. Παρακαλώ θυμηθείτε ότι το FET μπορεί να χειριστεί τις δραστηριότητες με πολυάριθμα σύνολα καθηγητών/σπουδαστών. Εάν πρέπει να καθορίσετε σπουδαστές ως 9a, το οποίο είναι χωρισμένο σε 2 μέρη: Οι αγγλικές (δάσκαλος TE) και γαλλικές (δάσκαλος TF), και οι γλωσσικές δραστηριότητες πρέπει να είναι ταυτόχρονες, κατόπιν ίσως να μην θελήσετε να διαιρέσετε σύμφωνα με αυτήν την κατηγορία, αλλά να προσθέτετε περισσότερες μεγαλύτερες δραστηριότητες, με τους σπουδαστές καθορισμένους ως 9a και τους δασκάλους TE+TF. Το μόνο μειονέκτημα είναι ότι κάθε δραστηριότητα μπορεί να πραγματοποιηθεί μόνο σε ένα δωμάτιο στο FET, έτσι να πρέπει να βρείτε έναν τρόπο να υπερνικήσετε αυτόν τον περιορισμό.</translation>
    </message>
    <message>
        ...
        <translation>Παρακαλώ επιλέξτε διάφορες κατηγορίες και σε κάθε κατηγορία ο αριθμός χωρισμάτων(τμημάτων). Μπορείτε να επιλέξετε παραδείγματος χάριν 3 κατηγορίες, 5 τμήματα για την πρώτη κατηγορία: α, β, γ, δ και ε, 2 τμήματα για τη δεύτερη κατηγορία: αγόρια και κορίτσια, και 3 τμήματα για το τρίτο: Αγγλικά, γερμανικά και γαλλικά. Μπορείτε να επιλέξετε 1 ..2 ή 3 κατηγορίες, πρώτα με 2 έως 12 τμήματα και οι δεύτεροι και τρίτοι κάθε ένας με 2 έως 6 τμήματα εάν χρειάζεστε 4 κατηγορίες, εσείς μπορούν να εφαρμόσουν αυτό το τέχνασμα: εξετάστε 9a ετησίως, 9b ένα άλλο έτος..., και να  διαιρέστε τους σε 3 κατηγορίες (περισσότερες λεπτομέρειες κατωτέρω). Για περισσότερες τιμές (πολύ απίθανη περίπτωση) θα πρέπει με το χέρι να προσθέσετε τις τάξεις και τα τμήματα</translation>
    </message>
    <message>
        ...
        <translation>Εάν πρέπει να κάνετε ένα χωρισμό του έτους 9 σε 4 κατηγορίες (κατηγορία1: α, b,c, δ, κατηγορία2: γλώσσα, κατηγορία3: θρησκεία, κατηγορία4: αγόρια/κορίτσια), ίσως να θελήσετε να χρησιμοποιήσετε αυτό το τέχνασμα: θεωρήστε την πρώτη κατηγορία για να καθορίσετε τα έτη: το έτος 9a, έτος 9b, έτος 9c, έτος 9d, και διαιρείτε κάθε έτος με 3 κατηγορίες: γλώσσα, θρησκεία και αγόρια/κορίτσια Για τις δραστηριότητες με το έτος 9 - η γλώσσα 1 παραδείγματος χάριν, εσείς πρέπει να προσθέσετε σε αυτές τις δραστηριότητες τις ομάδες 9a_γλώσσα1+9b_γλώσσα1+9c_γλώσσα1+9d_γλώσσα1. Για τις δραστηριότητες με το έτος 9a, προσθέστε ακριβώς το έτος 9a στις αντίστοιχες δραστηριότητες.</translation>
    </message>
    <message>
        ...
        <translation>Παρακαλώ εισάγετε από την αρχή τα σωστά τμήματα. Αφότου εισαγάγατε τις δραστηριότητες και τους περιορισμούς για τις τάξεις και τμήματα, διαιρώντας πάλι θα άρει τις δραστηριότητες και τους περιορισμούς που αναφέρονται σε αυτές τις τάξεις/τμήματα. Ξέρω ότι αυτό δεν είναι κομψό, ελπίζω να λύσω αυτό στο μέλλον. Αν θελήσετε να χρησιμοποιήσετε την εναλλακτική λύση χειροκίνητη αλλαγή/διαγραφή τάξεων/τμημάτων στις επιλογές τάξεων/τμημάτων, αν και αφαιρώντας μια τάξη/τμήμα θα αφαιρέσετε επίσης τις σχετικές δραστηριότητες</translation>
    </message>
    <message>
        ...
        <translation>Πιθανώς δεν πρέπει να ανησυχήσετε για τα κενά τμήματα (καμία σημαντική αλλαγή ταχύτητας), αν και δεν εξέτασα αρκετές τέτοιες καταστάσεις. Πρέπει ακριβώς να ξέρετε ότι προς το παρόν ο μέγιστος συνολικός αριθμός τμημάτων είναι %1 (που μπορεί να αλλάξει, αλλά κανείς δεν χρειάστηκε τις μεγαλύτερες τιμές)</translation>
    </message>
    <message>
        ...
        <translation>Παρακαλώ σημειώστε ότι ο διάλογος εδώ θα κρατήσει την τελευταία διαμόρφωση του τελευταίου διαιρεμένου έτους, δεν θα θυμηθεί τις τιμές για ένα συγκεκριμένο έτος που πρέπει να τροποποιήσετε.</translation>
    </message>
    <message>
        ...
        <translation>Οι διαχωριστικοί χαρακτήρες είναι επιλογή σας (προκαθορισμένο είναι το κενό)</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Διαχωριστικό χαρακτήρα(ων)</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <source>Show subgroups</source>
        <translation>Δείξε τμήματα</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>FET - τμήματα μαθητών</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Τοποθέτηση αλφαβητικά των τμημάτων</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Πρόσθεση χαρ/σμού μαθήματος</translation>
    </message>
    <message>
...
ή να γράψετε στο συντάκτη</translation>
    ...
    <message>
        ...
        <translation>Επιπλέον πληροφορίες σχετικάμε την αδυναμία προγραμματισμού εργασιών:
    ...
    <message>
        ...
        <translation>Παρακαλώ ελέγξτε τους όρους σχετικά με τις τελευταίες δραστηριότητες στον κατάλογο κάτω, που δύσκολα τοποθετούνται:
    ...
    <message>
        ...
        <translation>Εδώ είναι οι τοποθετημένες δραστηριότητες που οδηγούν σε μια ασυνέπεια, κατά σειρά (στην τελευταία το FET  απέτυχε να καταμερίσει και είναι μάλλον αδύνατη):
    ...
    <message>
        ...
        <translation>Δείτε τους περιορισμούς σχετικά με την παρακάτω δραστηριότητα, που ίσως κάνουν αδύνατο τον καταμερισμό:
...
Simulation results should be now written. You may check now Timetable/View. The results are also saved in the directory %2 in html and xml mode and the soft conflicts in txt mode</source>
        <translation>Η κατανομή ολοκληρώθηκε επιτυχώς, υπόλοιπο %1 συγκρούσεις από τους περιορισμούς με ποσοστό χαμηλότερο από 100% (δείτε τις επιλογές χρονοδιαγράμματος / Δείτε συγκρούσεις ή αρχείο txt στον κατάλογο εξόδου για τις λεπτομέρειες). 
...
Ίσως διαρκέσει 5-20 λεπτά ή περισσότερο για δύσκολα χρονοδιαγράμματα</translation>
    ...
    <message>
        ...
        <translation>Συνήθως δεν απαιτείται να σταματήσετε και επανεκινήσετε ψάξιμο, ακόμα κι αν μοιάζει σταματημένο. Αναφέρετε αντίθετες περιπτώσεις</translation>
    </message>
    <message>
        ...
        <translation>Συνιστάται να βάζετε πιό πολλούς περιορισμούς σταδιακά (π.χ. ελάχ. αρ.ημερών ή καθηγ. μέγιστα κενά), εφόσον έχετε καλά χρονοδιαγράμματα.</translation>
    </message>
    <message>
...
timetable on the hard disk, in xml and html formats.</source>
        <translation>Γράφει (σώζει , αναβαθμίζει ) τα αποτελέσματα στον δίσκο,
χωρίς να σταματήσει ο καταμερισμός. Μπορείτε
...
Please note that, for large data, each timetable might occupy more megabytes of hard disk space, so make sure you have enough space (you can check the dimension of a single timetable as a precaution).</source>
        <translation>Ειδοποίηση: μπορείτε μόνο να δείτε τα παραγμένα χρονοδιαγράμματα σε σκληρό δίσκο, στο HTML και xml τα σχήματα και τις συγκρούσεις με μορφή txt, ή το πιό πρόσφατο χρονοδιάγραμμα στις επιλογές χρονοδιαγράμματος FET. Απαιτείται ότι ο κατάλογος %1 να είναι κενός πρίν προχωρήσετε.
Παρακαλώ σημειώστε ότι, για πολλά δεδομένα, κάθε χρονοδιάγραμμα καταλαμβάνει περισσότερα μεγαμπάιτ σκληρών δίσκων, έτσι σιγουρευτείτε ότι έχετε αρκετό χώρο (μπορείτε να ελέγξετε το μέγεθος ενός τυχαίου χρονοδιαγράμματος πριν προχωρήσετε).</translation>
    </message>
    <message>
        ...
        <translation>Ο κατάλογος %1 υπάρχει και δεν είναι κενός, (ίσως περιέχει παλαιά αρχεία). Πρέπει να αφαιρέσετε όλο το περιεχόμενο του καταλόγου ΚΑΙ τον ίδιο τον κατάλογο (ή να τον μετονομάσετε) και έπειτα μπορείτε να παραγάγετε πολλαπλά χρονοδιαγράμματα</translation>
    </message>
    <message>
...
Για περισσότερες πληροφορίες μπορείτε δείτε την λίστα ταχυδρομείου 
ή να γράψετε στο συντάκτη</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Όριο χρόνου επεξεργασίας για κάθε ένα (σε λεπτά)</translation>
    </message>
    <message>
        <location filename="../src/interface/timetablegeneratemultipleform_template.ui" line="54"/>
        <source>Number of timetables</source>
        <translation>Αριθμός χρονοδιαγραμμάτων</translation>
    </message>
    <message>
